set moduleName fft1D_512_Pipeline_twiddles
set isTopModule 0
...
set C_modelName {fft1D_512_Pipeline_twiddles}
set C_modelType { void 0 }
set C_modelArgList {
	{ conv2_i double 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "conv2_i", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ conv2_i sc_in sc_lv 64 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv2_i", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "conv2_i", "role": "default" }} , 
...
set Spec2ImplPortList { 
	conv2_i { ap_none {  { conv2_i in_data 0 64 } } }
