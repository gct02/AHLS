...
module fft1D_512_fft1D_512_Pipeline_twiddles (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [63:0] mul_i_reg_272;
reg   [63:0] div_i_reg_277;
reg   [63:0] phi_reg_282;
reg   [63:0] phi_x_reg_288;
reg   [63:0] phi_y_reg_294;
reg   [63:0] mul8_i_reg_312;
reg   [63:0] mul11_i_reg_317;
reg   [63:0] mul14_i_reg_322;
reg   [63:0] mul17_i_reg_327;
...
assign add_ln28_fu_218_p2 = (ap_sig_allocacmp_j_2 + 4'd1);
...
assign grp_fu_2047_p_din0 = mul8_i_reg_312;

assign grp_fu_2047_p_din1 = mul11_i_reg_317;

assign grp_fu_2047_p_opcode = 2'd1;

assign grp_fu_2051_p_ce = 1'b1;

assign grp_fu_2051_p_din0 = mul14_i_reg_322;

assign grp_fu_2051_p_din1 = mul17_i_reg_327;

assign grp_fu_2051_p_opcode = 2'd0;

assign grp_fu_2105_p_ce = 1'b1;

assign grp_fu_2105_p_din0 = conv_i_reg_267;

assign grp_fu_2105_p_din1 = 64'd13842132293033989956;

assign grp_fu_2110_p_ce = 1'b1;

assign grp_fu_2110_p_din0 = mul_i_reg_272;

assign grp_fu_2110_p_din1 = 64'd4566650022153682944;

assign grp_fu_2117_p_ce = 1'b1;

assign grp_fu_2117_p_din0 = div_i_reg_277;

assign grp_fu_2117_p_din1 = conv2_i;
...
assign icmp_ln28_fu_205_p2 = ((ap_sig_allocacmp_j_2 == 4'd8) ? 1'b1 : 1'b0);

assign twiddles8_reversed8_address0 = zext_ln28_fu_211_p1;

assign zext_ln28_fu_211_p1 = ap_sig_allocacmp_j_2;

endmodule //fft1D_512_fft1D_512_Pipeline_twiddles
