...
attribute shreg_extract : string;
    ...
    signal icmp_ln65_fu_152_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal idx_fu_46 : STD_LOGIC_VECTOR (29 downto 0) := "000000000000000000000000000000";
    signal add_ln65_fu_157_p2 : STD_LOGIC_VECTOR (29 downto 0);
    ...
    signal zext_ln65_fu_148_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal trunc_ln65_fu_163_p1 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln65_fu_152_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln65_fu_152_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln65_fu_152_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    add_ln57_fu_167_p2 <= std_logic_vector(unsigned(trunc_ln65_fu_163_p1) + unsigned(e));
    add_ln65_fu_157_p2 <= std_logic_vector(unsigned(idx_fu_46) + unsigned(ap_const_lv30_1));
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln65_fu_152_p2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((icmp_ln65_fu_152_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln65_fu_152_p2)
    begin
        if (((icmp_ln65_fu_152_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    icmp_ln65_fu_152_p2 <= "1" when (signed(zext_ln65_fu_148_p1) < signed(m_reg_194)) else "0";
    m_fu_132_p3 <= 
    ...
    sha_info_data_we0_assign_proc : process(ap_CS_fsm_state2, icmp_ln65_fu_152_p2)
    begin
        if (((icmp_ln65_fu_152_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    trunc_ln65_fu_163_p1 <= idx_fu_46(4 - 1 downto 0);
    ...
    zext_ln65_fu_148_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(idx_fu_46),31));
end behav;
