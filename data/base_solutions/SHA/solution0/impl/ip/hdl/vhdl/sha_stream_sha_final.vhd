...
attribute shreg_extract : string;
    ...
    signal trunc_ln174_fu_114_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal trunc_ln174_reg_154 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal icmp_ln181_fu_119_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln181_reg_159 : STD_LOGIC_VECTOR (0 downto 0);
    signal sub_ln186_fu_125_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal sub_ln186_reg_163 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln182_fu_137_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln182_reg_168 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal zext_ln179_fu_96_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal zext_ln174_fu_105_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal count_1_fu_108_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal xor_ln182_fu_132_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state7) or ((icmp_ln181_fu_119_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2)) or ((icmp_ln181_fu_119_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                ...
                trunc_ln174_reg_154 <= trunc_ln174_fu_114_p1;
                    zext_ln182_reg_168(5 downto 0) <= zext_ln182_fu_137_p1(5 downto 0);
            end if;
        end if;
    end process;
    zext_ln182_reg_168(6) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln181_fu_119_p2, grp_local_memset_fu_64_ap_done, grp_sha_transform_fu_74_ap_done, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state8, ap_CS_fsm_state6, ap_CS_fsm_state11, ap_block_state8_on_subcall_done)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((icmp_ln181_fu_119_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    ap_block_state8_on_subcall_done_assign_proc : process(icmp_ln181_reg_159, grp_local_memset_fu_64_ap_done)
    begin
                ap_block_state8_on_subcall_done <= ((grp_local_memset_fu_64_ap_done = ap_const_logic_0) and (icmp_ln181_reg_159 = ap_const_lv1_1));
    end process;
    ...
    count_1_fu_108_p2 <= std_logic_vector(unsigned(zext_ln174_fu_105_p1) + unsigned(ap_const_lv7_1));
    count_fu_86_p4 <= sha_info_count_lo(8 downto 3);
    grp_local_memset_fu_64_ap_start <= grp_local_memset_fu_64_ap_start_reg;

    grp_local_memset_fu_64_e_assign_proc : process(trunc_ln174_reg_154, icmp_ln181_reg_159, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state8)
    begin
        if (((icmp_ln181_reg_159 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    grp_local_memset_fu_64_n_assign_proc : process(icmp_ln181_reg_159, sub_ln186_reg_163, zext_ln182_reg_168, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state8)
    begin
        if (((icmp_ln181_reg_159 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    icmp_ln181_fu_119_p2 <= "1" when (unsigned(count_1_fu_108_p2) > unsigned(ap_const_lv7_38)) else "0";

    sha_info_data_address0_assign_proc : process(ap_CS_fsm_state1, icmp_ln181_reg_159, grp_local_memset_fu_64_sha_info_data_address0, grp_sha_transform_fu_74_sha_info_data_address0, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state8, ap_CS_fsm_state6, ap_CS_fsm_state11, zext_ln179_fu_96_p1, ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
            sha_info_data_address0 <= ap_const_lv4_F;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
            sha_info_data_address0 <= zext_ln179_fu_96_p1(4 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_CS_fsm_state11) or (ap_const_logic_1 = ap_CS_fsm_state6))) then 
            sha_info_data_address0 <= grp_sha_transform_fu_74_sha_info_data_address0;
        elsif (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3) or ((icmp_ln181_reg_159 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
            sha_info_data_address0 <= grp_local_memset_fu_64_sha_info_data_address0;
        else 
    ...
    sha_info_data_ce0_assign_proc : process(ap_start, ap_CS_fsm_state1, icmp_ln181_reg_159, grp_local_memset_fu_64_sha_info_data_ce0, grp_sha_transform_fu_74_sha_info_data_ce0, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state8, ap_CS_fsm_state6, ap_CS_fsm_state11, ap_CS_fsm_state9)
    begin
    ...
    sha_info_data_d0_assign_proc : process(ap_CS_fsm_state1, sha_info_count_lo, icmp_ln181_reg_159, grp_local_memset_fu_64_sha_info_data_d0, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state8, ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    sha_info_data_we0_assign_proc : process(ap_start, ap_CS_fsm_state1, icmp_ln181_reg_159, grp_local_memset_fu_64_sha_info_data_we0, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state8, ap_CS_fsm_state9)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state9) or ((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1)))) then 
    ...
    sub_ln186_fu_125_p2 <= std_logic_vector(unsigned(ap_const_lv7_37) - unsigned(zext_ln174_fu_105_p1));
    trunc_ln174_fu_114_p1 <= count_1_fu_108_p2(4 - 1 downto 0);
    xor_ln182_fu_132_p2 <= (count_reg_145 xor ap_const_lv6_3F);
    zext_ln174_fu_105_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(count_reg_145),7));
    zext_ln179_fu_96_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(count_fu_86_p4),64));
    zext_ln182_fu_137_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(xor_ln182_fu_132_p2),7));
end behav;
