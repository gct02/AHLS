...
using hls::sim::Byte;
extern "C" void sha_stream(Byte<1>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_sha_stream_hw(volatile void * __xlx_apatb_param_indata, volatile void * __xlx_apatb_param_in_i, volatile void * __xlx_apatb_param_outdata) {
...
__xlx_indata__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_indata)[i]);
  ...
  int __xlx_size_param_indata = 16384;
  int __xlx_offset_param_indata = 0;
  int __xlx_offset_byte_param_indata = 0*1;
  // Collect __xlx_in_i__tmp_vec
std::vector<Byte<4>> __xlx_in_i__tmp_vec;
for (size_t i = 0; i < 2; ++i){
__xlx_in_i__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_in_i)[i]);
}
  int __xlx_size_param_in_i = 2;
  int __xlx_offset_param_in_i = 0;
  int __xlx_offset_byte_param_in_i = 0*4;
...
__xlx_outdata__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_outdata)[i]);
  ...
  int __xlx_size_param_outdata = 5;
  int __xlx_offset_param_outdata = 0;
  int __xlx_offset_byte_param_outdata = 0*4;
  // DUT call
  sha_stream(__xlx_indata__tmp_vec.data(), __xlx_in_i__tmp_vec.data(), __xlx_outdata__tmp_vec.data());
...
// print __xlx_apatb_param_in_i
for (size_t i = 0; i < __xlx_size_param_in_i; ++i) {
((Byte<4>*)__xlx_apatb_param_in_i)[i] = __xlx_in_i__tmp_vec[__xlx_offset_param_in_i+i];
}
