; ModuleID = 'data/base_solutions/SHA/solution0/.autopilot/db/a.o.1.tmp.bc'
source_filename = "data/base_solutions/SHA/solution0/.autopilot/db/a.o.1.tmp.bc"
...
@__empty_str = internal unnamed_addr constant [1 x i8] zeroinitializer
@AP_complete_mode = internal unnamed_addr constant [9 x i8] c"COMPLETE\00"
...
@6 = internal unnamed_addr constant [18 x i8] c"sha_stream_label0\00"
@7 = internal unnamed_addr constant [17 x i8] c"VITIS_LOOP_207_1\00"
@8 = internal unnamed_addr constant [18 x i8] c"sha_stream_label1\00"
@9 = internal unnamed_addr constant [18 x i8] c"sha_update_label4\00"
@10 = internal unnamed_addr constant [20 x i8] c"local_memcpy_label3\00"
@11 = internal unnamed_addr constant [21 x i8] c"sha_transform_label4\00"
@12 = internal unnamed_addr constant [21 x i8] c"sha_transform_label3\00"
@13 = internal unnamed_addr constant [21 x i8] c"sha_transform_label2\00"
@14 = internal unnamed_addr constant [21 x i8] c"sha_transform_label5\00"
@15 = internal unnamed_addr constant [1 x i8] zeroinitializer

; Function Attrs: noinline
define internal fastcc void @sha_update([2 x [8192 x i8]]* noalias nocapture align 512 %buffer, i64 %buffer.offset, i32 %count) #0 {
entry:
  call void (...) @_ssdm_op_SpecPipeline(i32 0, i32 0, i32 1, i32 0, [1 x i8]* @15), !fpga.pragma.source !4
  call void (...) @_ssdm_InlineSelf(i64 2, [1 x i8]* @15), !fpga.pragma.source !4
...
while.body:                                       ; preds = %while.body.split, %entry
  ...
  %idx = phi i64 [ 0, %entry ], [ %add.ln162, %while.body.split ]
...
while.body.split:                                 ; preds = %while.body
  ...
  call fastcc void @local_memcpy([2 x [8192 x i8]]* noalias nocapture align 512 %buffer, i64 %buffer.offset, i32 64, i64 %idx)
...
while.end.loopexit:                               ; preds = %while.body
  ...
  call fastcc void @local_memcpy([2 x [8192 x i8]]* noalias nocapture align 512 %buffer, i64 %buffer.offset, i32 %select.ln169, i64 %select.ln169.1)
  ret void
}
...
for.inc60.preheader:                              ; preds = %for.inc38
  %E.2.lcssa = phi i32 [ %E.2, %for.inc38 ]
  %E.4.lcssa = phi i32 [ %E.3, %for.inc38 ]
  %D.4.lcssa = phi i32 [ %D.3, %for.inc38 ]
  %B.2.lcssa = phi i32 [ %B.2, %for.inc38 ]
  %B.4.lcssa = phi i32 [ %B.3, %for.inc38 ]
  br label %for.inc60
...
for.inc60:                                        ; preds = %for.inc60.split, %for.inc60.preheader
  ...
  %B.6 = phi i32 [ %A.10, %for.inc60.split ], [ %B.4.lcssa, %for.inc60.preheader ]
  %B.5 = phi i32 [ %B.6, %for.inc60.split ], [ %B.2.lcssa, %for.inc60.preheader ]
  %D.6 = phi i32 [ %C.4, %for.inc60.split ], [ %D.4.lcssa, %for.inc60.preheader ]
  %E.6 = phi i32 [ %D.6, %for.inc60.split ], [ %E.4.lcssa, %for.inc60.preheader ]
  %E.5 = phi i32 [ %E.6, %for.inc60.split ], [ %E.2.lcssa, %for.inc60.preheader ]
...
for.inc85.preheader:                              ; preds = %for.inc60
  %E.5.lcssa = phi i32 [ %E.5, %for.inc60 ]
  %E.7.lcssa = phi i32 [ %E.6, %for.inc60 ]
  %D.7.lcssa = phi i32 [ %D.6, %for.inc60 ]
  %B.5.lcssa = phi i32 [ %B.5, %for.inc60 ]
  %B.7.lcssa = phi i32 [ %B.6, %for.inc60 ]
  br label %for.inc85
...
for.inc85:                                        ; preds = %for.inc85.split, %for.inc85.preheader
  ...
  %B.9 = phi i32 [ %A.11, %for.inc85.split ], [ %B.7.lcssa, %for.inc85.preheader ]
  %B.8 = phi i32 [ %B.9, %for.inc85.split ], [ %B.5.lcssa, %for.inc85.preheader ]
  %D.9 = phi i32 [ %C.6, %for.inc85.split ], [ %D.7.lcssa, %for.inc85.preheader ]
  %E.9 = phi i32 [ %D.9, %for.inc85.split ], [ %E.7.lcssa, %for.inc85.preheader ]
  %E.8 = phi i32 [ %E.9, %for.inc85.split ], [ %E.5.lcssa, %for.inc85.preheader ]
...
for.inc107.preheader:                             ; preds = %for.inc85
  %E.8.lcssa = phi i32 [ %E.8, %for.inc85 ]
  %E.9.lcssa = phi i32 [ %E.9, %for.inc85 ]
  %D.9.lcssa = phi i32 [ %D.9, %for.inc85 ]
  %B.8.lcssa = phi i32 [ %B.8, %for.inc85 ]
  %B.9.lcssa = phi i32 [ %B.9, %for.inc85 ]
  br label %for.inc107
...
for.inc107:                                       ; preds = %for.inc107.split, %for.inc107.preheader
  ...
  %A.12 = phi i32 [ %temp, %for.inc107.split ], [ %B.9.lcssa, %for.inc107.preheader ]
  %B.10 = phi i32 [ %A.12, %for.inc107.split ], [ %B.8.lcssa, %for.inc107.preheader ]
  %C.9 = phi i32 [ %C.8, %for.inc107.split ], [ %D.9.lcssa, %for.inc107.preheader ]
  %D.12 = phi i32 [ %C.9, %for.inc107.split ], [ %E.9.lcssa, %for.inc107.preheader ]
  %E.10 = phi i32 [ %D.12, %for.inc107.split ], [ %E.8.lcssa, %for.inc107.preheader ]
...
entry:
  call void (...) @_ssdm_op_SpecPipeline(i32 0, i32 0, i32 1, i32 0, [1 x i8]* @15), !fpga.pragma.source !4
  call void (...) @_ssdm_op_SpecTopModule([11 x i8]* @1), !fpga.pragma.source !4
  call void (...) @_ssdm_op_SpecInterface([2 x [8192 x i8]]* %indata, [10 x i8]* @3, i32 0, i32 0, [1 x i8]* @15, i32 -1, i32 0, [1 x i8]* @15, [1 x i8]* @15, [1 x i8]* @15, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @15, [1 x i8]* @15, i32 -1, i32 0)
  call void (...) @_ssdm_op_SpecBitsMap([2 x [8192 x i8]]* %indata), !map !68
  call void (...) @_ssdm_op_SpecInterface([2 x i32]* %in_i, [10 x i8]* @3, i32 0, i32 0, [1 x i8]* @15, i32 -1, i32 0, [1 x i8]* @15, [1 x i8]* @15, [1 x i8]* @15, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @15, [1 x i8]* @15, i32 -1, i32 0)
  call void (...) @_ssdm_op_SpecBitsMap([2 x i32]* %in_i), !map !68
  call void (...) @_ssdm_op_SpecInterface([5 x i32]* %outdata, [10 x i8]* @3, i32 0, i32 0, [1 x i8]* @15, i32 -1, i32 0, [1 x i8]* @15, [1 x i8]* @15, [1 x i8]* @15, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @15, [1 x i8]* @15, i32 -1, i32 0)
...
for.inc.split:                                    ; preds = %for.inc
  call void (...) @_ssdm_op_SpecPipeline(i32 -1, i32 0, i32 0, i32 0, [1 x i8]* @15)
  call void (...) @_ssdm_op_SpecLoopTripCount(i64 8192, i64 8192, i64 8192), !fpga.pragma.source !4
  call void (...) @_ssdm_op_SpecLoopName([17 x i8]* @7)
  ...
  %local_indata.addr = getelementptr inbounds [2 x [8192 x i8]], [2 x [8192 x i8]]* @local_indata, i64 0, i64 %i, i64 %j.1
...
for.inc21.split:                                  ; preds = %for.inc21
  ...
  call fastcc void @sha_update([2 x [8192 x i8]]* noalias nocapture align 512 @local_indata, i64 %j, i32 %i.6) #2
...
entry:
  call void (...) @_ssdm_op_SpecPipeline(i32 0, i32 0, i32 1, i32 0, [1 x i8]* @15)
  call void (...) @_ssdm_InlineSelf(i64 2, [1 x i8]* @15)
...
; Function Attrs: noinline
define internal fastcc void @local_memcpy([2 x [8192 x i8]]* noalias nocapture align 512 %s2, i64 %s2.offset, i32 %n, i64 %idx1) #0 {
entry:
  call void (...) @_ssdm_op_SpecPipeline(i32 0, i32 0, i32 1, i32 0, [1 x i8]* @15)
  call void (...) @_ssdm_InlineSelf(i64 2, [1 x i8]* @15)
...
while.body.split:                                 ; preds = %while.body
  ...
  call void (...) @_ssdm_op_SpecLoopName([20 x i8]* @10)
  %p1 = getelementptr [16 x i32], [16 x i32]* @sha_info_data, i64 0, i64 %idx9
  %add.ln73 = add i64 %idx, %idx1
  %p2 = getelementptr [2 x [8192 x i8]], [2 x [8192 x i8]]* %s2, i64 0, i64 %s2.offset, i64 %add.ln73
  %add.ln82 = add i64 %add.ln73, 1
  %p2.1 = getelementptr [2 x [8192 x i8]], [2 x [8192 x i8]]* %s2, i64 0, i64 %s2.offset, i64 %add.ln82
  %p2.load = load i8, i8* %p2, align 1
  %add.ln83 = add i64 %add.ln73, 2
  %p2.2 = getelementptr [2 x [8192 x i8]], [2 x [8192 x i8]]* %s2, i64 0, i64 %s2.offset, i64 %add.ln83
  %p2.1.load = load i8, i8* %p2.1, align 1
  %add.ln84 = add i64 %add.ln73, 3
  %p2.3 = getelementptr [2 x [8192 x i8]], [2 x [8192 x i8]]* %s2, i64 0, i64 %s2.offset, i64 %add.ln84
...
declare void @._ssdm_op_SpecBindPort(...)
