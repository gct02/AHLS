...
set C_modelArgMapList {[ 
	{ "Name" : "sha_info_data", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
...
set Spec2ImplPortList { 
	sha_info_data { ap_memory {  { sha_info_data_address0 mem_address 1 4 }  { sha_info_data_ce0 mem_ce 1 1 }  { sha_info_data_q0 in_data 0 32 } } }
	sha_info_digest { ap_memory {  { sha_info_digest_address0 mem_address 1 3 }  { sha_info_digest_ce0 mem_ce 1 1 }  { sha_info_digest_we0 mem_we 1 1 }  { sha_info_digest_d0 mem_din 1 32 }  { sha_info_digest_q0 in_data 0 32 }  { sha_info_digest_address1 MemPortADDR2 1 3 }  { sha_info_digest_ce1 MemPortCE2 1 1 }  { sha_info_digest_we1 MemPortWE2 1 1 }  { sha_info_digest_d1 MemPortDIN2 1 32 }  { sha_info_digest_q1 in_data 0 32 } } }
}
