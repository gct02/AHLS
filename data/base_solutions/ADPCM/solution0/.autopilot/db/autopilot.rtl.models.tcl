set SynModuleInfo {
  ...
  {SRCNAME filtep MODELNAME filtep RTLNAME adpcm_main_filtep
    SUBMODULES {
  ...
  {SRCNAME abs MODELNAME abs_r RTLNAME adpcm_main_abs_r}
  ...
  {SRCNAME logscl MODELNAME logscl RTLNAME adpcm_main_logscl
    SUBMODULES {
      {MODELNAME adpcm_main_logscl_wl_code_table_ROM_AUTO_1R RTLNAME adpcm_main_logscl_wl_code_table_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME scalel MODELNAME scalel RTLNAME adpcm_main_scalel
    SUBMODULES {
      {MODELNAME adpcm_main_scalel_ilb_table_ROM_AUTO_1R RTLNAME adpcm_main_scalel_ilb_table_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME uppol2 MODELNAME uppol2 RTLNAME adpcm_main_uppol2
    SUBMODULES {
  ...
  {SRCNAME uppol1 MODELNAME uppol1 RTLNAME adpcm_main_uppol1}
  {SRCNAME logsch MODELNAME logsch RTLNAME adpcm_main_logsch
    SUBMODULES {
