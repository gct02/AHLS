...
wire    grp_add_bias_to_activations_clone_1_fu_136_ap_start;
wire    grp_add_bias_to_activations_clone_1_fu_136_ap_done;
wire    grp_add_bias_to_activations_clone_1_fu_136_ap_idle;
wire    grp_add_bias_to_activations_clone_1_fu_136_ap_ready;
wire   [5:0] grp_add_bias_to_activations_clone_1_fu_136_biases2_address0;
wire    grp_add_bias_to_activations_clone_1_fu_136_biases2_ce0;
wire   [5:0] grp_add_bias_to_activations_clone_1_fu_136_activations_address0;
wire    grp_add_bias_to_activations_clone_1_fu_136_activations_ce0;
wire    grp_add_bias_to_activations_clone_1_fu_136_activations_we0;
wire   [63:0] grp_add_bias_to_activations_clone_1_fu_136_activations_d0;
reg   [3:0] i_reg_112;
wire   [0:0] icmp_ln60_fu_175_p2;
reg   [63:0] add113_reg_123;
reg    grp_add_bias_to_activations_clone_1_fu_136_ap_start_reg;
...
initial begin
#0 ap_CS_fsm = 13'd1;
#0 grp_add_bias_to_activations_clone_1_fu_136_ap_start_reg = 1'b0;
#0 phi_mul_fu_60 = 10'd0;
#0 j_fu_64 = 7'd0;
end

backprop_add_bias_to_activations_clone_1 grp_add_bias_to_activations_clone_1_fu_136(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_add_bias_to_activations_clone_1_fu_136_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln60_fu_175_p2 == 1'd1))) begin
            grp_add_bias_to_activations_clone_1_fu_136_ap_start_reg <= 1'b1;
        end else if ((grp_add_bias_to_activations_clone_1_fu_136_ap_ready == 1'b1)) begin
            grp_add_bias_to_activations_clone_1_fu_136_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_add_bias_to_activations_clone_1_fu_136_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)) | ((1'b1 == ap_CS_fsm_state13) & (grp_add_bias_to_activations_clone_1_fu_136_ap_done == 1'b1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state13) & (grp_add_bias_to_activations_clone_1_fu_136_ap_done == 1'b1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign add_ln64_fu_198_p2 = (i_reg_112 + 4'd1);
...
assign biases1_address0 = grp_add_bias_to_activations_clone_1_fu_136_biases2_address0;

assign biases1_ce0 = grp_add_bias_to_activations_clone_1_fu_136_biases2_ce0;

assign bitcast_ln66_1_fu_244_p1 = training_data_load_reg_311;

assign bitcast_ln66_fu_239_p1 = weights1_q0;

assign grp_add_bias_to_activations_clone_1_fu_136_ap_start = grp_add_bias_to_activations_clone_1_fu_136_ap_start_reg;

assign grp_fu_990_p_ce = 1'b1;

assign grp_fu_990_p_din0 = add113_reg_123;

assign grp_fu_990_p_din1 = mul8_reg_326;

assign grp_fu_990_p_opcode = 2'd0;

assign grp_fu_994_p_ce = 1'b1;

assign grp_fu_994_p_din0 = bitcast_ln66_fu_239_p1;

assign grp_fu_994_p_din1 = bitcast_ln66_1_fu_244_p1;

assign icmp_ln60_fu_175_p2 = ((j_fu_64 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln64_fu_192_p2 = ((i_reg_112 == 4'd13) ? 1'b1 : 1'b0);
...
assign zext_ln64_1_fu_208_p1 = i_reg_112;

assign zext_ln64_fu_204_p1 = i_reg_112;
