...
set portList { 
	...
	{ activations_q0 sc_in sc_lv 64 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "biases1", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_add_bias_to_activations_clone_1_fu_136", "Port" : "biases2", "Inst_start_state" : "2", "Inst_end_state" : "13"}]},
			{"Name" : "weights1", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "activations", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_add_bias_to_activations_clone_1_fu_136", "Port" : "activations", "Inst_start_state" : "2", "Inst_end_state" : "13"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_add_bias_to_activations_clone_1_fu_136", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_add_bias_to_activations_clone_1_fu_136.dadd_64ns_64ns_64_4_full_dsp_1_U1", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "8771", "Max" : "8771"}
	, {"Name" : "Interval", "Min" : "8771", "Max" : "8771"}
]}
...
set Spec2ImplPortList { 
	...
	activations { ap_memory {  { activations_address0 mem_address 1 6 }  { activations_ce0 mem_ce 1 1 }  { activations_we0 mem_we 1 1 }  { activations_d0 mem_din 1 64 }  { activations_q0 mem_dout 0 64 } } }
