...
(* CORE_GENERATION_INFO="Gsm_LPC_Analysis_Gsm_LPC_Analysis,hls_ip_2023_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu50-fsvh2104-2-e,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.672063,HLS_SYN_LAT=1999,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2427,HLS_SYN_LUT=7658,HLS_VERSION=2023_2}" *)
...
wire    grp_Autocorrelation_fu_103_indata_we1;
wire   [15:0] grp_Autocorrelation_fu_103_indata_d1;
...
Gsm_LPC_Analysis_Autocorrelation grp_Autocorrelation_fu_103(
    ...
    .indata_we1(grp_Autocorrelation_fu_103_indata_we1),
    .indata_d1(grp_Autocorrelation_fu_103_indata_d1),
    .indata_q1(indata_q1),
    ...
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln248_fu_144_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter0 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter0 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln248_fu_144_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
assign indata_d1 = grp_Autocorrelation_fu_103_indata_d1;

assign indata_we0 = grp_Autocorrelation_fu_103_indata_we0;

assign indata_we1 = grp_Autocorrelation_fu_103_indata_we1;
