set moduleName Autocorrelation_Pipeline_Autocorrelation_label3
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "L_ACF_load_9", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln123", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln123 sc_in sc_lv 64 signal 4 } 
	{ add_ln122 sc_in sc_lv 64 signal 5 } 
	{ add_ln121 sc_in sc_lv 64 signal 6 } 
	{ add_ln120 sc_in sc_lv 64 signal 7 } 
	{ add_ln119 sc_in sc_lv 64 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln123", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add_ln123", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln123 { ap_none {  { add_ln123 in_data 0 64 } } }
