set moduleName Autocorrelation_Pipeline_Autocorrelation_label4
set isTopModule 0
...
set C_modelName {Autocorrelation_Pipeline_Autocorrelation_label4}
set C_modelType { void 0 }
set C_modelArgList {
	{ L_ACF int 64 regular {array 9 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ L_ACF_we0 sc_out sc_logic 1 signal 0 } 
	{ L_ACF_d0 sc_out sc_lv 64 signal 0 } 
	{ L_ACF_address1 sc_out sc_lv 4 signal 0 } 
	{ L_ACF_ce1 sc_out sc_logic 1 signal 0 } 
	{ L_ACF_q1 sc_in sc_lv 64 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	L_ACF { ap_memory {  { L_ACF_address0 mem_address 1 4 }  { L_ACF_ce0 mem_ce 1 1 }  { L_ACF_we0 mem_we 1 1 }  { L_ACF_d0 mem_din 1 64 }  { L_ACF_address1 MemPortADDR2 1 4 }  { L_ACF_ce1 MemPortCE2 1 1 }  { L_ACF_q1 in_data 0 64 } } }
}
