...
set ce_signed 0
set out_width 33
set arg_lists {i0 {16 1 +} i1 {16 1 +} s {17 1 +} i2 {16 1 +} m {33 1 +} i3 {32 1 +} p {33 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3 ALLOW_PRAGMA 1
}
...
set ce_signed 0
set out_width 33
set arg_lists {i0 {16 1 +} i1 {16 1 +} s {17 1 +} i2 {16 1 +} p {33 1 +} c_expval {c} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3 ALLOW_PRAGMA 1
}
...
set ce_signed 0
set out_width 34
set arg_lists {i0 {16 1 +} i1 {16 1 +} s {17 1 +} i2 {16 1 +} m {33 1 +} i3 {33 1 +} p {34 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename L_ACF \
    op interface \
    ports { L_ACF_address0 { O 4 vector } L_ACF_ce0 { O 1 bit } L_ACF_we0 { O 1 bit } L_ACF_d0 { O 64 vector } L_ACF_q0 { I 64 vector } L_ACF_address1 { O 4 vector } L_ACF_ce1 { O 1 bit } L_ACF_we1 { O 1 bit } L_ACF_d1 { O 64 vector } L_ACF_q1 { I 64 vector } } \
} "
} else {
