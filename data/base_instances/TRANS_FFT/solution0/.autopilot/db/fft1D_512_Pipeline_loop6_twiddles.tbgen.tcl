set moduleName fft1D_512_Pipeline_loop6_twiddles
set isTopModule 0
...
set C_modelName {fft1D_512_Pipeline_loop6_twiddles}
set C_modelType { void 0 }
set C_modelArgList {
	{ data_x double 64 regular {array 8 { 2 2 } 1 1 }  }
	{ data_y double 64 regular {array 8 { 2 2 } 1 1 }  }
	{ DATA_x_r double 64 regular {array 512 { 2 2 } 1 1 }  }
	{ DATA_y_r double 64 regular {array 512 { 2 2 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "data_x", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "DATA_x_r", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "DATA_y_r", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ DATA_x_r_q0 sc_in sc_lv 64 signal 2 } 
	...
	{ DATA_x_r_q1 sc_in sc_lv 64 signal 2 } 
	...
	{ DATA_y_r_q0 sc_in sc_lv 64 signal 3 } 
	...
	{ DATA_y_r_q1 sc_in sc_lv 64 signal 3 } 
	{ twiddles8_reversed8_address0 sc_out sc_lv 3 signal 4 } 
	{ twiddles8_reversed8_ce0 sc_out sc_logic 1 signal 4 } 
	{ twiddles8_reversed8_q0 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "DATA_x_r_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "DATA_x_r", "role": "q0" }} , 
 	...
 	{ "name": "DATA_x_r_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "DATA_x_r", "role": "q1" }} , 
 	...
 	{ "name": "DATA_y_r_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "DATA_y_r", "role": "q0" }} , 
 	...
 	{ "name": "DATA_y_r_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "DATA_y_r", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitodp_32ns_64_2_no_dsp_1_U60", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	DATA_x_r { ap_memory {  { DATA_x_r_address0 mem_address 1 9 }  { DATA_x_r_ce0 mem_ce 1 1 }  { DATA_x_r_we0 mem_we 1 1 }  { DATA_x_r_d0 mem_din 1 64 }  { DATA_x_r_q0 in_data 0 64 }  { DATA_x_r_address1 MemPortADDR2 1 9 }  { DATA_x_r_ce1 MemPortCE2 1 1 }  { DATA_x_r_we1 MemPortWE2 1 1 }  { DATA_x_r_d1 MemPortDIN2 1 64 }  { DATA_x_r_q1 in_data 0 64 } } }
	DATA_y_r { ap_memory {  { DATA_y_r_address0 mem_address 1 9 }  { DATA_y_r_ce0 mem_ce 1 1 }  { DATA_y_r_we0 mem_we 1 1 }  { DATA_y_r_d0 mem_din 1 64 }  { DATA_y_r_q0 in_data 0 64 }  { DATA_y_r_address1 MemPortADDR2 1 9 }  { DATA_y_r_ce1 MemPortCE2 1 1 }  { DATA_y_r_we1 MemPortWE2 1 1 }  { DATA_y_r_d1 MemPortDIN2 1 64 }  { DATA_y_r_q1 in_data 0 64 } } }
