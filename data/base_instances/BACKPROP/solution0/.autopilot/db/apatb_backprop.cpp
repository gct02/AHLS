...
extern "C"
void backprop_hw_stub_wrapper(void*, void*, void*, void*, void*, void*, void*, void*);

extern "C"
void apatb_backprop_hw(void* __xlx_apatb_param_weights1, void* __xlx_apatb_param_weights2, void* __xlx_apatb_param_weights3, void* __xlx_apatb_param_biases1, void* __xlx_apatb_param_biases2, void* __xlx_apatb_param_biases3, void* __xlx_apatb_param_training_data, void* __xlx_apatb_param_training_targets)
{
#ifdef USE_BINARY_TV_FILE
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_weights1),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_weights1),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_weights1),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_weights1),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_weights1),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_weights1),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_weights1 };
  port0.nbytes = { 6656 };
  port0.offset = {  };
  port0.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_weights2),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_weights2),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_weights2),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_weights2),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_weights2),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_weights2),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_weights2 };
  port1.nbytes = { 32768 };
  port1.offset = {  };
  port1.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_weights3),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_weights3),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_weights3),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_weights3),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_weights3),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_weights3),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_weights3 };
  port2.nbytes = { 1536 };
  port2.offset = {  };
  port2.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_biases1),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_biases1),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_biases1),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_biases1),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_biases1),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_biases1),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_biases1 };
  port3.nbytes = { 512 };
  port3.offset = {  };
  port3.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_biases2),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_biases2),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_biases2),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_biases2),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_biases2),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_biases2),
#endif
#endif
  };
  port4.param = { __xlx_apatb_param_biases2 };
  port4.nbytes = { 512 };
  port4.offset = {  };
  port4.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_biases3),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_biases3),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_biases3),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_biases3),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_biases3),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_biases3),
#endif
#endif
  };
  port5.param = { __xlx_apatb_param_biases3 };
  port5.nbytes = { 24 };
  port5.offset = {  };
  port5.hasWrite = { true };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port6 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_training_data),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_training_data),
#endif
#endif
  };
  port6.param = { __xlx_apatb_param_training_data };
  port6.nbytes = { 16952 };
  port6.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port7 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_training_targets),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_training_targets),
#endif
#endif
  };
  port7.param = { __xlx_apatb_param_training_targets };
  port7.nbytes = { 3912 };
  port7.offset = {  };
