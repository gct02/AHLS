set moduleName matrix_vector_product_with_bias_input_layer_1
set isTopModule 0
...
set C_modelName {matrix_vector_product_with_bias_input_layer.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ biases1 int 64 regular {array 64 { 1 3 } 1 1 }  }
	{ weights1 int 64 regular {array 832 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ biases1_q0 sc_in sc_lv 64 signal 0 } 
	...
	{ training_data_address0 sc_out sc_lv 12 signal 3 } 
	{ training_data_ce0 sc_out sc_logic 1 signal 3 } 
	{ training_data_q0 sc_in sc_lv 64 signal 3 } 
	{ idx sc_in sc_lv 12 signal 4 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "biases1", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_matrix_vector_product_with_bias_input_layer_1_Pipeline_add_bias_to_activations_l_fu_134", "Port" : "biases1", "Inst_start_state" : "2", "Inst_end_state" : "13"}]},
			{"Name" : "weights1", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "activations", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_matrix_vector_product_with_bias_input_layer_1_Pipeline_add_bias_to_activations_l_fu_134", "Port" : "activations", "Inst_start_state" : "2", "Inst_end_state" : "13"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_matrix_vector_product_with_bias_input_layer_1_Pipeline_add_bias_to_activations_l_fu_134", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_matrix_vector_product_with_bias_input_layer_1_Pipeline_add_bias_to_activations_l_fu_134.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "8519", "Max" : "8519"}
	, {"Name" : "Interval", "Min" : "8519", "Max" : "8519"}
]}
...
set Spec2ImplPortList { 
	...
	weights1 { ap_memory {  { weights1_address0 mem_address 1 10 }  { weights1_ce0 mem_ce 1 1 }  { weights1_q0 in_data 0 64 } } }
