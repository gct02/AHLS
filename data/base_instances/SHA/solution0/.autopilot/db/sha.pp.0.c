...
# 197 "data/benchmarks/sha/sha.c"

    int i, j;
    const unsigned char *p;

    VITIS_LOOP_201_1: for (i = 0; i < 2; i++) {
        VITIS_LOOP_202_2: for (j = 0; j < 8192; j++) {
...
#pragma HLS LOOP_TRIPCOUNT min=2 max=2 avg=2
 i = in_i[j];
    ...
    VITIS_LOOP_219_3: for (i = 0; i < 5; i++) {
