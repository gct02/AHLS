...
module sha_stream_sha_stream_Pipeline_sha_stream_label1_VITIS_LOOP_207_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln205_fu_105_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln209_fu_169_p1;
reg   [63:0] zext_ln209_reg_219;
wire    ap_block_pp0_stage0_11001;
wire    ap_block_pp0_stage0;
reg   [13:0] j_fu_48;
wire   [13:0] add_ln207_fu_174_p2;
wire    ap_loop_init;
reg   [13:0] ap_sig_allocacmp_j_load;
reg   [1:0] i_fu_52;
wire   [1:0] select_ln205_fu_143_p3;
reg   [1:0] ap_sig_allocacmp_i_load;
reg   [14:0] indvar_flatten_fu_56;
wire   [14:0] add_ln205_1_fu_111_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln205_fu_105_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        zext_ln209_reg_219[13 : 0] <= zext_ln209_fu_169_p1[13 : 0];
    end
end

always @ (*) begin
    if (((icmp_ln205_fu_105_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln205_1_fu_111_p2 = (ap_sig_allocacmp_indvar_flatten_load + 15'd1);

assign add_ln205_fu_123_p2 = (ap_sig_allocacmp_i_load + 2'd1);
...
assign icmp_ln205_fu_105_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 15'd16384) ? 1'b1 : 1'b0);

assign icmp_ln207_fu_129_p2 = ((ap_sig_allocacmp_j_load == 14'd8192) ? 1'b1 : 1'b0);

assign indata_address0 = zext_ln209_fu_169_p1;

assign local_indata_address0 = zext_ln209_reg_219;

assign local_indata_d0 = indata_q0;

assign select_ln201_fu_135_p3 = ((icmp_ln207_fu_129_p2[0:0] == 1'b1) ? 14'd0 : ap_sig_allocacmp_j_load);
...
assign zext_ln209_fu_169_p1 = add_ln209_fu_163_p2;

always @ (posedge ap_clk) begin
    zext_ln209_reg_219[63:14] <= 50'b00000000000000000000000000000000000000000000000000;
end

endmodule //sha_stream_sha_stream_Pipeline_sha_stream_label1_VITIS_LOOP_207_1
