...
attribute shreg_extract : string;
    ...
    signal icmp_ln163_reg_320 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_fu_228_p1 : STD_LOGIC_VECTOR (13 downto 0);
    signal trunc_ln163_reg_329 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal select_ln170_fu_279_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln170_reg_334 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln170_1_fu_286_p3 : STD_LOGIC_VECTOR (13 downto 0);
    signal select_ln170_1_reg_339 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal add_ln156_fu_118_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln160_fu_168_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal idx_fu_68 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal add_ln163_fu_239_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal count_addr_02_fu_72 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal add_ln168_fu_233_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal shl_ln156_fu_112_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln156_fu_124_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln157_fu_134_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal lshr_ln_fu_154_p4 : STD_LOGIC_VECTOR (2 downto 0);
    signal select_ln156_fu_140_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln160_fu_164_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal trunc_ln163_1_fu_255_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal zext_ln170_fu_275_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln163_1_fu_219_p2 = ap_const_lv1_0)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln163_1_fu_219_p2 = ap_const_lv1_1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln163_1_fu_219_p2 = ap_const_lv1_1))) then 
                count_addr_02_fu_72 <= add_ln168_fu_233_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                icmp_ln163_reg_320 <= icmp_ln163_fu_184_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                    select_ln170_1_reg_339(13 downto 6) <= select_ln170_1_fu_286_p3(13 downto 6);
                select_ln170_reg_334 <= select_ln170_fu_279_p3;
                trunc_ln163_reg_329 <= trunc_ln163_fu_228_p1;
            end if;
        end if;
    end process;
    select_ln170_1_reg_339(5 downto 0) <= "000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, grp_local_memcpy_fu_88_ap_done, grp_sha_transform_fu_100_ap_done, icmp_ln163_1_fu_219_p2, ap_CS_fsm_state3, ap_CS_fsm_state6, ap_CS_fsm_state5)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln163_1_fu_219_p2 = ap_const_lv1_0))) then
    ...
    add_ln156_fu_118_p2 <= std_logic_vector(unsigned(sha_info_count_lo_i) + unsigned(shl_ln156_fu_112_p2));
    add_ln157_fu_134_p2 <= std_logic_vector(unsigned(sha_info_count_hi_i) + unsigned(ap_const_lv32_1));
    add_ln160_fu_168_p2 <= std_logic_vector(unsigned(select_ln156_fu_140_p3) + unsigned(zext_ln160_fu_164_p1));
    add_ln163_fu_239_p2 <= std_logic_vector(unsigned(idx_fu_68) + unsigned(ap_const_lv32_40));
    add_ln168_fu_233_p2 <= std_logic_vector(unsigned(count_addr_02_fu_72) + unsigned(ap_const_lv32_FFFFFFC0));
    ...
    grp_local_memcpy_fu_88_idx1_assign_proc : process(trunc_ln163_reg_329, select_ln170_1_reg_339, ap_CS_fsm_state3, ap_CS_fsm_state6)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            grp_local_memcpy_fu_88_idx1 <= select_ln170_1_reg_339;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            grp_local_memcpy_fu_88_idx1 <= trunc_ln163_reg_329;
        else 
    ...
    grp_local_memcpy_fu_88_n_assign_proc : process(select_ln170_reg_334, ap_CS_fsm_state3, ap_CS_fsm_state6)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            grp_local_memcpy_fu_88_n <= select_ln170_reg_334;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
    ...
    icmp_ln156_fu_124_p2 <= "1" when (unsigned(add_ln156_fu_118_p2) < unsigned(sha_info_count_lo_i)) else "0";
    icmp_ln163_1_fu_219_p2 <= "1" when (signed(tmp_2_fu_209_p4) > signed(ap_const_lv26_0)) else "0";
    icmp_ln163_fu_184_p2 <= "1" when (signed(tmp_fu_174_p4) > signed(ap_const_lv26_0)) else "0";
    lshr_ln_fu_154_p4 <= count(31 downto 29);
    select_ln156_fu_140_p3 <= 
        add_ln157_fu_134_p2 when (icmp_ln156_fu_124_p2(0) = '1') else 
        sha_info_count_hi_i;
    select_ln170_1_fu_286_p3 <= 
        and_ln_fu_267_p3 when (icmp_ln163_reg_320(0) = '1') else 
        ap_const_lv14_0;
    select_ln170_fu_279_p3 <= 
        zext_ln170_fu_275_p1 when (icmp_ln163_reg_320(0) = '1') else 
        count;

    sha_info_count_hi_o_assign_proc : process(ap_CS_fsm_state1, sha_info_count_hi_i, add_ln160_fu_168_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
            sha_info_count_hi_o <= add_ln160_fu_168_p2;
        else 
    ...
    sha_info_count_lo_o_assign_proc : process(ap_CS_fsm_state1, sha_info_count_lo_i, add_ln156_fu_118_p2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
            sha_info_count_lo_o <= add_ln156_fu_118_p2;
        else 
    ...
    sha_info_digest_we0 <= grp_sha_transform_fu_100_sha_info_digest_we0;
    sha_info_digest_we1 <= grp_sha_transform_fu_100_sha_info_digest_we1;
    shl_ln156_fu_112_p2 <= std_logic_vector(shift_left(unsigned(count),to_integer(unsigned('0' & ap_const_lv32_3(31-1 downto 0)))));
    tmp_1_fu_258_p4 <= count(13 downto 6);
    tmp_2_fu_209_p4 <= count_addr_02_fu_72(31 downto 6);
    tmp_fu_174_p4 <= count(31 downto 6);
    trunc_ln163_1_fu_255_p1 <= count(6 - 1 downto 0);
    trunc_ln163_fu_228_p1 <= idx_fu_68(14 - 1 downto 0);
    zext_ln160_fu_164_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln_fu_154_p4),32));
    zext_ln170_fu_275_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln163_1_fu_255_p1),32));
end behav;
