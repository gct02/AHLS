...
wire   [3:0] trunc_ln175_fu_114_p1;
reg   [3:0] trunc_ln175_reg_154;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln182_fu_119_p2;
reg   [0:0] icmp_ln182_reg_159;
wire   [6:0] sub_ln187_fu_125_p2;
reg   [6:0] sub_ln187_reg_163;
wire   [6:0] zext_ln183_fu_137_p1;
reg   [6:0] zext_ln183_reg_168;
...
wire   [63:0] zext_ln180_fu_96_p1;
wire    ap_CS_fsm_state9;
wire   [6:0] zext_ln175_fu_105_p1;
wire   [6:0] count_1_fu_108_p2;
wire   [5:0] xor_ln183_fu_132_p2;
reg   [10:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state7) | ((icmp_ln182_fu_119_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)) | ((icmp_ln182_fu_119_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        zext_ln183_reg_168[5 : 0] <= zext_ln183_fu_137_p1[5 : 0];
    end
end
...
always @ (*) begin
    if (((icmp_ln182_reg_159 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        sha_info_data_address0 = zext_ln180_fu_96_p1;
    end else if (((1'b1 == ap_CS_fsm_state11) | (1'b1 == ap_CS_fsm_state6))) begin
        sha_info_data_address0 = grp_sha_transform_fu_74_sha_info_data_address0;
    end else if (((1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | ((icmp_ln182_reg_159 == 1'd1) & (1'b1 == ap_CS_fsm_state8)))) begin
        sha_info_data_address0 = grp_local_memset_fu_64_sha_info_data_address0;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((icmp_ln182_fu_119_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state8_on_subcall_done = ((grp_local_memset_fu_64_ap_done == 1'b0) & (icmp_ln182_reg_159 == 1'd1));
end

assign count_1_fu_108_p2 = (zext_ln175_fu_105_p1 + 7'd1);
...
assign icmp_ln182_fu_119_p2 = ((count_1_fu_108_p2 > 7'd56) ? 1'b1 : 1'b0);
...
assign sub_ln187_fu_125_p2 = (7'd55 - zext_ln175_fu_105_p1);

assign trunc_ln175_fu_114_p1 = count_1_fu_108_p2[3:0];

assign xor_ln183_fu_132_p2 = (count_reg_145 ^ 6'd63);

assign zext_ln175_fu_105_p1 = count_reg_145;

assign zext_ln180_fu_96_p1 = count_fu_86_p4;

assign zext_ln183_fu_137_p1 = xor_ln183_fu_132_p2;

always @ (posedge ap_clk) begin
    zext_ln183_reg_168[6] <= 1'b0;
end
