...
int MixColumn_AddRoundKey (int statemt[32], int nb, int n) {
    ...
    for (j = 0; j < nb; ++j) {
#line 19 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
...
#pragma HLS LOOP_TRIPCOUNT min=4 max=8 avg=6
 ret[j * 4] = (statemt[j * 4] << 1);
    ...
    for (j = 0; j < nb; ++j) {
#line 20 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
...
int AddRoundKey_InversMixColumn (int statemt[32], int nb, int n) {
    ...
    for (j = 0; j < nb; ++j) {
#line 12 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
...
#pragma HLS LOOP_TRIPCOUNT min=4 max=8 avg=6
 statemt[j * 4] ^= word[0][j + nb * n];
    ...
    for (j = 0; j < nb; ++j) {
#line 10 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
...
#pragma HLS LOOP_TRIPCOUNT min=4 max=8 avg=6
 AddRoundKey_InversMixColumn_label1:
        for (i = 0; i < 4; ++i) {
#line 11 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
...
#pragma HLS LOOP_TRIPCOUNT min=4 max=4 avg=4
 x = (statemt[i + j * 4] << 1);
    ...
    for (i = 0; i < nb; ++i) {
#line 13 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
...
int AddRoundKey (int statemt[32], int type, int n) {
    ...
    AddRoundKey_label0:
    for (j = 0; j < nb; ++j) {
#line 18 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
...
int KeySchedule (int type, int key[32]) {
    ...
    KeySchedule_label4:
    for (j = 0; j < nk; ++j) {
#line 21 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
...
#pragma HLS LOOP_TRIPCOUNT min=4 max=8 avg=6
 KeySchedule_label5:
        for (i = 0; i < 4; ++i) {
#line 22 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
...
#line 23 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
...
#pragma HLS LOOP_TRIPCOUNT min=32 max=116 avg=74
 KeySchedule_label7:
        ...
        if (nk > 6 && j % nk == 4) {
            KeySchedule_label8:
            for (i = 0; i < 4; ++i) {
#line 16 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
...
#pragma HLS LOOP_TRIPCOUNT min=4 max=4 avg=4
 temp[i] = Sbox[(temp[i] / 16)][(temp[i] % 16)];
        ...
        KeySchedule_label9:
        for (i = 0; i < 4; ++i) {
#line 17 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/vitis/run_hls.tcl"
#pragma HLSDIRECTIVE PIPELINE off=true
