set SynModuleInfo {
  {SRCNAME ByteSub_ShiftRow MODELNAME ByteSub_ShiftRow RTLNAME aes_main_ByteSub_ShiftRow
    SUBMODULES {
      {MODELNAME aes_main_ByteSub_ShiftRow_Sbox_1_ROM_AUTO_1R RTLNAME aes_main_ByteSub_ShiftRow_Sbox_1_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME aes_main MODELNAME aes_main RTLNAME aes_main IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME aes_main_Rcon0_ROM_AUTO_1R RTLNAME aes_main_Rcon0_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
}
