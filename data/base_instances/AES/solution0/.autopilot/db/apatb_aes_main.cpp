...
#define AUTOTB_TVOUT_key "../tv/cdatafile/c.aes_main.autotvout_key.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.aes_main.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_statemt "../tv/rtldatafile/rtl.aes_main.autotvout_statemt.dat"
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.aes_main.autotvout_ap_return.dat"
...
extern "C"
hls::sim::Byte<4> aes_main_hw_stub_wrapper(void*, void*);

extern "C"
hls::sim::Byte<4> apatb_aes_main_hw(void* __xlx_apatb_param_statemt, void* __xlx_apatb_param_key)
{
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_statemt),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_statemt),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_statemt),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_statemt),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_statemt),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_statemt),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_statemt };
  port1.nbytes = { 128 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  port2.param = { __xlx_apatb_param_key };
  port2.nbytes = { 128 };
  port2.offset = {  };
  ...
  try {
    ...
    ap_return = aes_main_hw_stub_wrapper(__xlx_apatb_param_statemt, __xlx_apatb_param_key);
