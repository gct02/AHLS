...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("orig_address0", 11, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("orig_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("orig_q0", 32, hls_in, 1, "ap_memory", "in_data", 1),
	Port_Property("orig_address1", 11, hls_out, 1, "ap_memory", "MemPortADDR2", 1),
	Port_Property("orig_ce1", 1, hls_out, 1, "ap_memory", "MemPortCE2", 1),
	Port_Property("orig_q1", 32, hls_in, 1, "ap_memory", "in_data", 1),
	Port_Property("sol_address0", 11, hls_out, 2, "ap_memory", "mem_address", 1),
	...
	Port_Property("sol_address1", 11, hls_out, 2, "ap_memory", "MemPortADDR2", 1),
