...
using hls::sim::Byte;
extern "C" void stencil3d(Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_stencil3d_hw(volatile void * __xlx_apatb_param_C, volatile void * __xlx_apatb_param_orig, volatile void * __xlx_apatb_param_sol) {
...
__xlx_orig__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_orig)[i]);
  ...
  int __xlx_size_param_orig = 2048;
...
__xlx_sol__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_sol)[i]);
  ...
  int __xlx_size_param_sol = 2048;
  int __xlx_offset_param_sol = 0;
  int __xlx_offset_byte_param_sol = 0*4;
  // DUT call
  stencil3d(__xlx_C__tmp_vec.data(), __xlx_orig__tmp_vec.data(), __xlx_sol__tmp_vec.data());
