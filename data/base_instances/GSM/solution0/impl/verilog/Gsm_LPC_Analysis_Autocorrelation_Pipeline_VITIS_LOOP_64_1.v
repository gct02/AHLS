...
module Gsm_LPC_Analysis_Autocorrelation_Pipeline_VITIS_LOOP_64_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln64_fu_83_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [30:0] zext_ln64_cast_fu_71_p1;
reg   [30:0] zext_ln64_cast_reg_134;
...
wire   [63:0] zext_ln64_1_fu_95_p1;
wire    ap_block_pp0_stage0;
reg   [7:0] k_2_fu_44;
wire   [7:0] add_ln64_fu_89_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln64_fu_83_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        indata_addr_reg_143 <= zext_ln64_1_fu_95_p1;
        indata_addr_reg_143_pp0_iter1_reg <= indata_addr_reg_143;
        zext_ln64_cast_reg_134[14 : 0] <= zext_ln64_cast_fu_71_p1[14 : 0];
    end
end
...
always @ (*) begin
    if (((icmp_ln64_fu_83_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln64_fu_89_p2 = (ap_sig_allocacmp_k + 8'd1);
...
assign grp_fu_119_p1 = zext_ln64_cast_reg_134;

assign grp_fu_119_p2 = 31'd16384;

assign icmp_ln64_fu_83_p2 = ((ap_sig_allocacmp_k == 8'd160) ? 1'b1 : 1'b0);

assign indata_address0 = indata_addr_reg_143_pp0_iter3_reg;

assign indata_address1 = zext_ln64_1_fu_95_p1;

assign indata_d0 = {{trunc_ln_fu_109_p1[30:15]}};

assign trunc_ln_fu_109_p1 = grp_fu_119_p3;

assign zext_ln64_1_fu_95_p1 = ap_sig_allocacmp_k;

assign zext_ln64_cast_fu_71_p1 = zext_ln64;

always @ (posedge ap_clk) begin
    zext_ln64_cast_reg_134[30:15] <= 16'b0000000000000000;
end

endmodule //Gsm_LPC_Analysis_Autocorrelation_Pipeline_VITIS_LOOP_64_1
