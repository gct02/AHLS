set SynModuleInfo {
  {SRCNAME Autocorrelation_Pipeline_Autocorrelation_label0 MODELNAME Autocorrelation_Pipeline_Autocorrelation_label0 RTLNAME Gsm_LPC_Analysis_Autocorrelation_Pipeline_Autocorrelation_label0
    SUBMODULES {
  ...
  {SRCNAME Reflection_coefficients_Pipeline_gsm_div_label0 MODELNAME Reflection_coefficients_Pipeline_gsm_div_label0 RTLNAME Gsm_LPC_Analysis_Reflection_coefficients_Pipeline_gsm_div_label0}
  ...
  {SRCNAME Gsm_LPC_Analysis MODELNAME Gsm_LPC_Analysis RTLNAME Gsm_LPC_Analysis IS_TOP 1
    SUBMODULES {
      {MODELNAME Gsm_LPC_Analysis_bitoff_ROM_AUTO_1R RTLNAME Gsm_LPC_Analysis_bitoff_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
