set moduleName Transformation_to_Log_Area_Ratios
set isTopModule 0
...
set C_modelName {Transformation_to_Log_Area_Ratios}
set C_modelType { void 0 }
set C_modelArgList {
	{ LARc int 16 regular {array 8 { 2 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	LARc { ap_memory {  { LARc_address0 mem_address 1 3 }  { LARc_ce0 mem_ce 1 1 }  { LARc_we0 mem_we 1 1 }  { LARc_d0 mem_din 1 16 }  { LARc_q0 in_data 0 16 } } }
}
