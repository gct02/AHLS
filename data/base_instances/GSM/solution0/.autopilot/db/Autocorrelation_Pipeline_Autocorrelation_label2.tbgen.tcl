set moduleName Autocorrelation_Pipeline_Autocorrelation_label2
set isTopModule 0
...
set C_modelName {Autocorrelation_Pipeline_Autocorrelation_label2}
set C_modelType { void 0 }
set C_modelArgList {
	{ L_ACF int 64 regular {array 9 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "L_ACF", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	L_ACF { ap_memory {  { L_ACF_address0 mem_address 1 4 }  { L_ACF_ce0 mem_ce 1 1 }  { L_ACF_we0 mem_we 1 1 }  { L_ACF_d0 mem_din 1 64 } } }
}
