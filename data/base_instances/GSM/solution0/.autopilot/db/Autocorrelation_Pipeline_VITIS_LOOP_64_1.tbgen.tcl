set moduleName Autocorrelation_Pipeline_VITIS_LOOP_64_1
set isTopModule 0
...
set C_modelName {Autocorrelation_Pipeline_VITIS_LOOP_64_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ indata int 16 regular {array 160 { 0 1 } 1 1 }  }
	{ zext_ln64 int 15 regular  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "indata", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} , 
 	{ "Name" : "zext_ln64", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ zext_ln64 sc_in sc_lv 15 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln64", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "zext_ln64", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	zext_ln64 { ap_none {  { zext_ln64 in_data 0 15 } } }
}
