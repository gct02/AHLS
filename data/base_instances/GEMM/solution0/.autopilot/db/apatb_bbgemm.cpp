...
extern "C"
void bbgemm_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_bbgemm_hw(void* __xlx_apatb_param_m1, void* __xlx_apatb_param_m2, void* __xlx_apatb_param_prod)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_m1),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_m1),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_m1 };
  port0.nbytes = { 32768 };
  port0.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_m2),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_m2),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_m2 };
  port1.nbytes = { 32768 };
  port1.offset = {  };
