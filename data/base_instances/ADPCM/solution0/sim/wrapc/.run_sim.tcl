...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "adpcm_main.autotvin.dat"
	set constFileTvOut       "adpcm_main.autotvout.dat"
	set constFileHdlTvIn     "adpcm_main.autohdltvin.dat"
	set constFileHdlTvOut    "adpcm_main.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
