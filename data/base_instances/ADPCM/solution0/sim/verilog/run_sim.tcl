...
if {[file isfile adpcm_main.autotvin.dat]} {
	file delete -force adpcm_main.autotvin.dat
}

if {[file isfile adpcm_main.autotvout.dat]} {
	file delete -force adpcm_main.autotvout.dat
}
