...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.adpcm_main.autotvin_in_data.dat"
         "c.adpcm_main.autotvin_encoded.dat"
         "c.adpcm_main.autotvin_decoded.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.adpcm_main.autotvout_encoded.dat"
         "rtl.adpcm_main.autotvout_decoded.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
