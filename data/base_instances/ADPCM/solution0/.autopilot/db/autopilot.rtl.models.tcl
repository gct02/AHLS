set SynModuleInfo {
  {SRCNAME encode MODELNAME encode RTLNAME adpcm_main_encode
    SUBMODULES {
      {MODELNAME adpcm_main_mul_14s_32s_46_1_1 RTLNAME adpcm_main_mul_14s_32s_46_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      ...
      {MODELNAME adpcm_main_mul_14s_14s_28_1_1 RTLNAME adpcm_main_mul_14s_14s_28_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME adpcm_main_encode_decis_levl_ROM_AUTO_1R RTLNAME adpcm_main_encode_decis_levl_ROM_AUTO_1R BINDTYPE storage TYPE rom IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
