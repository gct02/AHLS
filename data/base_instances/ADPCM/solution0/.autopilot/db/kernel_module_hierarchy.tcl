...
"SubInsts" : [
	{"Name" : "grp_reset_fu_241","ID" : "1","Type" : "sequential",
		"SubLoops" : [
...
"SubLoops" : [
	...
	"SubInsts" : [
	{"Name" : "grp_encode_fu_331","ID" : "7","Type" : "sequential",
			"SubInsts" : [
			{"Name" : "grp_filtez_fu_426","ID" : "8","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "filtez_label8","ID" : "9","Type" : "no"},]},
			{"Name" : "grp_quantl_fu_436","ID" : "10","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "quantl_label9","ID" : "11","Type" : "no"},]},
			{"Name" : "grp_upzero_fu_448","ID" : "12","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "upzero_label10","ID" : "13","Type" : "no"},
				{"Name" : "upzero_label11","ID" : "14","Type" : "no"},]},
			{"Name" : "grp_upzero_fu_457","ID" : "15","Type" : "sequential",
				"SubLoops" : [
	...
	"SubInsts" : [
	{"Name" : "grp_decode_fu_397","ID" : "21","Type" : "sequential",
			"SubInsts" : [
			{"Name" : "grp_filtez_fu_427","ID" : "22","Type" : "sequential",
				"SubLoops" : [
				{"Name" : "filtez_label8","ID" : "23","Type" : "no"},]},
			{"Name" : "grp_upzero_fu_437","ID" : "24","Type" : "sequential",
				"SubLoops" : [
