...
if { $bench_exec == 1 } { # Face detection
	...
	add_files { 
		benchmarks/rosetta/face-detection/src/face_detect.cpp 
	}
	add_files -tb {
	...
	add_files { 
		benchmarks/rosetta/digit-recognition/src/digitrec.cpp 
	}
	add_files -tb {
	...
	add_files { 
		benchmarks/rosetta/3d-rendering/src/rendering.cpp 
	}
	add_files -tb {
	...
	add_files { 
		benchmarks/rosetta/spam-filter/src/sgd.cpp 
	}
	add_files -tb {
	...
	add_files { 
		benchmarks/chstone/adpcm/src/adpcm.c 
	}
	add_files -tb { 
