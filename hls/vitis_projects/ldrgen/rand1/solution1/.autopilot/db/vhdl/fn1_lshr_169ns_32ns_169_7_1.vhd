...
entity fn1_lshr_169ns_32ns_169_7_1 is
    generic (
      ID         : INTEGER := 1;                            --core ID,       unused in RTL
      din0_WIDTH : INTEGER := 169;                 --data bitwidth
      din1_WIDTH : INTEGER := 169;                 --shift control bitwidth
      dout_WIDTH : INTEGER := 169;                 --output bitwidth
...
end entity fn1_lshr_169ns_32ns_169_7_1;
architecture rtl of fn1_lshr_169ns_32ns_169_7_1 is
