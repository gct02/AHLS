...
entity fn1_lshr_111ns_32ns_111_2_1 is
    generic (
      ID         : INTEGER := 1;                            --core ID,       unused in RTL
      din0_WIDTH : INTEGER := 111;                 --data bitwidth
      din1_WIDTH : INTEGER := 111;                 --shift control bitwidth
      dout_WIDTH : INTEGER := 111;                 --output bitwidth
...
end entity fn1_lshr_111ns_32ns_111_2_1;
architecture rtl of fn1_lshr_111ns_32ns_111_2_1 is
