set moduleName adpcm_main_Pipeline_reset_label4
set isTopModule 0
...
set C_modelName {adpcm_main_Pipeline_reset_label4}
set C_modelType { void 0 }
set C_modelArgList {
	{ delay_dltx int 16 regular {array 6 { 0 3 } 0 1 } {global 1}  }
	{ delay_dhx int 14 regular {array 6 { 0 3 } 0 1 } {global 1}  }
	{ dec_del_dltx int 16 regular {array 6 { 0 3 } 0 1 } {global 1}  }
	{ dec_del_dhx int 14 regular {array 6 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "delay_dltx", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "delay_dhx", "interface" : "memory", "bitwidth" : 14, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "dec_del_dltx", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "dec_del_dhx", "interface" : "memory", "bitwidth" : 14, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ delay_dltx_address0 sc_out sc_lv 3 signal 0 } 
	{ delay_dltx_ce0 sc_out sc_logic 1 signal 0 } 
	{ delay_dltx_we0 sc_out sc_logic 1 signal 0 } 
	{ delay_dltx_d0 sc_out sc_lv 16 signal 0 } 
	{ delay_dhx_address0 sc_out sc_lv 3 signal 1 } 
	{ delay_dhx_ce0 sc_out sc_logic 1 signal 1 } 
	{ delay_dhx_we0 sc_out sc_logic 1 signal 1 } 
	{ delay_dhx_d0 sc_out sc_lv 14 signal 1 } 
	...
	{ dec_del_dhx_address0 sc_out sc_lv 3 signal 3 } 
	{ dec_del_dhx_ce0 sc_out sc_logic 1 signal 3 } 
	{ dec_del_dhx_we0 sc_out sc_logic 1 signal 3 } 
	{ dec_del_dhx_d0 sc_out sc_lv 14 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	delay_dhx { ap_memory {  { delay_dhx_address0 mem_address 1 3 }  { delay_dhx_ce0 mem_ce 1 1 }  { delay_dhx_we0 mem_we 1 1 }  { delay_dhx_d0 mem_din 1 14 } } }
	...
	dec_del_dhx { ap_memory {  { dec_del_dhx_address0 mem_address 1 3 }  { dec_del_dhx_ce0 mem_ce 1 1 }  { dec_del_dhx_we0 mem_we 1 1 }  { dec_del_dhx_d0 mem_din 1 14 } } }
}
