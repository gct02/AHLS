set moduleName rendering_Pipeline_COLORING_FB_INIT_ROW_COLORING_FB_INIT_COL
set isTopModule 0
...
set C_modelName {rendering_Pipeline_COLORING_FB_INIT_ROW_COLORING_FB_INIT_COL}
...
set portList { 
	...
	{ output_r_address0 sc_out sc_lv 16 signal 0 } 
