...
extern "C" void rendering(volatile void *, Byte<1>*, int);
extern "C" void apatb_rendering_hw(volatile void * __xlx_apatb_param_triangle_3ds, volatile void * __xlx_apatb_param_output_r, int __xlx_apatb_param_num_3d_tri) {
...
__xlx_output_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_size_param_output_r = 65536;
  int __xlx_offset_param_output_r = 0;
  int __xlx_offset_byte_param_output_r = 0*1;
  // DUT call
  rendering(__xlx_apatb_param_triangle_3ds, __xlx_output_r__tmp_vec.data(), __xlx_apatb_param_num_3d_tri);
