...
entity face_detect_lshr_79ns_32ns_79_2_1 is
    generic (
      ID         : INTEGER := 1;                            --core ID,       unused in RTL
      din0_WIDTH : INTEGER := 79;                 --data bitwidth
      din1_WIDTH : INTEGER := 79;                 --shift control bitwidth
      dout_WIDTH : INTEGER := 79;                 --output bitwidth
...
end entity face_detect_lshr_79ns_32ns_79_2_1;
architecture rtl of face_detect_lshr_79ns_32ns_79_2_1 is
