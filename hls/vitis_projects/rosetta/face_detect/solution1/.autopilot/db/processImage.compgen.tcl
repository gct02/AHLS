...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler face_detect_lshr_137ns_32ns_137_7_1 BINDTYPE {op} TYPE {lshr} IMPL {auto_pipe} LATENCY 6
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler face_detect_shl_137ns_32ns_137_7_1 BINDTYPE {op} TYPE {shl} IMPL {auto_pipe} LATENCY 6
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler face_detect_processImage_SUM1_data_RAM_1WNR_AUTO_1R1W BINDTYPE {storage} TYPE {ram_1wnr} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler face_detect_processImage_SQSUM1_data_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
