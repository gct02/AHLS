...
extern "C" void apatb_face_detect_hw(volatile void * __xlx_apatb_param_Data, volatile void * __xlx_apatb_param_result_x, volatile void * __xlx_apatb_param_result_y, volatile void * __xlx_apatb_param_result_w, volatile void * __xlx_apatb_param_result_h, volatile void * __xlx_apatb_param_result_size) {
using hls::sim::createStream;
  // Collect __xlx_Data__tmp_vec
std::vector<Byte<1>> __xlx_Data__tmp_vec;
for (size_t i = 0; i < 76800; ++i){
__xlx_Data__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_Data)[i]);
}
  int __xlx_size_param_Data = 76800;
...
__xlx_result_h__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_result_h)[i]);
  ...
  // DUT call
  face_detect(__xlx_Data__tmp_vec.data(), __xlx_result_x__tmp_vec.data(), __xlx_result_y__tmp_vec.data(), __xlx_result_w__tmp_vec.data(), __xlx_result_h__tmp_vec.data(), __xlx_apatb_param_result_size);
// print __xlx_apatb_param_Data
for (size_t i = 0; i < __xlx_size_param_Data; ++i) {
((Byte<1>*)__xlx_apatb_param_Data)[i] = __xlx_Data__tmp_vec[__xlx_offset_param_Data+i];
}
