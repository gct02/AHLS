...
entity face_detect_lshr_137ns_32ns_137_7_1 is
    generic (
      ID         : INTEGER := 1;                            --core ID,       unused in RTL
      din0_WIDTH : INTEGER := 137;                 --data bitwidth
      din1_WIDTH : INTEGER := 137;                 --shift control bitwidth
      dout_WIDTH : INTEGER := 137;                 --output bitwidth
...
end entity face_detect_lshr_137ns_32ns_137_7_1;
architecture rtl of face_detect_lshr_137ns_32ns_137_7_1 is
