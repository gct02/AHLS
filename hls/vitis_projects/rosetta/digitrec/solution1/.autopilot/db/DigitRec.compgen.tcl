...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler DigitRec_votes_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename results \
    op interface \
    ports { results_address0 { O 9 vector } results_ce0 { O 1 bit } results_we0 { O 1 bit } results_d0 { O 8 vector } } \
} "
} else {
