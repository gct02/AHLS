set moduleName DigitRec_Pipeline_3
set isTopModule 0
...
set C_modelName {DigitRec_Pipeline_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ votes int 32 regular {array 10 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "votes", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ votes_we0 sc_out sc_logic 1 signal 0 } 
	{ votes_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	votes { ap_memory {  { votes_address0 mem_address 1 4 }  { votes_ce0 mem_ce 1 1 }  { votes_we0 mem_we 1 1 }  { votes_d0 mem_din 1 32 } } }
}
