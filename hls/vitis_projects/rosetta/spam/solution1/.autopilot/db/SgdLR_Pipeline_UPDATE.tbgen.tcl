set moduleName SgdLR_Pipeline_UPDATE
set isTopModule 0
...
set C_modelName {SgdLR_Pipeline_UPDATE}
set C_modelType { void 0 }
set C_modelArgList {
	{ gradient float 32 regular {array 1024 { 1 3 } 1 1 }  }
	{ theta int 32 regular {array 1024 { 0 1 } 1 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "gradient", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ gradient_address0 sc_out sc_lv 10 signal 0 } 
	{ gradient_ce0 sc_out sc_logic 1 signal 0 } 
	{ gradient_q0 sc_in sc_lv 32 signal 0 } 
	{ theta_address0 sc_out sc_lv 10 signal 1 } 
	{ theta_ce0 sc_out sc_logic 1 signal 1 } 
	{ theta_we0 sc_out sc_logic 1 signal 1 } 
	{ theta_d0 sc_out sc_lv 32 signal 1 } 
	{ theta_address1 sc_out sc_lv 10 signal 1 } 
	{ theta_ce1 sc_out sc_logic 1 signal 1 } 
	{ theta_q1 sc_in sc_lv 32 signal 1 } 
	{ grp_fu_119_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_119_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_119_p_opcode sc_out sc_lv 1 signal -1 } 
	{ grp_fu_119_p_dout0 sc_in sc_lv 32 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "gradient_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "gradient", "role": "q0" }} , 
 	...
 	{ "name": "grp_fu_119_p_din1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_119_p_din1", "role": "default" }} , 
 	{ "name": "grp_fu_119_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_119_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_119_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_119_p_dout0", "role": "default" }} , 
...
set Spec2ImplPortList { 
	gradient { ap_memory {  { gradient_address0 mem_address 1 10 }  { gradient_ce0 mem_ce 1 1 }  { gradient_q0 mem_dout 0 32 } } }
	theta { ap_memory {  { theta_address0 mem_address 1 10 }  { theta_ce0 mem_ce 1 1 }  { theta_we0 mem_we 1 1 }  { theta_d0 mem_din 1 32 }  { theta_address1 MemPortADDR2 1 10 }  { theta_ce1 MemPortCE2 1 1 }  { theta_q1 MemPortDOUT2 0 32 } } }
}
