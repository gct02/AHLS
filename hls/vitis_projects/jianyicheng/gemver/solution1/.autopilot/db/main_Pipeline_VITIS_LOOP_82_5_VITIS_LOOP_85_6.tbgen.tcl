set moduleName main_Pipeline_VITIS_LOOP_82_5_VITIS_LOOP_85_6
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "A_s", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "x_s", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ x_s_address0 sc_out sc_lv 8 signal 3 } 
	{ x_s_ce0 sc_out sc_logic 1 signal 3 } 
	{ x_s_we0 sc_out sc_logic 1 signal 3 } 
	{ x_s_d0 sc_out sc_lv 32 signal 3 } 
	{ x_s_q0 sc_in sc_lv 32 signal 3 } 
...
set Spec2ImplPortList { 
	...
	x_s { ap_memory {  { x_s_address0 mem_address 1 8 }  { x_s_ce0 mem_ce 1 1 }  { x_s_we0 mem_we 1 1 }  { x_s_d0 mem_din 1 32 }  { x_s_q0 mem_dout 0 32 } } }
}
