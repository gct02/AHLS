...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A \
    op interface \
    ports { A_address0 { O 16 vector } A_ce0 { O 1 bit } A_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x \
    op interface \
    ports { x_address0 { O 8 vector } x_ce0 { O 1 bit } x_we0 { O 1 bit } x_d0 { O 32 vector } x_q0 { I 32 vector } } \
} "
} else {
...
set InstName gemver_flow_control_loop_pipe_sequential_init_U
set CompName gemver_flow_control_loop_pipe_sequential_init
