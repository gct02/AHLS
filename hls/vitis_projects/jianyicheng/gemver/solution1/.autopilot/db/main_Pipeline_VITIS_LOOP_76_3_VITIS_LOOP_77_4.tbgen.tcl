set moduleName main_Pipeline_VITIS_LOOP_76_3_VITIS_LOOP_77_4
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_76_3_VITIS_LOOP_77_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ u1 float 32 regular {array 256 { 1 3 } 1 1 }  }
	{ u2 float 32 regular {array 256 { 1 3 } 1 1 }  }
	{ v1 float 32 regular {array 256 { 1 3 } 1 1 }  }
	{ v2 float 32 regular {array 256 { 1 3 } 1 1 }  }
	{ A_s float 32 regular {array 65536 { 2 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ A_s_address0 sc_out sc_lv 16 signal 4 } 
	{ A_s_ce0 sc_out sc_logic 1 signal 4 } 
	{ A_s_we0 sc_out sc_logic 1 signal 4 } 
	{ A_s_d0 sc_out sc_lv 32 signal 4 } 
	{ A_s_q0 sc_in sc_lv 32 signal 4 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "131105", "Max" : "131105"}
	, {"Name" : "Interval", "Min" : "131105", "Max" : "131105"}
]}
...
set Spec2ImplPortList { 
	...
	A_s { ap_memory {  { A_s_address0 mem_address 1 16 }  { A_s_ce0 mem_ce 1 1 }  { A_s_we0 mem_we 1 1 }  { A_s_d0 mem_din 1 32 }  { A_s_q0 mem_dout 0 32 } } }
}
