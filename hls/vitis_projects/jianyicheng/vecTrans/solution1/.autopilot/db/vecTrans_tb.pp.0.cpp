# 1 "benchmarks/jianyicheng/vecTrans/src/vecTrans_tb.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/vecTrans/src/vecTrans_tb.cpp" 2
# 1 "benchmarks/jianyicheng/vecTrans/src/vecTrans.h" 1
void vecTrans(int A[1024], int b[1024]);
int g(int d);
# 2 "benchmarks/jianyicheng/vecTrans/src/vecTrans_tb.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 3 "benchmarks/jianyicheng/vecTrans/src/vecTrans_tb.cpp" 2
...
# 4 "benchmarks/jianyicheng/vecTrans/src/vecTrans_tb.cpp" 2
...
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_vecTrans.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 15 "benchmarks/jianyicheng/vecTrans/src/vecTrans_tb.cpp"
