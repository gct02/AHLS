# 1 "HLS-benchmarks/Inter-Block/matrixadd/matrixadd.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "HLS-benchmarks/Inter-Block/matrixadd/matrixadd.cpp" 2
# 1 "HLS-benchmarks/Inter-Block/matrixadd/matrixadd.h" 1
typedef float in_float_t;
typedef float out_float_t;
typedef float inout_float_t;

__attribute__((sdx_kernel("matrixadd", 0))) out_float_t matrixadd(in_float_t array_0[8192], in_float_t array_1[8192],
...
# 2 "HLS-benchmarks/Inter-Block/matrixadd/matrixadd.cpp" 2
...
__attribute__((sdx_kernel("matrixadd", 0))) out_float_t matrixadd(in_float_t array_0[8192], in_float_t array_1[8192],
                      ...
                      in_float_t array_4[8192], in_float_t array_5[8192],
                      in_float_t array_6[8192], in_float_t array_7[8192]);
# 10 "HLS-benchmarks/Inter-Block/matrixadd/matrixadd.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 11 "HLS-benchmarks/Inter-Block/matrixadd/matrixadd.cpp" 2
...
#pragma HLSDIRECTIVE TOP name=matrixadd
# 17 "HLS-benchmarks/Inter-Block/matrixadd/matrixadd.cpp"
...
int main() {
  ...
  srand(9);
  VITIS_LOOP_77_1: for (int i = 0; i < 8192; i++) {
    array_0[i] = rand() % 120;
    array_1[i] = rand() % 120;
    array_2[i] = rand() % 120;
    array_3[i] = rand() % 120;
