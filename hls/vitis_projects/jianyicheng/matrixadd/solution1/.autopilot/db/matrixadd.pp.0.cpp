# 1 "benchmarks/jianyicheng/matrixadd/src/matrixadd.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/matrixadd/src/matrixadd.cpp" 2
# 1 "benchmarks/jianyicheng/matrixadd/src/matrixadd.h" 1
...
# 2 "benchmarks/jianyicheng/matrixadd/src/matrixadd.cpp" 2
...
out_float_t matrixadd(in_float_t array_0[8192], in_float_t array_1[8192],
                      ...
                      in_float_t array_4[8192], in_float_t array_5[8192],
                      in_float_t array_6[8192], in_float_t array_7[8192]);
# 10 "benchmarks/jianyicheng/matrixadd/src/matrixadd.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 11 "benchmarks/jianyicheng/matrixadd/src/matrixadd.cpp" 2
...
# 12 "benchmarks/jianyicheng/matrixadd/src/matrixadd.cpp" 2
...
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_matrixadd.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 83 "benchmarks/jianyicheng/matrixadd/src/matrixadd.cpp"

  float array_0[8192], array_1[8192], array_2[8192], array_3[8192],
      array_4[8192], array_5[8192], array_6[8192], array_7[8192];

  (9);
  VITIS_LOOP_88_1: for (int i = 0; i < 8192; i++) {
    array_0[i] = _rand() % 120;
    array_1[i] = _rand() % 120;
    array_2[i] = _rand() % 120;
    array_3[i] = _rand() % 120;
