# 1 "HLS-benchmarks/DSS/gSumIf/src/g.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "HLS-benchmarks/DSS/gSumIf/src/g.cpp" 2
# 10 "HLS-benchmarks/DSS/gSumIf/src/g.cpp"
...
double g(double i);
# 11 "HLS-benchmarks/DSS/gSumIf/src/g.cpp" 2
