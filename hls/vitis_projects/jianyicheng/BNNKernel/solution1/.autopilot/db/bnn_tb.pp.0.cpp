# 1 "benchmarks/jianyicheng/BNNKernel/src/bnn_tb.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/BNNKernel/src/bnn_tb.cpp" 2
# 10 "benchmarks/jianyicheng/BNNKernel/src/bnn_tb.cpp"
# 1 "benchmarks/jianyicheng/BNNKernel/src/bnn.h" 1
# 10 "benchmarks/jianyicheng/BNNKernel/src/bnn.h"
...
# 11 "benchmarks/jianyicheng/BNNKernel/src/bnn_tb.cpp" 2

__attribute__((sdx_kernel("main", 0))) int main(){
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_BNNKernel.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 12 "benchmarks/jianyicheng/BNNKernel/src/bnn_tb.cpp"


  int addr_in[10000], alpha, w[10000], addr_out[10000], data[10000], gold[10000],in[10000], mean[10000];

  VITIS_LOOP_16_1: for (int i=0; i<10000; i++){
  addr_in[i] = i;
 addr_out[i] = i;
 in[i] = 1;
 data[i] = 0;
 ...
 w[i] = 1;
  ...
  int count = 0;
  VITIS_LOOP_32_2: for(int i=0;i<10000; i++)
 count += (data[i] == gold[i]);
