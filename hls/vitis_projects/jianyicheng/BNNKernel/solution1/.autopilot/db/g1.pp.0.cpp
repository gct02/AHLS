# 1 "benchmarks/jianyicheng/BNNKernel/src/g1.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/BNNKernel/src/g1.cpp" 2
# 10 "benchmarks/jianyicheng/BNNKernel/src/g1.cpp"
void g1(int alpha, int in[10000], int i, int w[10000], int addr_in[10000], int data[10000]){

 int j, x, lut;

 VITIS_LOOP_14_1: for (j=0;j<100;j++){
  x = i*100+j;
  lut=in[x]^w[x];
