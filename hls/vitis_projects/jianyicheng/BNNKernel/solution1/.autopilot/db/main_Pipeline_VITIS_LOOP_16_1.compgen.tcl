...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename addr_in \
    op interface \
    ports { addr_in_address0 { O 14 vector } addr_in_ce0 { O 1 bit } addr_in_we0 { O 1 bit } addr_in_d0 { O 14 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename addr_out \
    op interface \
    ports { addr_out_address0 { O 14 vector } addr_out_ce0 { O 1 bit } addr_out_we0 { O 1 bit } addr_out_d0 { O 14 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in_r \
    op interface \
    ports { in_r_address0 { O 14 vector } in_r_ce0 { O 1 bit } in_r_we0 { O 1 bit } in_r_d0 { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data \
    op interface \
    ports { data_address0 { O 14 vector } data_ce0 { O 1 bit } data_we0 { O 1 bit } data_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename gold \
    op interface \
    ports { gold_address0 { O 14 vector } gold_ce0 { O 1 bit } gold_we0 { O 1 bit } gold_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'gold'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename mean \
    op interface \
    ports { mean_address0 { O 14 vector } mean_ce0 { O 1 bit } mean_we0 { O 1 bit } mean_d0 { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename w \
    op interface \
    ports { w_address0 { O 14 vector } w_ce0 { O 1 bit } w_we0 { O 1 bit } w_d0 { O 1 vector } } \
} "
} else {
