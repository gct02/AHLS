...
set C_modelArgList {
	...
	{ addr_in int 14 regular {array 10000 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "phi_mul", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "addr_in", "interface" : "memory", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ addr_in_q0 sc_in sc_lv 14 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "addr_in_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "addr_in", "role": "q0" }} , 
...
set ArgLastReadFirstWriteLatency {
	main_Pipeline_VITIS_LOOP_14_1 {
		...
		w {Type I LastRead 3 FirstWrite -1}
		addr_in {Type I LastRead 1 FirstWrite -1}
		data {Type IO LastRead 3 FirstWrite 6}}}
...
set Spec2ImplPortList { 
	...
	addr_in { ap_memory {  { addr_in_address0 mem_address 1 14 }  { addr_in_ce0 mem_ce 1 1 }  { addr_in_q0 mem_dout 0 14 } } }
