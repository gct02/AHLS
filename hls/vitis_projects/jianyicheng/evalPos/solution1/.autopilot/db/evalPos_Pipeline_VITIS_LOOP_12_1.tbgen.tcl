set moduleName evalPos_Pipeline_VITIS_LOOP_12_1
set isTopModule 0
...
set C_modelName {evalPos_Pipeline_VITIS_LOOP_12_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ board int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ empty int 31 regular  }
	{ conv16_i float 32 regular  }
	{ centralityValue_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "board", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "conv16_i", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "centralityValue_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ conv16_i sc_in sc_lv 32 signal 2 } 
	{ centralityValue_out sc_out sc_lv 32 signal 3 } 
	{ centralityValue_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv16_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "conv16_i", "role": "default" }} , 
 	{ "name": "centralityValue_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "centralityValue_out", "role": "default" }} , 
 	{ "name": "centralityValue_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "centralityValue_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U4", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_6ns_4ns_6_10_1_U5", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_6ns_8ns_13_1_1_U6", "Parent" : "0"},
...
set Spec2ImplPortList { 
	board { ap_memory {  { board_address0 mem_address 1 6 }  { board_ce0 mem_ce 1 1 }  { board_q0 in_data 0 32 } } }
	empty { ap_none {  { empty in_data 0 31 } } }
	conv16_i { ap_none {  { conv16_i in_data 0 32 } } }
	centralityValue_out { ap_vld {  { centralityValue_out out_data 1 32 }  { centralityValue_out_ap_vld out_vld 1 1 } } }
}
