# 1 "HLS-benchmarks/PNAnalyser/evalPos/src/evalPos.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "HLS-benchmarks/PNAnalyser/evalPos/src/evalPos.cpp" 2
# 1 "HLS-benchmarks/PNAnalyser/evalPos/src/evalPos.h" 1
float g( int profile, int i, int moveCount, int benefitMagnitude, int pm);
__attribute__((sdx_kernel("evalPos", 0))) void evalPos(int board[64], int color[1], int profile[1], int rawMoveCount[64], int pm_2[2], float res[1]);
# 2 "HLS-benchmarks/PNAnalyser/evalPos/src/evalPos.cpp" 2


__attribute__((sdx_kernel("evalPos", 0))) void evalPos(int board[64], int color[1], int profile[1], int rawMoveCount[64], int pm_2[2], float res[1])
{
#line 19 "/home/gabriel/Documents/UFRGS/RAISE/ahls_resource_estimation/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=evalPos
# 5 "HLS-benchmarks/PNAnalyser/evalPos/src/evalPos.cpp"
  ...
  VITIS_LOOP_12_1: for (int i = 0; i < 64; i++)
  {
     b = board[i];
