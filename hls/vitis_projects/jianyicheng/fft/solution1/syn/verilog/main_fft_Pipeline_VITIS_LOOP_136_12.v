...
module main_fft_Pipeline_VITIS_LOOP_136_12 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_ready;
input  [7:0] numBF_5;
input  [3:0] zext_ln136;
input  [0:0] select_ln133_1;
...
wire   [8:0] shl_ln137_fu_226_p2;
reg   [8:0] shl_ln137_reg_304;
wire   [7:0] add_ln141_fu_232_p2;
reg   [7:0] add_ln141_reg_309;
wire    ap_block_pp0_stage1_11001;
reg   [9:0] X_R_5_addr_reg_324;
reg   [9:0] X_I_5_addr_reg_329;
reg   [9:0] X_R_5_addr_1_reg_334;
reg   [9:0] X_I_5_addr_1_reg_339;
reg   [31:0] c_reg_344;
reg   [31:0] s_reg_350;
reg   [31:0] X_R_5_load_1_reg_356;
reg   [31:0] X_I_5_load_1_reg_361;
reg   [31:0] mul_reg_366;
wire    ap_CS_fsm_pp0_stage10;
wire    ap_block_pp0_stage10_11001;
reg   [31:0] mul11_reg_371;
reg   [31:0] mul12_reg_376;
reg   [31:0] mul13_reg_381;
reg   [31:0] sub_reg_386;
wire    ap_CS_fsm_pp0_stage30;
wire    ap_block_pp0_stage30_11001;
reg   [31:0] sub3_reg_391;
reg    ap_enable_reg_pp0_iter0_reg;
wire    ap_block_pp0_stage0_subdone;
wire   [63:0] zext_ln137_fu_243_p1;
wire    ap_block_pp0_stage1;
wire   [63:0] zext_ln141_fu_256_p1;
wire   [63:0] zext_ln144_fu_270_p1;
reg   [7:0] j_5_fu_50;
wire   [7:0] add_ln136_fu_238_p2;
wire    ap_loop_init;
...
wire   [6:0] trunc_ln137_fu_218_p1;
wire   [8:0] zext_ln137_1_fu_222_p1;
wire   [8:0] zext_ln136_cast_fu_200_p1;
wire   [9:0] add_ln_fu_248_p4;
wire   [9:0] add_ln3_fu_262_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_5_fu_50 <= 8'd0;
    end else if (((icmp_ln136_reg_300 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        X_I_5_addr_1_reg_339[7 : 0] <= zext_ln144_fu_270_p1[7 : 0];
X_I_5_addr_1_reg_339[9] <= zext_ln144_fu_270_p1[9];
        X_I_5_addr_reg_329[7 : 0] <= zext_ln141_fu_256_p1[7 : 0];
X_I_5_addr_reg_329[9] <= zext_ln141_fu_256_p1[9];
        X_R_5_addr_1_reg_334[7 : 0] <= zext_ln144_fu_270_p1[7 : 0];
X_R_5_addr_1_reg_334[9] <= zext_ln144_fu_270_p1[9];
        X_R_5_addr_reg_324[7 : 0] <= zext_ln141_fu_256_p1[7 : 0];
X_R_5_addr_reg_324[9] <= zext_ln141_fu_256_p1[9];
    end
end
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage32) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage32)) | ((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        ...
        X_I_5_address0 = zext_ln144_fu_270_p1;
    end else begin
        X_I_5_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage31) & (1'b1 == ap_CS_fsm_pp0_stage31))) begin
            ...
            X_I_5_address1 = zext_ln141_fu_256_p1;
        end else begin
            X_I_5_address1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((icmp_ln136_reg_300 == 1'd0) & (1'b0 == ap_block_pp0_stage31_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage31))) begin
        X_I_5_we1 = 1'b1;
    end else begin
        X_I_5_we1 = 1'b0;
    end
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage32) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage32)) | ((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        ...
        X_R_5_address0 = zext_ln144_fu_270_p1;
    end else begin
        X_R_5_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage31) & (1'b1 == ap_CS_fsm_pp0_stage31))) begin
            ...
            X_R_5_address1 = zext_ln141_fu_256_p1;
        end else begin
            X_R_5_address1 = 'bx;
        end
    end else begin
...
always @ (*) begin
    if (((icmp_ln136_reg_300 == 1'd1) & (1'b0 == ap_block_pp0_stage1_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if ((((icmp_ln136_reg_300 == 1'd0) & (1'b0 == ap_block_pp0_stage21_00001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage21)) | ((icmp_ln136_reg_300 == 1'd0) & (1'b0 == ap_block_pp0_stage11_00001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11)))) begin
        grp_fu_148_opcode = 2'd1;
    end else if (((icmp_ln136_reg_300 == 1'd0) & (1'b0 == ap_block_pp0_stage34_00001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage34))) begin
...
always @ (*) begin
    if (((icmp_ln136_reg_300 == 1'd0) & (1'b0 == ap_block_pp0_stage21_00001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage21))) begin
        grp_fu_152_opcode = 2'd1;
    end else if ((((icmp_ln136_reg_300 == 1'd0) & (1'b0 == ap_block_pp0_stage11_00001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage11)) | ((icmp_ln136_reg_300 == 1'd0) & (1'b0 == ap_block_pp0_stage34_00001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage34)))) begin
...
assign X_I_5_d0 = reg_194;

assign X_I_5_d1 = sub3_reg_391;

assign X_R_5_d0 = reg_188;

assign X_R_5_d1 = sub_reg_386;

assign add_ln136_fu_238_p2 = (j_reg_294 + 8'd1);

assign add_ln141_fu_232_p2 = (ap_sig_allocacmp_j + numBF_5);

assign add_ln3_fu_262_p4 = {{{select_ln133_1}, {1'd0}}, {j_reg_294}};

assign add_ln_fu_248_p4 = {{{select_ln133_1}, {1'd0}}, {add_ln141_reg_309}};
...
assign cos_coefficients_table_address0 = zext_ln137_fu_243_p1;
...
assign icmp_ln136_fu_212_p2 = ((ap_sig_allocacmp_j == numBF_5) ? 1'b1 : 1'b0);

assign shl_ln137_fu_226_p2 = zext_ln137_1_fu_222_p1 << zext_ln136_cast_fu_200_p1;

assign sin_coefficients_table_address0 = zext_ln137_fu_243_p1;

assign trunc_ln137_fu_218_p1 = ap_sig_allocacmp_j[6:0];

assign zext_ln136_cast_fu_200_p1 = zext_ln136;

assign zext_ln137_1_fu_222_p1 = trunc_ln137_fu_218_p1;

assign zext_ln137_fu_243_p1 = shl_ln137_reg_304;

assign zext_ln141_fu_256_p1 = add_ln_fu_248_p4;

assign zext_ln144_fu_270_p1 = add_ln3_fu_262_p4;

always @ (posedge ap_clk) begin
    X_R_5_addr_reg_324[8] <= 1'b0;
    X_I_5_addr_reg_329[8] <= 1'b0;
    X_R_5_addr_1_reg_334[8] <= 1'b0;
    X_I_5_addr_1_reg_339[8] <= 1'b0;
end

endmodule //main_fft_Pipeline_VITIS_LOOP_136_12
