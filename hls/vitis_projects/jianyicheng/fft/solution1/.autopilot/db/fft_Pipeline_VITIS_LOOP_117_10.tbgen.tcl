set moduleName fft_Pipeline_VITIS_LOOP_117_10
set isTopModule 0
...
set C_modelName {fft_Pipeline_VITIS_LOOP_117_10}
set C_modelType { void 0 }
set C_modelArgList {
	{ numBF_4 int 8 regular  }
	{ zext_ln117 int 4 regular  }
	{ select_ln114_1 int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "numBF_4", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln117", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "select_ln114_1", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ numBF_4 sc_in sc_lv 8 signal 0 } 
	{ zext_ln117 sc_in sc_lv 4 signal 1 } 
	{ select_ln114_1 sc_in sc_lv 1 signal 2 } 
	{ X_R_4_address0 sc_out sc_lv 10 signal 3 } 
	{ X_R_4_ce0 sc_out sc_logic 1 signal 3 } 
	{ X_R_4_we0 sc_out sc_logic 1 signal 3 } 
	{ X_R_4_d0 sc_out sc_lv 32 signal 3 } 
	{ X_R_4_q0 sc_in sc_lv 32 signal 3 } 
	{ X_R_4_address1 sc_out sc_lv 10 signal 3 } 
	{ X_R_4_ce1 sc_out sc_logic 1 signal 3 } 
	{ X_R_4_we1 sc_out sc_logic 1 signal 3 } 
	{ X_R_4_d1 sc_out sc_lv 32 signal 3 } 
	{ X_R_4_q1 sc_in sc_lv 32 signal 3 } 
	{ X_I_4_address0 sc_out sc_lv 10 signal 4 } 
	{ X_I_4_ce0 sc_out sc_logic 1 signal 4 } 
	{ X_I_4_we0 sc_out sc_logic 1 signal 4 } 
	{ X_I_4_d0 sc_out sc_lv 32 signal 4 } 
	{ X_I_4_q0 sc_in sc_lv 32 signal 4 } 
	{ X_I_4_address1 sc_out sc_lv 10 signal 4 } 
	{ X_I_4_ce1 sc_out sc_logic 1 signal 4 } 
	{ X_I_4_we1 sc_out sc_logic 1 signal 4 } 
	{ X_I_4_d1 sc_out sc_lv 32 signal 4 } 
	{ X_I_4_q1 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "numBF_4", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "numBF_4", "role": "default" }} , 
 	{ "name": "zext_ln117", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "zext_ln117", "role": "default" }} , 
 	{ "name": "select_ln114_1", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "select_ln114_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	numBF_4 { ap_none {  { numBF_4 in_data 0 8 } } }
	zext_ln117 { ap_none {  { zext_ln117 in_data 0 4 } } }
	select_ln114_1 { ap_none {  { select_ln114_1 in_data 0 1 } } }
