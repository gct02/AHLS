# 1 "benchmarks/jianyicheng/fft/src/fft.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/fft/src/fft.cpp" 2
# 1 "benchmarks/jianyicheng/fft/src/fft.h" 1
...
# 2 "benchmarks/jianyicheng/fft/src/fft.cpp" 2
...
void fft(inout_float_t X_R_0[1024], inout_float_t X_R_1[1024],
         ...
         in_float_t cos_coefficients_table[512],
         in_float_t sin_coefficients_table[512]);
# 10 "benchmarks/jianyicheng/fft/src/fft.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 11 "benchmarks/jianyicheng/fft/src/fft.cpp" 2
...
# 13 "benchmarks/jianyicheng/fft/src/fft.cpp" 2
...
loop_0:
  for (int i = 0; i < 2; i++)
    VITIS_LOOP_39_1: for (int stage = 1; stage <= 8; stage++) {
      int numBF = (1 << (stage - 1));
      VITIS_LOOP_41_2: for (int j = 0; j < numBF; j++) {
...
loop_1:
  for (int i = 0; i < 2; i++)
    VITIS_LOOP_58_3: for (int stage = 1; stage <= 8; stage++) {
      int numBF = (1 << (stage - 1));
      VITIS_LOOP_60_4: for (int j = 0; j < numBF; j++) {
        float c = cos_coefficients_table[j << (8 - stage)];
        float s = sin_coefficients_table[j << (8 - stage)];
        int i_lower = j + numBF;
        float temp_R =
...
loop_2:
  for (int i = 0; i < 2; i++)
    VITIS_LOOP_77_5: for (int stage = 1; stage <= 8; stage++) {
      int numBF = (1 << (stage - 1));
      VITIS_LOOP_79_6: for (int j = 0; j < numBF; j++) {
        float c = cos_coefficients_table[j << (8 - stage)];
        float s = sin_coefficients_table[j << (8 - stage)];
        int i_lower = j + numBF;
        float temp_R =
...
loop_3:
  for (int i = 0; i < 2; i++)
    VITIS_LOOP_96_7: for (int stage = 1; stage <= 8; stage++) {
      int numBF = (1 << (stage - 1));
      VITIS_LOOP_98_8: for (int j = 0; j < numBF; j++) {
        float c = cos_coefficients_table[j << (8 - stage)];
        float s = sin_coefficients_table[j << (8 - stage)];
        int i_lower = j + numBF;
        float temp_R =
...
loop_4:
  for (int i = 0; i < 2; i++)
    VITIS_LOOP_115_9: for (int stage = 1; stage <= 8; stage++) {
      int numBF = (1 << (stage - 1));
      VITIS_LOOP_117_10: for (int j = 0; j < numBF; j++) {
        float c = cos_coefficients_table[j << (8 - stage)];
        float s = sin_coefficients_table[j << (8 - stage)];
        int i_lower = j + numBF;
        float temp_R =
...
loop_5:
  for (int i = 0; i < 2; i++)
    VITIS_LOOP_134_11: for (int stage = 1; stage <= 8; stage++) {
      int numBF = (1 << (stage - 1));
      VITIS_LOOP_136_12: for (int j = 0; j < numBF; j++) {
        float c = cos_coefficients_table[j << (8 - stage)];
        float s = sin_coefficients_table[j << (8 - stage)];
        int i_lower = j + numBF;
        float temp_R =
...
loop_6:
  for (int i = 0; i < 2; i++)
    VITIS_LOOP_153_13: for (int stage = 1; stage <= 8; stage++) {
      int numBF = (1 << (stage - 1));
      VITIS_LOOP_155_14: for (int j = 0; j < numBF; j++) {
        float c = cos_coefficients_table[j << (8 - stage)];
        float s = sin_coefficients_table[j << (8 - stage)];
        int i_lower = j + numBF;
        float temp_R =
...
loop_7:
  for (int i = 0; i < 2; i++)
    VITIS_LOOP_172_15: for (int stage = 1; stage <= 8; stage++) {
      int numBF = (1 << (stage - 1));
      VITIS_LOOP_174_16: for (int j = 0; j < numBF; j++) {
        float c = cos_coefficients_table[j << (8 - stage)];
        float s = sin_coefficients_table[j << (8 - stage)];
        int i_lower = j + numBF;
        float temp_R =
...
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_fft.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 190 "benchmarks/jianyicheng/fft/src/fft.cpp"
  ...
  (9);
  VITIS_LOOP_373_1: for (int i = 0; i < 1024; i++) {
    X_R_0[i] = _rand();
    X_R_1[i] = _rand();
    X_R_2[i] = _rand();
    X_R_3[i] = _rand();
