# 1 "HLS-benchmarks/Inter-Block/matrixtrans/matrixtrans.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "HLS-benchmarks/Inter-Block/matrixtrans/matrixtrans.cpp" 2
# 1 "HLS-benchmarks/Inter-Block/matrixtrans/matrixtrans.h" 1
typedef int in_int_t;
typedef int out_int_t;
typedef int inout_int_t;

__attribute__((sdx_kernel("matrixtrans", 0))) void matrixtrans(in_int_t array_0[8192], in_int_t array_1[8192],
...
# 2 "HLS-benchmarks/Inter-Block/matrixtrans/matrixtrans.cpp" 2
...
__attribute__((sdx_kernel("matrixtrans", 0))) void matrixtrans(in_int_t array_0[8192], in_int_t array_1[8192],
                 ...
                 out_int_t results_4[8192], out_int_t results_5[8192],
                 out_int_t results_6[8192], out_int_t results_7[8192]);
# 10 "HLS-benchmarks/Inter-Block/matrixtrans/matrixtrans.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 11 "HLS-benchmarks/Inter-Block/matrixtrans/matrixtrans.cpp" 2
...
#pragma HLSDIRECTIVE TOP name=matrixtrans
# 20 "HLS-benchmarks/Inter-Block/matrixtrans/matrixtrans.cpp"
...
int main() {
  ...
  VITIS_LOOP_61_1: for (int i = 0; i < 8192; i++) {
    array_0[i] = rand();
    array_1[i] = rand();
    array_2[i] = rand();
    array_3[i] = rand();
