# 1 "benchmarks/jianyicheng/matrixtrans/src/matrixtrans.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/matrixtrans/src/matrixtrans.cpp" 2
# 1 "benchmarks/jianyicheng/matrixtrans/src/matrixtrans.h" 1
...
# 2 "benchmarks/jianyicheng/matrixtrans/src/matrixtrans.cpp" 2
...
void matrixtrans(in_int_t array_0[8192], in_int_t array_1[8192],
                 ...
                 out_int_t results_4[8192], out_int_t results_5[8192],
                 out_int_t results_6[8192], out_int_t results_7[8192]);
# 10 "benchmarks/jianyicheng/matrixtrans/src/matrixtrans.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 11 "benchmarks/jianyicheng/matrixtrans/src/matrixtrans.cpp" 2
...
# 12 "benchmarks/jianyicheng/matrixtrans/src/matrixtrans.cpp" 2
...
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_matrixtrans.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 66 "benchmarks/jianyicheng/matrixtrans/src/matrixtrans.cpp"
  ...
  VITIS_LOOP_72_1: for (int i = 0; i < 8192; i++) {
    array_0[i] = _rand();
    array_1[i] = _rand();
    array_2[i] = _rand();
    array_3[i] = _rand();
