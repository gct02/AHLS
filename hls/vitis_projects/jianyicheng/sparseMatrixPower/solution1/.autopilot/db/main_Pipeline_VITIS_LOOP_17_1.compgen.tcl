...
set id 1
set name main_am_addmul_7ns_7ns_9ns_17_4_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename az \
    op interface \
    ports { az_address0 { O 7 vector } az_ce0 { O 1 bit } az_we0 { O 1 bit } az_d0 { O 3 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'az'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data \
    op interface \
    ports { data_address0 { O 7 vector } data_ce0 { O 1 bit } data_we0 { O 1 bit } data_d0 { O 32 vector } } \
} "
} else {
