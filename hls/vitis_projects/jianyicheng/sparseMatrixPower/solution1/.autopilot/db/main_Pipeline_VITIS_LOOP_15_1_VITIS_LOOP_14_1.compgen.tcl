...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler main_sparsemux_7_2_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}


set name main_mul_4ns_32s_32_5_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set id 12
set name main_mac_muladd_7ns_7ns_7ns_14_4_1
...
set ce_signed 0
set out_width 14
set arg_lists {i0 {7 0 +} i1 {7 0 +} m {14 1 +} i2 {7 0 +} p {14 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data \
    op interface \
    ports { data_address0 { O 7 vector } data_ce0 { O 1 bit } data_we0 { O 1 bit } data_d0 { O 32 vector } data_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_1 \
    op interface \
    ports { data_1_address0 { O 7 vector } data_1_ce0 { O 1 bit } data_1_we0 { O 1 bit } data_1_d0 { O 32 vector } data_1_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_2 \
    op interface \
    ports { data_2_address0 { O 7 vector } data_2_ce0 { O 1 bit } data_2_we0 { O 1 bit } data_2_d0 { O 32 vector } data_2_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename w \
    op interface \
    ports { w_address0 { O 14 vector } w_ce0 { O 1 bit } w_q0 { I 4 vector } } \
} "
} else {
