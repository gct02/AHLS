# 1 "benchmarks/jianyicheng/sparseMatrixPower/src/smm_tb.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/sparseMatrixPower/src/smm_tb.cpp" 2
# 10 "benchmarks/jianyicheng/sparseMatrixPower/src/smm_tb.cpp"
...
# 11 "benchmarks/jianyicheng/sparseMatrixPower/src/smm_tb.cpp" 2
...
# 12 "benchmarks/jianyicheng/sparseMatrixPower/src/smm_tb.cpp" 2

__attribute__((sdx_kernel("main", 0))) int main(){
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_sparseMatrixPower.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 13 "benchmarks/jianyicheng/sparseMatrixPower/src/smm_tb.cpp"

  int data[200], az[100], w[10000], data1[200];
  int temp;

  VITIS_LOOP_17_1: for(int i=0; i<100; i++){
    data[i] = 1;
    data[i+100] = 0;
    az[i] = i%5;
  }

  VITIS_LOOP_23_2: for(int i=0; i<10000; i++){
    w[i] = i%10;
  }

  smm(data, az, w);

  VITIS_LOOP_29_3: for (int j=0; j<100; j++){
    temp = az[j];
    if (temp != 1){
      VITIS_LOOP_32_4: for (int i=0; i<100; i++){
  ...
  int res = 0;
  VITIS_LOOP_39_5: for(int i = 0; i< 200; i++)
    res += (data[i] == data1[i]);
