set moduleName main_Pipeline_loop_0_loop_1
set isTopModule 0
...
set C_modelName {main_Pipeline_loop_0_loop_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ B float 32 regular {array 256 { 1 3 } 1 1 }  }
	{ w float 32 regular {array 65536 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ B_address0 sc_out sc_lv 8 signal 0 } 
	...
	{ grp_fu_178_p_opcode sc_out sc_lv 5 signal -1 } 
	{ grp_fu_178_p_dout0 sc_in sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_178_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "grp_fu_178_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_178_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_178_p_dout0", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "main_Pipeline_loop_0_loop_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "720928", "EstimateLatencyMax" : "720928",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	main_Pipeline_loop_0_loop_1 {
		B {Type I LastRead 1 FirstWrite -1}
		w {Type I LastRead 2 FirstWrite -1}
		sum_s {Type O LastRead -1 FirstWrite 41}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "720928", "Max" : "720928"}
	, {"Name" : "Interval", "Min" : "720928", "Max" : "720928"}
]}
