set moduleName main_Pipeline_VITIS_LOOP_50_1_VITIS_LOOP_53_2
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_50_1_VITIS_LOOP_53_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ w float 32 regular {array 65536 { 0 3 } 0 1 }  }
	{ sum float 32 regular {array 256 { 0 3 } 0 1 }  }
	{ sum_s float 32 regular {array 256 { 0 3 } 0 1 }  }
	{ A float 32 regular {array 256 { 0 3 } 0 1 }  }
	{ B float 32 regular {array 256 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "w", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sum", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sum_s", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ w_address0 sc_out sc_lv 16 signal 0 } 
	...
	{ sum_d0 sc_out sc_lv 32 signal 1 } 
	{ sum_s_address0 sc_out sc_lv 8 signal 2 } 
	{ sum_s_ce0 sc_out sc_logic 1 signal 2 } 
	{ sum_s_we0 sc_out sc_logic 1 signal 2 } 
	{ sum_s_d0 sc_out sc_lv 32 signal 2 } 
	...
	{ B_address0 sc_out sc_lv 8 signal 4 } 
	{ B_ce0 sc_out sc_logic 1 signal 4 } 
	{ B_we0 sc_out sc_logic 1 signal 4 } 
	{ B_d0 sc_out sc_lv 32 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_s_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sum_s", "role": "address0" }} , 
 	{ "name": "sum_s_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sum_s", "role": "ce0" }} , 
 	{ "name": "sum_s_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "sum_s", "role": "we0" }} , 
 	{ "name": "sum_s_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_s", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "main_Pipeline_VITIS_LOOP_50_1_VITIS_LOOP_53_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "sum_s", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "A", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "B", "Type" : "Memory", "Direction" : "O"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_50_1_VITIS_LOOP_53_2", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "2", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage1", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage1_subdone", "QuitState" : "ap_ST_fsm_pp0_stage1", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage1_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	main_Pipeline_VITIS_LOOP_50_1_VITIS_LOOP_53_2 {
		w {Type O LastRead -1 FirstWrite 3}
		sum {Type O LastRead -1 FirstWrite 3}
		sum_s {Type O LastRead -1 FirstWrite 3}
...
set Spec2ImplPortList { 
	w { ap_memory {  { w_address0 mem_address 1 16 }  { w_ce0 mem_ce 1 1 }  { w_we0 mem_we 1 1 }  { w_d0 mem_din 1 32 } } }
	sum { ap_memory {  { sum_address0 mem_address 1 8 }  { sum_ce0 mem_ce 1 1 }  { sum_we0 mem_we 1 1 }  { sum_d0 mem_din 1 32 } } }
	sum_s { ap_memory {  { sum_s_address0 mem_address 1 8 }  { sum_s_ce0 mem_ce 1 1 }  { sum_s_we0 mem_we 1 1 }  { sum_s_d0 mem_din 1 32 } } }
	A { ap_memory {  { A_address0 mem_address 1 8 }  { A_ce0 mem_ce 1 1 }  { A_we0 mem_we 1 1 }  { A_d0 mem_din 1 32 } } }
	B { ap_memory {  { B_address0 mem_address 1 8 }  { B_ce0 mem_ce 1 1 }  { B_we0 mem_we 1 1 }  { B_d0 mem_din 1 32 } } }
}
