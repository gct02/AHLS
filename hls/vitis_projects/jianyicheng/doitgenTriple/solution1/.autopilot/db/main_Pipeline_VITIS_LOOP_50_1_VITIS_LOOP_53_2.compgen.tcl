...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename w \
    op interface \
    ports { w_address0 { O 16 vector } w_ce0 { O 1 bit } w_we0 { O 1 bit } w_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sum \
    op interface \
    ports { sum_address0 { O 8 vector } sum_ce0 { O 1 bit } sum_we0 { O 1 bit } sum_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sum_s \
    op interface \
    ports { sum_s_address0 { O 8 vector } sum_s_ce0 { O 1 bit } sum_s_we0 { O 1 bit } sum_s_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'sum_s'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A \
    op interface \
    ports { A_address0 { O 8 vector } A_ce0 { O 1 bit } A_we0 { O 1 bit } A_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename B \
    op interface \
    ports { B_address0 { O 8 vector } B_ce0 { O 1 bit } B_we0 { O 1 bit } B_d0 { O 32 vector } } \
} "
} else {
