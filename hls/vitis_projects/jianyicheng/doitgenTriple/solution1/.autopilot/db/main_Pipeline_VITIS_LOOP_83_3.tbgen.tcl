set moduleName main_Pipeline_VITIS_LOOP_83_3
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_83_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ A float 32 regular {array 256 { 1 3 } 1 1 }  }
	{ B float 32 regular {array 256 { 1 3 } 1 1 }  }
	{ f_1_out int 9 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "f_1_out", "interface" : "wire", "bitwidth" : 9, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ f_1_out sc_out sc_lv 9 signal 2 } 
	{ f_1_out_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "f_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "f_1_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "main_Pipeline_VITIS_LOOP_83_3",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	main_Pipeline_VITIS_LOOP_83_3 {
		A {Type I LastRead 0 FirstWrite -1}
		B {Type I LastRead 0 FirstWrite -1}
		f_1_out {Type O LastRead -1 FirstWrite 5}}}
...
set Spec2ImplPortList { 
	...
	f_1_out { ap_vld {  { f_1_out out_data 1 9 }  { f_1_out_ap_vld out_vld 1 1 } } }
}
