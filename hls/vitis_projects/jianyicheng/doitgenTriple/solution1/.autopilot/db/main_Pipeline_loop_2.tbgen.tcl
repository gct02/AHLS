set moduleName main_Pipeline_loop_2
set isTopModule 0
...
set C_modelName {main_Pipeline_loop_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ B_load float 32 regular  }
	{ sum_s float 32 regular {array 256 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "B_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sum_s", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ B_load sc_in sc_lv 32 signal 0 } 
	{ sum_s_address0 sc_out sc_lv 8 signal 1 } 
	{ sum_s_ce0 sc_out sc_logic 1 signal 1 } 
	{ sum_s_q0 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_s_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_s", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "sum_s", "Type" : "Memory", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_10_full_dsp_1_U12", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_8_max_dsp_1_U13", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	main_Pipeline_loop_2 {
		B_load {Type I LastRead 0 FirstWrite -1}
		sum_s {Type I LastRead 0 FirstWrite -1}
		B {Type O LastRead -1 FirstWrite 28}}}
...
set Spec2ImplPortList { 
	...
	sum_s { ap_memory {  { sum_s_address0 mem_address 1 8 }  { sum_s_ce0 mem_ce 1 1 }  { sum_s_q0 mem_dout 0 32 } } }
