...
using hls::sim::Byte;
extern "C" void doitgenTriple(Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_doitgenTriple_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_w, volatile void * __xlx_apatb_param_sum) {
...
__xlx_sum__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_sum)[i]);
  ...
  int __xlx_size_param_sum = 256;
  int __xlx_offset_param_sum = 0;
  int __xlx_offset_byte_param_sum = 0*4;
  // DUT call
  doitgenTriple(__xlx_A__tmp_vec.data(), __xlx_w__tmp_vec.data(), __xlx_sum__tmp_vec.data());
