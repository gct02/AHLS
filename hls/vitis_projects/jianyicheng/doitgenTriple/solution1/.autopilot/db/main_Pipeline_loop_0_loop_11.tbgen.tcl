set moduleName main_Pipeline_loop_0_loop_11
set isTopModule 0
...
set C_modelName {main_Pipeline_loop_0_loop_11}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "main_Pipeline_loop_0_loop_11",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	main_Pipeline_loop_0_loop_11 {
		A {Type I LastRead 1 FirstWrite -1}
		w {Type I LastRead 2 FirstWrite -1}
		sum {Type O LastRead -1 FirstWrite 41}}}
