...
using hls::sim::Byte;
extern "C" void gesummv(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_gesummv_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_tmp, volatile void * __xlx_apatb_param_y, volatile void * __xlx_apatb_param_x) {
...
__xlx_x__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_x)[i]);
  ...
  // DUT call
  gesummv(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_tmp__tmp_vec.data(), __xlx_y__tmp_vec.data(), __xlx_x__tmp_vec.data());
