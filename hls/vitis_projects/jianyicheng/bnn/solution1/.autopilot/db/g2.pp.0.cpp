# 1 "HLS-benchmarks/DSS/BNNKernel/src/g2.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "HLS-benchmarks/DSS/BNNKernel/src/g2.cpp" 2
# 10 "HLS-benchmarks/DSS/BNNKernel/src/g2.cpp"
void g2(int mean[10000], int i, int addr_out[10000], int data[10000]){
#pragma SS II=1

 int temp, m, k, y, z;

  VITIS_LOOP_15_1: for(k=0; k<100; k++){
    y=i*100+k;
    m=mean[y];
