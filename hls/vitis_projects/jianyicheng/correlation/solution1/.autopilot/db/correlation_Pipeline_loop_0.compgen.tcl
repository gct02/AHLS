...
set name correlation_fadd_32ns_32ns_32_5_full_dsp_1
...
set name correlation_fcmp_32ns_32ns_1_2_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename m \
    op interface \
    ports { m_address0 { O 5 vector } m_ce0 { O 1 bit } m_we0 { O 1 bit } m_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename s \
    op interface \
    ports { s_address0 { O 5 vector } s_ce0 { O 1 bit } s_we0 { O 1 bit } s_d0 { O 32 vector } } \
} "
} else {
...
set InstName correlation_flow_control_loop_pipe_sequential_init_U
set CompName correlation_flow_control_loop_pipe_sequential_init
