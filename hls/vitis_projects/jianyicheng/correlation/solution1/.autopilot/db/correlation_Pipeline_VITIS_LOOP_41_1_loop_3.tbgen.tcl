set moduleName correlation_Pipeline_VITIS_LOOP_41_1_loop_3
set isTopModule 0
...
set C_modelName {correlation_Pipeline_VITIS_LOOP_41_1_loop_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ data int 32 regular {array 1024 { 0 1 } 1 1 }  }
	{ m int 32 regular {array 32 { 1 3 } 1 1 }  }
	{ s int 32 regular {array 32 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	data { ap_memory {  { data_address0 mem_address 1 10 }  { data_ce0 mem_ce 1 1 }  { data_we0 mem_we 1 1 }  { data_d0 mem_din 1 32 }  { data_address1 MemPortADDR2 1 10 }  { data_ce1 MemPortCE2 1 1 }  { data_q1 MemPortDOUT2 0 32 } } }
	m { ap_memory {  { m_address0 mem_address 1 5 }  { m_ce0 mem_ce 1 1 }  { m_q0 mem_dout 0 32 } } }
	s { ap_memory {  { s_address0 mem_address 1 5 }  { s_ce0 mem_ce 1 1 }  { s_q0 mem_dout 0 32 } } }
}
