set moduleName main_Pipeline_loop_1
set isTopModule 0
...
set C_modelName {main_Pipeline_loop_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "s", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ii", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ i_1 sc_in sc_lv 8 signal 1 } 
	{ ii sc_in sc_lv 16 signal 2 } 
	{ array_r_address0 sc_out sc_lv 16 signal 3 } 
	{ array_r_ce0 sc_out sc_logic 1 signal 3 } 
	{ array_r_q0 sc_in sc_lv 32 signal 3 } 
	{ s_2_out sc_out sc_lv 32 signal 4 } 
	{ s_2_out_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ii", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "ii", "role": "default" }} , 
