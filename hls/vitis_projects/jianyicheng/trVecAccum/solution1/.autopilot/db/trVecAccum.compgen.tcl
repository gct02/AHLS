...
set id 8
set name trVecAccum_mac_muladd_9ns_9ns_3ns_16_4_1
...
set ce_signed 0
set out_width 16
set arg_lists {i0 {9 0 +} i1 {9 0 +} m {16 1 +} i2 {3 0 +} p {16 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename r \
    op interface \
    ports { r_address0 { O 16 vector } r_ce0 { O 1 bit } r_we0 { O 1 bit } r_d0 { O 32 vector } r_q0 { I 32 vector } } \
} "
} else {
