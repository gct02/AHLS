# 1 "benchmarks/jianyicheng/getTanhDouble/src/inlined.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/getTanhDouble/src/inlined.cpp" 2
# 10 "benchmarks/jianyicheng/getTanhDouble/src/inlined.cpp"
...
# 11 "benchmarks/jianyicheng/getTanhDouble/src/inlined.cpp" 2

void inlined(double A[1000], int addr_in[1000], int addr_out[1000]){
  int i;
  double result, is_neg, beta;

  VITIS_LOOP_16_1: for (i = 0; i < 1000; i++){
       beta = A[addr_in[i]];
