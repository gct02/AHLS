# 1 "benchmarks/jianyicheng/getTanhDouble/src/getTanhDouble_tb.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/getTanhDouble/src/getTanhDouble_tb.cpp" 2
# 10 "benchmarks/jianyicheng/getTanhDouble/src/getTanhDouble_tb.cpp"
...
# 11 "benchmarks/jianyicheng/getTanhDouble/src/getTanhDouble_tb.cpp" 2
...
# 39 "/tools/Xilinx/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/iostream" 2 3
...
# 62 "/tools/Xilinx/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/bits/stl_algobase.h" 2 3
...
# 63 "/tools/Xilinx/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/bits/stl_algobase.h" 2 3
...
# 12 "benchmarks/jianyicheng/getTanhDouble/src/getTanhDouble_tb.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 14 "benchmarks/jianyicheng/getTanhDouble/src/getTanhDouble_tb.cpp" 2
...
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_getTanhDouble.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 26 "benchmarks/jianyicheng/getTanhDouble/src/getTanhDouble_tb.cpp"


    double A[1000], gold[1000];
    int addr_out[1000],addr_in[1000];

    VITIS_LOOP_31_1: for (int i = 0; i < 1000; i++){
        A[i] = i % 100 == 0? ((double)_rand()/2147483647*2.0-1.0): 1.2;
  gold[i] = A[i];
  addr_out[i] = i;
    addr_in[i] = i;
    }
    ...
    int results = 0;
    VITIS_LOOP_43_2: for (int i = 0; i < 1000; i++)
 results += (gold[i] == A[i]);
