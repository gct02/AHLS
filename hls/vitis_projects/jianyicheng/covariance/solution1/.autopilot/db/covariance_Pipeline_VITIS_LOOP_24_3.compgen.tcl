...
set name covariance_fmul_32ns_32ns_32_4_max_dsp_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_bitcast_ln28 \
    op interface \
    ports { bitcast_ln28 { I 32 vector } } \
} "
}
