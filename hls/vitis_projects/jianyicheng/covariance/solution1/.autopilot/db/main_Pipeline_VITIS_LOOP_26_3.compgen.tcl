...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { data_load_32 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln24_2 \
    op interface \
    ports { zext_ln24_2 { I 5 vector } } \
} "
}
