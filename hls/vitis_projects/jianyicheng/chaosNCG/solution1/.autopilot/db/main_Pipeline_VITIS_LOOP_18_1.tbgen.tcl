...
set C_modelArgList {
	{ M int 11 regular {array 2000 { 0 3 } 0 1 }  }
	{ buffer_r int 32 regular {array 2000 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "M", "interface" : "memory", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "M_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "M", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_16ns_12ns_11_20_1_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_16ns_12ns_16_20_1_U2", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2022", "Max" : "2022"}
	, {"Name" : "Interval", "Min" : "2022", "Max" : "2022"}
]}
...
set Spec2ImplPortList { 
	M { ap_memory {  { M_address0 mem_address 1 11 }  { M_ce0 mem_ce 1 1 }  { M_we0 mem_we 1 1 }  { M_d0 mem_din 1 11 } } }
	buffer_r { ap_memory {  { buffer_r_address0 mem_address 1 11 }  { buffer_r_ce0 mem_ce 1 1 }  { buffer_r_we0 mem_we 1 1 }  { buffer_r_d0 mem_din 1 32 } } }
}
