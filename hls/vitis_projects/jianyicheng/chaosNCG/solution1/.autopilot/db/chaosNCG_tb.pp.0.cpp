# 1 "benchmarks/jianyicheng/chaosNCG/src/chaosNCG_tb.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/chaosNCG/src/chaosNCG_tb.cpp" 2
...
# 2 "benchmarks/jianyicheng/chaosNCG/src/chaosNCG_tb.cpp" 2
...
# 3 "benchmarks/jianyicheng/chaosNCG/src/chaosNCG_tb.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 4 "benchmarks/jianyicheng/chaosNCG/src/chaosNCG_tb.cpp" 2
...
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_chaosNCG.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 14 "benchmarks/jianyicheng/chaosNCG/src/chaosNCG_tb.cpp"

 int I = 10, bo = 900, M[2000], X = 250, Y = 250, params[2], buffer[2000];
 params[0] = 127;
 params[1] = 41;
 VITIS_LOOP_18_1: for (int i = 0; i < 2000; i++){
  M[i] = _rand()%2000;
  buffer[i] = _rand()%2000;
 }
