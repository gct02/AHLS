set moduleName main_Pipeline_VITIS_LOOP_7_1
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_7_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ M int 11 regular {array 2000 { 1 1 } 1 1 }  }
	{ buffer_r int 32 regular {array 2000 { 2 2 } 1 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "M", "interface" : "memory", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ M_address0 sc_out sc_lv 11 signal 0 } 
	{ M_ce0 sc_out sc_logic 1 signal 0 } 
	{ M_q0 sc_in sc_lv 11 signal 0 } 
	{ M_address1 sc_out sc_lv 11 signal 0 } 
	{ M_ce1 sc_out sc_logic 1 signal 0 } 
	{ M_q1 sc_in sc_lv 11 signal 0 } 
	{ buffer_r_address0 sc_out sc_lv 11 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "M_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "M", "role": "q0" }} , 
 	...
 	{ "name": "M_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "M", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "main_Pipeline_VITIS_LOOP_7_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "76504", "EstimateLatencyMax" : "76504",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.srem_32ns_6ns_32_36_1_U7", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.srem_32ns_6ns_32_36_1_U8", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	main_Pipeline_VITIS_LOOP_7_1 {
		M {Type I LastRead 2 FirstWrite -1}
		buffer_r {Type IO LastRead 4 FirstWrite 46}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "76504", "Max" : "76504"}
	, {"Name" : "Interval", "Min" : "76504", "Max" : "76504"}
]}
...
set Spec2ImplPortList { 
	M { ap_memory {  { M_address0 mem_address 1 11 }  { M_ce0 mem_ce 1 1 }  { M_q0 mem_dout 0 11 }  { M_address1 MemPortADDR2 1 11 }  { M_ce1 MemPortCE2 1 1 }  { M_q1 MemPortDOUT2 0 11 } } }
	buffer_r { ap_memory {  { buffer_r_address0 mem_address 1 11 }  { buffer_r_ce0 mem_ce 1 1 }  { buffer_r_we0 mem_we 1 1 }  { buffer_r_d0 mem_din 1 32 }  { buffer_r_q0 mem_dout 0 32 }  { buffer_r_address1 MemPortADDR2 1 11 }  { buffer_r_ce1 MemPortCE2 1 1 }  { buffer_r_we1 MemPortWE2 1 1 }  { buffer_r_d1 MemPortDIN2 1 32 }  { buffer_r_q1 MemPortDOUT2 0 32 } } }
}
