# 1 "benchmarks/jianyicheng/vecTrans2/src/vecTrans2_tb.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/vecTrans2/src/vecTrans2_tb.cpp" 2
# 1 "benchmarks/jianyicheng/vecTrans2/src/vecTrans2.h" 1
void vecTrans2(int A[1024], int b[1024]);
int g(int d);
# 2 "benchmarks/jianyicheng/vecTrans2/src/vecTrans2_tb.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 3 "benchmarks/jianyicheng/vecTrans2/src/vecTrans2_tb.cpp" 2
...
# 4 "benchmarks/jianyicheng/vecTrans2/src/vecTrans2_tb.cpp" 2
...
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_vecTrans2.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 15 "benchmarks/jianyicheng/vecTrans2/src/vecTrans2_tb.cpp"

      int A[1024], b[1024];

      VITIS_LOOP_18_1: for(int j = 0; j < 1024; ++j){
        A[j] = j % 50-25;
        b[j] = _rand()%1024;
      }
