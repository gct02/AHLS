...
using hls::sim::Byte;
extern "C" void vecTrans2(Byte<4>*, Byte<4>*);
extern "C" void apatb_vecTrans2_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_b) {
...
__xlx_b__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_b)[i]);
  ...
  // DUT call
  vecTrans2(__xlx_A__tmp_vec.data(), __xlx_b__tmp_vec.data());
