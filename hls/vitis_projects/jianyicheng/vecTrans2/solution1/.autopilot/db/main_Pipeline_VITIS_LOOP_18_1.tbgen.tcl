set moduleName main_Pipeline_VITIS_LOOP_18_1
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_18_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ A int 32 regular {array 1024 { 0 3 } 0 1 }  }
	{ b int 10 regular {array 1024 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "b", "interface" : "memory", "bitwidth" : 10, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "b_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "b", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_10ns_7ns_6_14_1_U1", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	b { ap_memory {  { b_address0 mem_address 1 10 }  { b_ce0 mem_ce 1 1 }  { b_we0 mem_we 1 1 }  { b_d0 mem_din 1 10 } } }
}
