set moduleName main_Pipeline_VITIS_LOOP_44_2
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_44_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gold int 32 regular {array 1000 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ gold_q0 sc_in sc_lv 32 signal 0 } 
...
set Spec2ImplPortList { 
	gold { ap_memory {  { gold_address0 mem_address 1 10 }  { gold_ce0 mem_ce 1 1 }  { gold_q0 mem_dout 0 32 } } }
