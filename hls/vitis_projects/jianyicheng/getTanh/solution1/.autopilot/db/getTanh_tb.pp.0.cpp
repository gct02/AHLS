# 1 "benchmarks/jianyicheng/getTanh/src/getTanh_tb.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/getTanh/src/getTanh_tb.cpp" 2
# 11 "benchmarks/jianyicheng/getTanh/src/getTanh_tb.cpp"
...
# 12 "benchmarks/jianyicheng/getTanh/src/getTanh_tb.cpp" 2
...
# 13 "benchmarks/jianyicheng/getTanh/src/getTanh_tb.cpp" 2
...
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_getTanh.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 24 "benchmarks/jianyicheng/getTanh/src/getTanh_tb.cpp"
    ...
    VITIS_LOOP_32_1: for (int i = 0; i < 1000; i++){
        A[i] = 30000;
 gold[i] = A[i];
 addr_out[i] = i;
   addr_in[i] = i;
    ...
    int results = 0;
    VITIS_LOOP_44_2: for (int i = 0; i < 1000; i++)
 results += (gold[i] == A[i]);
