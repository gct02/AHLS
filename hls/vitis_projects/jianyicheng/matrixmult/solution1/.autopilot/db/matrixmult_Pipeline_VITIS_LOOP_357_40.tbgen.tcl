set moduleName matrixmult_Pipeline_VITIS_LOOP_357_40
set isTopModule 0
...
set C_modelName {matrixmult_Pipeline_VITIS_LOOP_357_40}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln301_1 int 5 regular  }
	{ A_7 int 32 regular {array 8192 { 1 3 } 1 1 }  }
	{ B_4 int 32 regular {array 8192 { 1 3 } 1 1 }  }
	{ s_7_12_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln301_1", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "A_7", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "B_4", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "s_7_12_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ zext_ln301_1 sc_in sc_lv 5 signal 0 } 
	{ A_7_address0 sc_out sc_lv 13 signal 1 } 
	{ A_7_ce0 sc_out sc_logic 1 signal 1 } 
	{ A_7_q0 sc_in sc_lv 32 signal 1 } 
	{ B_4_address0 sc_out sc_lv 13 signal 2 } 
	{ B_4_ce0 sc_out sc_logic 1 signal 2 } 
	{ B_4_q0 sc_in sc_lv 32 signal 2 } 
	{ s_7_12_out sc_out sc_lv 32 signal 3 } 
	{ s_7_12_out_ap_vld sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln301_1", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln301_1", "role": "default" }} , 
 	...
 	{ "name": "s_7_12_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "s_7_12_out", "role": "default" }} , 
 	{ "name": "s_7_12_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "s_7_12_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	zext_ln301_1 { ap_none {  { zext_ln301_1 in_data 0 5 } } }
	A_7 { ap_memory {  { A_7_address0 mem_address 1 13 }  { A_7_ce0 mem_ce 1 1 }  { A_7_q0 in_data 0 32 } } }
	B_4 { ap_memory {  { B_4_address0 mem_address 1 13 }  { B_4_ce0 mem_ce 1 1 }  { B_4_q0 in_data 0 32 } } }
	s_7_12_out { ap_vld {  { s_7_12_out out_data 1 32 }  { s_7_12_out_ap_vld out_vld 1 1 } } }
}
