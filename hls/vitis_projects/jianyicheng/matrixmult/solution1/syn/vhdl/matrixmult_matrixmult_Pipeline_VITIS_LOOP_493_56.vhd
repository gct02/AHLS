...
entity matrixmult_matrixmult_Pipeline_VITIS_LOOP_493_56 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of matrixmult_matrixmult_Pipeline_VITIS_LOOP_493_56 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln493_reg_285 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage5 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln493_fu_133_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln496_fu_185_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln496_reg_310 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln496_1_fu_191_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln496_1_reg_315 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln496_2_fu_211_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln496_2_reg_320 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln496_3_fu_217_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln496_3_reg_325 : STD_LOGIC_VECTOR (0 downto 0);
    signal temp_b_fu_223_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage2 : signal is "none";
    signal ap_block_pp0_stage2_11001 : BOOLEAN;
    signal tmp_40_reg_336 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_42_reg_341 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_pp0_stage3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage3 : signal is "none";
    signal ap_block_pp0_stage3_11001 : BOOLEAN;
    signal or_ln496_2_fu_246_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln496_2_reg_346 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage5_11001 : BOOLEAN;
    signal mul_reg_351 : STD_LOGIC_VECTOR (31 downto 0);
    signal s_7_load_3_reg_356 : STD_LOGIC_VECTOR (31 downto 0);
    signal s_7_5_reg_362 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage4 : signal is "none";
    signal ap_block_pp0_stage4_11001 : BOOLEAN;
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal zext_ln494_fu_155_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal s_7_fu_56 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal s_7_6_fu_256_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage5 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal j_fu_60 : STD_LOGIC_VECTOR (13 downto 0) := "00000000000000";
    signal add_ln493_fu_139_p2 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal trunc_ln493_fu_145_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal zext_ln437_1_cast_fu_116_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln494_fu_149_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_s_fu_171_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln496_fu_181_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal tmp_41_fu_197_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln496_1_fu_207_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal or_ln496_fu_228_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln496_1_fu_237_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln496_fu_232_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln496_1_fu_241_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln493_fu_133_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    A_7_address0 <= zext_ln494_fu_155_p1(13 - 1 downto 0);
    ...
    B_6_address0 <= zext_ln494_fu_155_p1(13 - 1 downto 0);
    ...
    add_ln493_fu_139_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_15) + unsigned(ap_const_lv14_1));
    add_ln494_fu_149_p2 <= std_logic_vector(unsigned(trunc_ln493_fu_145_p1) + unsigned(zext_ln437_1_cast_fu_116_p1));
    and_ln496_1_fu_241_p2 <= (tmp_42_reg_341 and or_ln496_1_fu_237_p2);
    and_ln496_fu_232_p2 <= (tmp_40_reg_336 and or_ln496_fu_228_p2);
    ...
    ap_condition_exit_pp0_iter0_stage5_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage5, ap_block_pp0_stage5_subdone, icmp_ln493_reg_285)
    begin
        if (((icmp_ln493_reg_285 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage5_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
    ...
    ap_sig_allocacmp_j_15_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_fu_60)
    begin
    ...
    icmp_ln493_fu_133_p2 <= "1" when (ap_sig_allocacmp_j_15 = ap_const_lv14_2000) else "0";
    icmp_ln496_1_fu_191_p2 <= "1" when (trunc_ln496_fu_181_p1 = ap_const_lv23_0) else "0";
    icmp_ln496_2_fu_211_p2 <= "0" when (tmp_41_fu_197_p4 = ap_const_lv8_FF) else "1";
    icmp_ln496_3_fu_217_p2 <= "1" when (trunc_ln496_1_fu_207_p1 = ap_const_lv23_0) else "0";
    icmp_ln496_fu_185_p2 <= "0" when (tmp_s_fu_171_p4 = ap_const_lv8_FF) else "1";
    or_ln496_1_fu_237_p2 <= (icmp_ln496_3_reg_325 or icmp_ln496_2_reg_320);
    or_ln496_2_fu_246_p2 <= (and_ln496_fu_232_p2 or and_ln496_1_fu_241_p2);
    or_ln496_fu_228_p2 <= (icmp_ln496_reg_310 or icmp_ln496_1_reg_315);
    s_7_18_out <= s_7_fu_56;

    s_7_18_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage5, icmp_ln493_reg_285, ap_block_pp0_stage5_11001)
    begin
        if (((icmp_ln493_reg_285 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
    ...
    s_7_6_fu_256_p3 <= 
        s_7_load_3_reg_356 when (or_ln496_2_reg_346(0) = '1') else 
        s_7_5_reg_362;
    temp_a_fu_166_p1 <= A_7_q0;
    temp_b_fu_223_p1 <= B_6_load_reg_305;
    tmp_41_fu_197_p4 <= B_6_q0(30 downto 23);
    tmp_s_fu_171_p4 <= A_7_q0(30 downto 23);
    trunc_ln493_fu_145_p1 <= ap_sig_allocacmp_j_15(13 - 1 downto 0);
    trunc_ln496_1_fu_207_p1 <= B_6_q0(23 - 1 downto 0);
    trunc_ln496_fu_181_p1 <= A_7_q0(23 - 1 downto 0);
    zext_ln437_1_cast_fu_116_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln437_1),13));
    zext_ln494_fu_155_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln494_fu_149_p2),64));
end behav;
