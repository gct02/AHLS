set moduleName gramSchmidt_Pipeline_VITIS_LOOP_36_2
set isTopModule 0
...
set C_modelName {gramSchmidt_Pipeline_VITIS_LOOP_36_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln42_4 int 5 regular  }
	{ a int 32 regular {array 1024 { 1 3 } 1 1 }  }
	{ nrm_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln42_4", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "nrm_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ grp_fu_137_p_opcode sc_out sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "nrm_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "nrm_out", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_137_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_137_p_opcode", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	nrm_out { ap_vld {  { nrm_out out_data 1 32 }  { nrm_out_ap_vld out_vld 1 1 } } }
}
