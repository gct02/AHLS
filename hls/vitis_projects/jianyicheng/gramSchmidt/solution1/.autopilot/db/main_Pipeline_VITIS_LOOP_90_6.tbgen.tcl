set moduleName main_Pipeline_VITIS_LOOP_90_6
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_90_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln90_1 int 6 regular  }
	{ a float 32 regular {array 1024 { 2 0 } 1 1 }  }
	{ q_load float 32 regular  }
	{ k int 5 regular  }
	{ q float 32 regular {array 1024 { 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
	{ zext_ln90_3 int 5 regular  }
	{ zext_ln90_2 int 5 regular  }
	{ zext_ln90_4 int 5 regular  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln90_1", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln90_2", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln90_1 sc_in sc_lv 6 signal 0 } 
	...
	{ k sc_in sc_lv 5 signal 3 } 
	{ q_address0 sc_out sc_lv 10 signal 4 } 
	{ q_ce0 sc_out sc_logic 1 signal 4 } 
	{ q_q0 sc_in sc_lv 32 signal 4 } 
	{ zext_ln90_3 sc_in sc_lv 5 signal 5 } 
	{ zext_ln90_2 sc_in sc_lv 5 signal 6 } 
	{ zext_ln90_4 sc_in sc_lv 5 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln90_1", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln90_1", "role": "default" }} , 
 	...
 	{ "name": "zext_ln90_2", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln90_2", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln90_1 { ap_none {  { zext_ln90_1 in_data 0 6 } } }
	a { ap_memory {  { a_address0 mem_address 1 10 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 32 }  { a_q0 mem_dout 0 32 }  { a_address1 MemPortADDR2 1 10 }  { a_ce1 MemPortCE2 1 1 }  { a_we1 MemPortWE2 1 1 }  { a_d1 MemPortDIN2 1 32 } } }
	q_load { ap_none {  { q_load in_data 0 32 } } }
	k { ap_none {  { k in_data 0 5 } } }
	q { ap_memory {  { q_address0 mem_address 1 10 }  { q_ce0 mem_ce 1 1 }  { q_q0 mem_dout 0 32 } } }
	zext_ln90_3 { ap_none {  { zext_ln90_3 in_data 0 5 } } }
	zext_ln90_2 { ap_none {  { zext_ln90_2 in_data 0 5 } } }
