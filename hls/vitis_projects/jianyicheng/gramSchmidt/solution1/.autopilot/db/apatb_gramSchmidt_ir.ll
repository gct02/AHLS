; ModuleID = '/home/gabriel/Documents/UFRGS/RAISE/ahls_resource_estimation/vitis_projects/gramSchmidt/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_gramSchmidt_ir(float* noalias nocapture nonnull "fpga.decayed.dim.hint"="1024" %a, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="1024" %r, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="1024" %q) local_unnamed_addr #0 {
entry:
  ...
  %r_copy = bitcast i8* %malloccall1 to [1024 x float]*
  %malloccall2 = tail call i8* @malloc(i64 4096)
  %q_copy = bitcast i8* %malloccall2 to [1024 x float]*
  %0 = bitcast float* %a to [1024 x float]*
  %1 = bitcast float* %r to [1024 x float]*
  %2 = bitcast float* %q to [1024 x float]*
  call fastcc void @copy_in([1024 x float]* nonnull %0, [1024 x float]* %a_copy, [1024 x float]* nonnull %1, [1024 x float]* %r_copy, [1024 x float]* nonnull %2, [1024 x float]* %q_copy)
  call void @apatb_gramSchmidt_hw([1024 x float]* %a_copy, [1024 x float]* %r_copy, [1024 x float]* %q_copy)
  call void @copy_back([1024 x float]* %0, [1024 x float]* %a_copy, [1024 x float]* %1, [1024 x float]* %r_copy, [1024 x float]* %2, [1024 x float]* %q_copy)
...
declare void @apatb_gramSchmidt_hw([1024 x float]*, [1024 x float]*, [1024 x float]*)
...
define void @gramSchmidt_hw_stub_wrapper([1024 x float]*, [1024 x float]*, [1024 x float]*) #5 {
entry:
