set moduleName main_Pipeline_VITIS_LOOP_36_3
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_36_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ h float 32 regular {array 16384 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	h { ap_memory {  { h_address0 mem_address 1 14 }  { h_ce0 mem_ce 1 1 }  { h_we0 mem_we 1 1 }  { h_d0 mem_din 1 32 } } }
}
