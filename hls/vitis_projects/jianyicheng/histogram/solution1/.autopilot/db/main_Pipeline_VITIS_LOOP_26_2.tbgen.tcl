set moduleName main_Pipeline_VITIS_LOOP_26_2
set isTopModule 0
...
set C_modelName {main_Pipeline_VITIS_LOOP_26_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ hist double 64 regular {array 1000 { 1 3 } 1 1 }  }
	{ t_out int 10 regular {pointer 1}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "hist", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "t_out", "interface" : "wire", "bitwidth" : 10, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ hist_q0 sc_in sc_lv 64 signal 0 } 
	{ t_out sc_out sc_lv 10 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "t_out", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "t_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	hist { ap_memory {  { hist_address0 mem_address 1 10 }  { hist_ce0 mem_ce 1 1 }  { hist_q0 mem_dout 0 64 } } }
	t_out { ap_vld {  { t_out out_data 1 10 }  { t_out_ap_vld out_vld 1 1 } } }
}
