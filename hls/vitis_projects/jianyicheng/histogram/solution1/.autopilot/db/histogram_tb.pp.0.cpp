# 1 "benchmarks/jianyicheng/histogram/src/histogram_tb.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/jianyicheng/histogram/src/histogram_tb.cpp" 2
# 10 "benchmarks/jianyicheng/histogram/src/histogram_tb.cpp"
...
# 11 "benchmarks/jianyicheng/histogram/src/histogram_tb.cpp" 2

__attribute__((sdx_kernel("main", 0))) int main(){
#line 7 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/AHLS/hls/tcl/run_histogram.tcl"
#pragma HLSDIRECTIVE TOP name=main
# 12 "benchmarks/jianyicheng/histogram/src/histogram_tb.cpp"

 int f[1000];
 double w[1000], hist[1000];

 VITIS_LOOP_16_1: for(int i = 0; i<1000; i++){
 ...
 int t = 0;
   VITIS_LOOP_26_2: for (int i= 0; i<1000; i++)
  t+=(hist[i]==0.1);
