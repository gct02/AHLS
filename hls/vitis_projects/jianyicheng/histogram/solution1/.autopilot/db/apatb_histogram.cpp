...
// wrapc file define:
#define AUTOTB_TVIN_f "../tv/cdatafile/c.histogram.autotvin_f.dat"
#define AUTOTB_TVOUT_f "../tv/cdatafile/c.histogram.autotvout_f.dat"
#define AUTOTB_TVIN_w "../tv/cdatafile/c.histogram.autotvin_w.dat"
#define AUTOTB_TVOUT_w "../tv/cdatafile/c.histogram.autotvout_w.dat"
...
extern "C"
void histogram_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_histogram_hw(void* __xlx_apatb_param_f, void* __xlx_apatb_param_w, void* __xlx_apatb_param_hist)
{
#ifdef USE_BINARY_TV_FILE
  ...
  port0.param = { __xlx_apatb_param_f };
  port0.nbytes = { 4000 };
  port0.offset = {  };
  ...
  port2.param = { __xlx_apatb_param_hist };
  port2.nbytes = { 8000 };
  port2.offset = {  };
  port2.hasWrite = { true };
  ...
  try {
    ...
    histogram_hw_stub_wrapper(__xlx_apatb_param_f, __xlx_apatb_param_w, __xlx_apatb_param_hist);
