; ModuleID = '/home/gabriel/Documents/UFRGS/RAISE/ahls_resource_estimation/vitis_projects/gSum/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define double @apatb_gSum_ir(double* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1000" %A, double* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1000" %B) local_unnamed_addr #0 {
entry:
  ...
  %2 = call double @apatb_gSum_hw([1000 x double]* %A_copy, [1000 x double]* %B_copy)
...
declare double @apatb_gSum_hw([1000 x double]*, [1000 x double]*)
...
define double @gSum_hw_stub_wrapper([1000 x double]*, [1000 x double]*) #5 {
entry:
