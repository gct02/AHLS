...
def main(args: Dict[str, str]):
    ...
    out_channels = 1
    hid_dim = [512, 384, 256, 256, 256, 256]
    heads = [8, 8, 4, 4, 4, 4]
    ...
    model = HGT(
        ...
        hid_dim=hid_dim, heads=heads, num_layers=num_layers,
        proj_in_dim=proj_in_dim, proj_out_dim=proj_out_dim,
        jk_layers=jk_layers, dropout=0.0
    ).to(DEVICE)
