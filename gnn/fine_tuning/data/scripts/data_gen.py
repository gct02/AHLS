...
class DatasetGenerator:
    ...
    def _run_synth(self, solution_name):
        ...
        try:
            ...
            vitis_subproc = subprocess.Popen([self.vitis_run_script, self._hls_tcl_path])
            start_time = time.time()
            proc = psutil.Process(vitis_subproc.pid)
...
if __name__ == "__main__":
    ...
    if args.filter_dct:
        import pickle
        from gnn.fine_tuning.data.hls_dct_config import filter_directive_groups
