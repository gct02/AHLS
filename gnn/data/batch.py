...
from gnn.data.collate import collate
...
class DynamicInheritance(type):
    ...
    def __call__(cls, *args: Any, **kwargs: Any) -> Any:
        ...
        if issubclass(base_cls, HLSBatch):
            new_cls = base_cls
        else:
...
class HLSBatch(metaclass=DynamicInheritance):
    ...
    def from_data_list(
        ...
        batch, slice_dict, inc_dict = collate(
            ...
            data_list=data_list,
            increment=True,
            add_batch=not isinstance(data_list[0], HLSBatch),
