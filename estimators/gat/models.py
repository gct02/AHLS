...
class GAT(nn.Module):
    def __init__(self, in_features_1:int, in_features_2:int, out_size:int):
        ...
        self.gat14 = GraphAttentionalLayer(6, out_size, 3, False, 0.1, 0.0)
        ...
        self.gat24 = GraphAttentionalLayer(8, out_size, 3, False, 0.1, 0.0)
...
class GAT(nn.Module):
    def __init__(self, in_features_1:int, in_features_2:int, out_size:int, 
                 hidden_size_1:int=6, hidden_size_2:int=12, n_layers:int=5):
        super(GAT, self).__init__()
        ...
        self.gat_jkn_pre_1 = GraphAttentionalLayer(in_features_1, hidden_size_1, 1, True, 0.01, 0.5)
        self.gat_jkn_1 = GraphAttentionalLayer(hidden_size_1, hidden_size_1, 2, True, 0.01, 0.4)
        ...
        self.gat_jkn_2 = GraphAttentionalLayer(hidden_size_2, hidden_size_2, 4, True, 0.01, 0.4)
