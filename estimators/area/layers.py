...
from estimators.area.scatter import scatter_add


class GlobalSoftAttention(torch.nn.Module):
    ...
    def forward(self, x, batch, mask=None, size=None):
        ...
        if mask is not None:
            # Set gate scores of masked-out nodes to a large negative number
            gate[~mask] = -1e9
