...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i32 %%storemerge1 to i64, !dbg !2 for 0x%llxth hint within @jpeg2bmp  --> \n", ++aesl_llvm_cbe_17_count);
  llvm_cbe_tmp__1 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds i8* %%inputVector, i64 %%2, !dbg !2 for 0x%llxth hint within @jpeg2bmp  --> \n", ++aesl_llvm_cbe_18_count);
  llvm_cbe_tmp__2 = ( char *)(&llvm_cbe_inputVector[(((signed long long )llvm_cbe_tmp__1))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%llX",((signed long long )llvm_cbe_tmp__1));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load i8* %%3, align 1, !dbg !2 for 0x%llxth hint within @jpeg2bmp  --> \n", ++aesl_llvm_cbe_19_count);
  llvm_cbe_tmp__3 = (unsigned char )*llvm_cbe_tmp__2;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds [16384 x i8]* %%JpegFileBuf, i64 0, i64 %%2, !dbg !2 for 0x%llxth hint within @jpeg2bmp  --> \n", ++aesl_llvm_cbe_20_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%4, i8* %%5, align 1, !dbg !2 for 0x%llxth hint within @jpeg2bmp  --> \n", ++aesl_llvm_cbe_21_count);
  *llvm_cbe_tmp__4 = llvm_cbe_tmp__3;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = add nsw i32 %%storemerge1, 1, !dbg !4 for 0x%llxth hint within @jpeg2bmp  --> \n", ++aesl_llvm_cbe_22_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds [16384 x i8]* %%JpegFileBuf, i64 0, i64 0, !dbg !3 for 0x%llxth hint within @jpeg2bmp  --> \n", ++aesl_llvm_cbe_29_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds [3 x i32]* %%outCompVpos, i64 0, i64 0, !dbg !3 for 0x%llxth hint within @jpeg2bmp  --> \n", ++aesl_llvm_cbe_30_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = getelementptr inbounds [3 x i32]* %%outCompHpos, i64 0, i64 0, !dbg !3 for 0x%llxth hint within @jpeg2bmp  --> \n", ++aesl_llvm_cbe_31_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @jpeg_decode(i8* %%7, [16384 x i8]* %%outputVector, i32 undef, i32 undef, i32* %%8, i32* %%9) nounwind, !dbg !3 for 0x%llxth hint within @jpeg2bmp  --> \n", ++aesl_llvm_cbe_32_count);
