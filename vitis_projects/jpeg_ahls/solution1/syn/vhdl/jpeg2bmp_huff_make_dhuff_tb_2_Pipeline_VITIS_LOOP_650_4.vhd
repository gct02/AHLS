...
entity jpeg2bmp_huff_make_dhuff_tb_2_Pipeline_VITIS_LOOP_650_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of jpeg2bmp_huff_make_dhuff_tb_2_Pipeline_VITIS_LOOP_650_4 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln652_1_fu_171_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln652_1_reg_231 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal code_4_fu_146_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_code_3 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_2_fu_50 : STD_LOGIC_VECTOR (33 downto 0) := "0000000000000000000000000000000000";
    signal sext_ln650_cast_fu_120_p1 : STD_LOGIC_VECTOR (33 downto 0);
    signal add_ln651_fu_156_p2 : STD_LOGIC_VECTOR (33 downto 0);
    signal ap_sig_allocacmp_p : STD_LOGIC_VECTOR (33 downto 0);
...
begin
    ...
    p_2_fu_50_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    add_ln651_fu_156_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_p) + unsigned(ap_const_lv34_1));
    ...
    and_ln652_fu_192_p2 <= (icmp_ln652_fu_187_p2 and icmp_ln652_1_reg_231);
    ...
    ap_sig_allocacmp_code_3_assign_proc : process(ap_CS_fsm_state1, code, code_1_fu_46, ap_loop_init)
    begin
    ...
    ap_sig_allocacmp_p_assign_proc : process(ap_CS_fsm_state1, ap_loop_init, p_2_fu_50, sext_ln650_cast_fu_120_p1)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    code_2_out <= trunc_ln628_reg_216;

    code_2_out_ap_vld_assign_proc : process(ap_CS_fsm_state2, and_ln652_fu_192_p2)
    begin
        if (((ap_const_lv1_0 = and_ln652_fu_192_p2) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            code_2_out_ap_vld <= ap_const_logic_1;
        else 
            code_2_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    code_4_fu_146_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_code_3) + unsigned(ap_const_lv32_1));
    ...
    huffcode_d0 <= ap_sig_allocacmp_code_3;
    ...
    icmp_ln652_1_fu_171_p2 <= "1" when (signed(add_ln651_fu_156_p2) < signed(ap_const_lv34_101)) else "0";
    icmp_ln652_fu_187_p2 <= "1" when (huffsize_q0 = size_2) else "0";
        sext_ln650_cast_fu_120_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln650),34));

    trunc_ln628_fu_152_p1 <= code_4_fu_146_p2(31 - 1 downto 0);
    trunc_ln651_fu_162_p1 <= add_ln651_fu_156_p2(32 - 1 downto 0);
    zext_ln628_fu_141_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_p),64));
