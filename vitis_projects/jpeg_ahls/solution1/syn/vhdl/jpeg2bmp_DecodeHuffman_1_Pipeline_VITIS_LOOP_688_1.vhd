...
entity jpeg2bmp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of jpeg2bmp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1 is 
...
attribute shreg_extract : string;
    ...
    signal l_2_reg_274 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal code_8_fu_52 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal code_9_fu_247_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln577_3_cast_fu_116_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ap_sig_allocacmp_l_2 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    code_8_fu_52_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    add_ln688_fu_218_p2 <= std_logic_vector(unsigned(l_2_reg_274) + unsigned(ap_const_lv64_1));
    ...
    ap_sig_allocacmp_l_2_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, l_fu_56)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_l_2 <= ap_const_lv64_1;
        else 
    ...
    code_8_out <= code_8_fu_52;

    code_8_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln688_fu_142_p2, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln688_fu_142_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            code_8_out_ap_vld <= ap_const_logic_1;
        else 
            code_8_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    code_9_fu_247_p3 <= (trunc_ln689_fu_244_p1 & icmp_ln577_fu_238_p2);
    ...
    icmp_ln688_fu_142_p2 <= "1" when (signed(code_8_fu_52) > signed(p_jinfo_dc_dhuff_tbl_maxcode_q0)) else "0";
    ...
    p_jinfo_dc_dhuff_tbl_maxcode_address0 <= ap_sig_allocacmp_l_2(7 - 1 downto 0);

    p_jinfo_dc_dhuff_tbl_maxcode_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    trunc_ln688_fu_134_p1 <= ap_sig_allocacmp_l_2(7 - 1 downto 0);
    ...
    zext_ln577_3_cast_fu_116_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln577_3),32));
