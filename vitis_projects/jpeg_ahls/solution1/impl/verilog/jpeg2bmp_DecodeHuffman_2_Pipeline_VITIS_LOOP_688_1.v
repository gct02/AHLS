...
module jpeg2bmp_DecodeHuffman_2_Pipeline_VITIS_LOOP_688_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [0:0] zext_ln577_1;
output  [6:0] l_out;
output   l_out_ap_vld;
output  [31:0] code_6_out;
output   code_6_out_ap_vld;
...
reg   [31:0] code_6_fu_52;
wire   [31:0] code_7_fu_247_p3;
wire   [31:0] zext_ln577_1_cast_fu_116_p1;
wire    ap_loop_init;
reg   [63:0] l_fu_56;
wire   [63:0] add_ln688_fu_218_p2;
reg   [63:0] ap_sig_allocacmp_l_1;
...
always @ (*) begin
    if (((icmp_ln688_fu_142_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        code_6_out_ap_vld = 1'b1;
    end else begin
        code_6_out_ap_vld = 1'b0;
    end
end
...
assign add_ln688_fu_218_p2 = (l_1_reg_274 + 64'd1);
...
assign code_6_out = code_6_fu_52;

assign code_7_fu_247_p3 = {{trunc_ln689_fu_244_p1}, {icmp_ln577_fu_238_p2}};
...
assign icmp_ln688_fu_142_p2 = (($signed(code_6_fu_52) > $signed(p_jinfo_ac_dhuff_tbl_maxcode_q0)) ? 1'b1 : 1'b0);

assign l_out = trunc_ln688_reg_279;

assign p_jinfo_ac_dhuff_tbl_maxcode_address0 = ap_sig_allocacmp_l_1;
...
assign trunc_ln688_fu_134_p1 = ap_sig_allocacmp_l_1[6:0];

assign trunc_ln689_fu_244_p1 = code_reg_289[30:0];

assign zext_ln555_fu_171_p1 = CurHuffReadBuf_i;

assign zext_ln577_1_cast_fu_116_p1 = zext_ln577_1;

assign zext_ln577_fu_213_p1 = ap_phi_mux_empty_phi_fu_109_p4;

endmodule //jpeg2bmp_DecodeHuffman_2_Pipeline_VITIS_LOOP_688_1
