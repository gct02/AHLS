...
$(ObjDir)/jpeg_host.c_pre.c.tb.o : jpeg_host.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) jpeg_host.c_pre.c.tb.c" $(AVE_DIR_DLOG)
...
$(ObjDir)/jpeg_decode.c_pre.c.tb.o : jpeg_decode.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) jpeg_decode.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
