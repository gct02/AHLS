...
module jpeg2bmp_DecodeHuffman_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] code_fu_228_p2;
reg   [0:0] code_reg_309;
wire    ap_CS_fsm_state2;
wire    ap_CS_fsm_state5;
wire   [0:0] icmp_ln692_fu_254_p2;
reg   [0:0] icmp_ln692_reg_329;
wire    ap_CS_fsm_state6;
wire    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_start;
wire    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_done;
wire    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_idle;
wire    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_ready;
wire   [6:0] grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_l_out;
wire    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_l_out_ap_vld;
wire   [31:0] grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_code_8_out;
wire    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_code_8_out_ap_vld;
wire   [6:0] grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_p_jinfo_dc_dhuff_tbl_maxcode_address0;
wire    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_p_jinfo_dc_dhuff_tbl_maxcode_ce0;
wire   [31:0] grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_current_read_byte_o;
wire    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_current_read_byte_o_ap_vld;
wire   [31:0] grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_read_position_o;
wire    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_read_position_o_ap_vld;
wire   [7:0] grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_CurHuffReadBuf_o;
wire    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_CurHuffReadBuf_o_ap_vld;
reg   [31:0] ap_phi_mux_empty_phi_fu_124_p4;
wire   [0:0] tmp_fu_153_p3;
reg    grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_start_reg;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
wire   [63:0] zext_ln577_fu_213_p1;
wire   [63:0] l_reload_cast_fu_237_p1;
wire   [63:0] zext_ln692_fu_243_p1;
wire   [63:0] zext_ln694_fu_272_p1;
...
wire   [31:0] and_ln577_fu_222_p2;
wire   [10:0] trunc_ln685_fu_250_p1;
wire   [10:0] add_ln693_fu_260_p2;
wire   [10:0] p_fu_266_p2;
wire    ap_CS_fsm_state7;
wire   [7:0] select_ln692_fu_277_p3;
...
initial begin
#0 ap_CS_fsm = 7'd1;
#0 grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_start_reg = 1'b0;
...
jpeg2bmp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1 grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state3)) begin
            grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_start_reg <= 1'b1;
        end else if ((grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_ready == 1'b1)) begin
            grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (tmp_fu_153_p3 == 1'd1))) begin
        CurHuffReadBuf_o = select_ln555_fu_181_p3;
    end else if (((1'b1 == ap_CS_fsm_state4) & (grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_CurHuffReadBuf_o_ap_vld == 1'b1))) begin
        CurHuffReadBuf_o = grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_CurHuffReadBuf_o;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1) & (tmp_fu_153_p3 == 1'd1))) begin
...
always @ (*) begin
    if ((grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        if ((tmp_fu_153_p3 == 1'd0)) begin
            ...
            ap_phi_mux_empty_phi_fu_124_p4 = 32'd7;
        end else begin
            ap_phi_mux_empty_phi_fu_124_p4 = 'bx;
        end
    end else begin
        ap_phi_mux_empty_phi_fu_124_p4 = 'bx;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        bit_set_mask_address0 = zext_ln577_fu_213_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state4) & (grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_current_read_byte_o_ap_vld == 1'b1))) begin
        current_read_byte_o = grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_current_read_byte_o;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        p_jinfo_dc_dhuff_tbl_maxcode_address0 = zext_ln692_fu_243_p1;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        p_jinfo_dc_dhuff_tbl_maxcode_address0 = grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_p_jinfo_dc_dhuff_tbl_maxcode_address0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        p_jinfo_dc_dhuff_tbl_mincode_ce0 = 1'b1;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        p_jinfo_dc_dhuff_tbl_valptr_ce0 = 1'b1;
    end else begin
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state4) & (grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_read_position_o_ap_vld == 1'b1))) begin
        read_position_o = grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_read_position_o;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_done == 1'b1))) begin
...
assign add_ln577_fu_201_p2 = ($signed(ap_phi_mux_empty_phi_fu_124_p4) + $signed(32'd4294967295));

assign add_ln693_fu_260_p2 = (p_jinfo_dc_dhuff_tbl_valptr_q0 + trunc_ln685_fu_250_p1);

assign and_ln577_fu_222_p2 = (current_read_byte_i & bit_set_mask_q0);
...
assign code_fu_228_p2 = ((and_ln577_fu_222_p2 != 32'd0) ? 1'b1 : 1'b0);

assign grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_start = grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_ap_start_reg;

assign icmp_ln555_fu_175_p2 = ((CurHuffReadBuf_i == 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln692_fu_254_p2 = (($signed(grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_code_8_out) < $signed(p_jinfo_dc_dhuff_tbl_maxcode_q0)) ? 1'b1 : 1'b0);

assign l_reload_cast_fu_237_p1 = grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_l_out;

assign p_fu_266_p2 = (add_ln693_fu_260_p2 - p_jinfo_dc_dhuff_tbl_mincode_q0);

assign p_jinfo_ac_xhuff_tbl_huffval_address0 = zext_ln694_fu_272_p1;

assign p_jinfo_dc_dhuff_tbl_mincode_address0 = l_reload_cast_fu_237_p1;

assign p_jinfo_dc_dhuff_tbl_valptr_address0 = l_reload_cast_fu_237_p1;

assign select_ln555_fu_181_p3 = ((icmp_ln555_fu_175_p2[0:0] == 1'b1) ? 8'd1 : add_ln555_fu_165_p2);

assign select_ln692_fu_277_p3 = ((icmp_ln692_reg_329[0:0] == 1'b1) ? p_jinfo_ac_xhuff_tbl_huffval_q0 : 8'd0);

assign tmp_fu_153_p3 = read_position_i[32'd31];

assign trunc_ln685_fu_250_p1 = grp_DecodeHuffman_1_Pipeline_VITIS_LOOP_688_1_fu_131_code_8_out[10:0];

assign zext_ln555_fu_171_p1 = CurHuffReadBuf_i;

assign zext_ln577_fu_213_p1 = ap_phi_mux_empty_phi_fu_124_p4;

assign zext_ln692_fu_243_p1 = Dhuff_ml;

assign zext_ln694_fu_272_p1 = p_fu_266_p2;

endmodule //jpeg2bmp_DecodeHuffman_1
