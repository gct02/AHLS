...
module AESL_automem_outputVector (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.jpeg2bmp.autotvin_outputVector.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.jpeg2bmp.autotvout_outputVector.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 8;
parameter ADDR_WIDTH = 32'd 16;
parameter DEPTH = 32'd 49152;
parameter DLY = 0.1;
