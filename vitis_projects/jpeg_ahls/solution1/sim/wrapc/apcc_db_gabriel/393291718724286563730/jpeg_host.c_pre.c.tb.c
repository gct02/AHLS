...
void apatb_jpeg2bmp_sw( char *, signed int ,  char (*)[16384]);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @apatb_jpeg2bmp_sw(i8* %%1, i32 %%4, [16384 x i8]* %%5) nounwind, !dbg !4 for 0x%llxth hint within @main  --> \n", ++aesl_llvm_cbe_27_count);
  apatb_jpeg2bmp_sw(( char *)llvm_cbe_tmp__1, llvm_cbe_tmp__4, llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE) {
