# 1 "benchmarks/chstone/jpeg/src/jpeg2bmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 339 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/chstone/jpeg/src/jpeg2bmp.c" 2
# 1 "benchmarks/chstone/jpeg/src/jpeg2bmp.h" 1



# 1 "benchmarks/chstone/jpeg/src/constants.h" 1
# 5 "benchmarks/chstone/jpeg/src/jpeg2bmp.h" 2

__attribute__((sdx_kernel("jpeg2bmp", 0))) void jpeg2bmp(
    unsigned char inputVector[6496],
    int jpegSize,
    unsigned char outputVector[3][(128 * 128)]);
# 2 "benchmarks/chstone/jpeg/src/jpeg2bmp.c" 2
...
# 4 "benchmarks/chstone/jpeg/src/jpeg2bmp.c" 2
...
__attribute__((sdx_kernel("jpeg2bmp", 0))) void jpeg2bmp(
    ...
    unsigned char outputVector[3][(128 * 128)])
{
#line 84 "/home/gabriel/Documents/UFRGS/RAISE/AHLS/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=jpeg2bmp
# 9 "benchmarks/chstone/jpeg/src/jpeg2bmp.c"
    ...
    VITIS_LOOP_18_1: for (int i = 0; i < jpegSize; i++) {
