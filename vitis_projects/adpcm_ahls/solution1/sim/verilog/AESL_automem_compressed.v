...
module AESL_automem_compressed (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.adpcm_main.autotvin_compressed.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.adpcm_main.autotvout_compressed.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 12;
parameter DEPTH = 32'd 4000;
parameter DLY = 0.1;
