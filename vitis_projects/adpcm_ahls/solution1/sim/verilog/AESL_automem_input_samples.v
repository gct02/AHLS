...
module AESL_automem_input_samples (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.adpcm_main.autotvin_input_samples.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.adpcm_main.autotvout_input_samples.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 13;
parameter DEPTH = 32'd 8000;
parameter DLY = 0.1;
