...
module adpcm_main_adpcm_main_Pipeline_reset_label5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln561_fu_102_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln561_fu_114_p1;
reg   [2:0] i_1_fu_34;
wire   [2:0] add_ln561_fu_108_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln561_fu_102_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln561_fu_102_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln561_fu_102_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln561_fu_108_p2 = (ap_sig_allocacmp_i + 3'd1);
...
assign dec_del_bph_address0 = zext_ln561_fu_114_p1;

assign dec_del_bph_d0 = 32'd0;

assign dec_del_bpl_address0 = zext_ln561_fu_114_p1;

assign dec_del_bpl_d0 = 32'd0;

assign delay_bph_address0 = zext_ln561_fu_114_p1;

assign delay_bph_d0 = 32'd0;

assign delay_bpl_address0 = zext_ln561_fu_114_p1;

assign delay_bpl_d0 = 32'd0;

assign icmp_ln561_fu_102_p2 = ((ap_sig_allocacmp_i == 3'd6) ? 1'b1 : 1'b0);

assign zext_ln561_fu_114_p1 = ap_sig_allocacmp_i;

endmodule //adpcm_main_adpcm_main_Pipeline_reset_label5
