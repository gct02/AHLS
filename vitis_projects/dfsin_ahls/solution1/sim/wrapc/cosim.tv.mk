...
$(ObjDir)/dfsin_host.c_pre.c.tb.o : dfsin_host.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) dfsin_host.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/populate_io.c_pre.c.tb.o : populate_io.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) populate_io.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/dfsin.c_pre.c.tb.o : dfsin.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) dfsin.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/softfloat.c_pre.c.tb.o : softfloat.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) softfloat.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
