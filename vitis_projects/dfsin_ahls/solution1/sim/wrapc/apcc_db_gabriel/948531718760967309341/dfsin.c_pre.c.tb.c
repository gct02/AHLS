...
signed long long local_sin_hw_stub(signed long long llvm_cbe_rad);
signed long long apatb_local_sin_sw(signed long long llvm_cbe_rad);
void refine_signal_handler();
signed long long apatb_local_sin_ir(signed long long );
...
printf("\n\{ BEGIN @local_sin\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i64 @float64_mul(i64 %%rad, i64 %%rad) nounwind, !dbg !5 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_20_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = tail call i64 @float64_neg(i64 %%1) nounwind, !dbg !5 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_21_count);
...
llvm_cbe_tmp__17:
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = phi i32 [ %%14, %%3 ], [ 1, %%0 ], !dbg !4 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_25_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = phi i64 [ %%12, %%3 ], [ %%rad, %%0 ], !dbg !4 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_26_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = phi i64 [ %%13, %%3 ], [ %%rad, %%0 ], !dbg !4 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_27_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = tail call i64 @float64_mul(i64 %%5, i64 %%2) nounwind, !dbg !4 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_28_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = shl nsw i32 %%4, 1, !dbg !5 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_29_count);
  llvm_cbe_tmp__8 = (unsigned int )llvm_cbe_tmp__4 << 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = or i32 %%8, 1, !dbg !5 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_30_count);
  llvm_cbe_tmp__9 = (unsigned int )llvm_cbe_tmp__8 | 1u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = mul nsw i32 %%9, %%8, !dbg !5 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_31_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = tail call i64 @int32_to_float64(i32 %%10) nounwind, !dbg !5 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_32_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = tail call i64 @float64_div(i64 %%7, i64 %%11) nounwind, !dbg !5 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_33_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = tail call i64 @float64_add(i64 %%6, i64 %%12) nounwind, !dbg !4 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_38_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = add nsw i32 %%4, 1, !dbg !5 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_42_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = tail call i64 @float64_abs(i64 %%12), !dbg !4 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_47_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = tail call i32 @float64_ge(i64 %%15, i64 4532020583610935537) nounwind, !dbg !4 for 0x%llxth hint within @local_sin  --> \n", ++aesl_llvm_cbe_48_count);
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @local_sin_hw_stub\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i64 @local_sin(i64 %%rad), !dbg !3 for 0x%llxth hint within @local_sin_hw_stub  --> \n", ++aesl_llvm_cbe_54_count);
  llvm_cbe_tmp__19 = (unsigned long long ) /*tail*/ local_sin(llvm_cbe_rad);
if (AESL_DEBUG_TRACE) {
printf("\nArgument rad = 0x%llX",llvm_cbe_rad);
printf("\nReturn  = 0x%llX",llvm_cbe_tmp__19);
}
  if (AESL_DEBUG_TRACE)
      printf("\nEND @local_sin_hw_stub}\n");
...
const char* AESL_DEBUG_TRACE = getenv("DEBUG_TRACE");
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @apatb_local_sin_sw\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void (...)* @refine_signal_handler() nounwind, !dbg !3 for 0x%llxth hint within @apatb_local_sin_sw  --> \n", ++aesl_llvm_cbe_60_count);
   /*tail*/ refine_signal_handler();
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i64 @apatb_local_sin_ir(i64 %%rad) nounwind, !dbg !3 for 0x%llxth hint within @apatb_local_sin_sw  --> \n", ++aesl_llvm_cbe_61_count);
  llvm_cbe_tmp__20 = (unsigned long long ) /*tail*/ apatb_local_sin_ir(llvm_cbe_rad);
if (AESL_DEBUG_TRACE) {
printf("\nArgument rad = 0x%llX",llvm_cbe_rad);
printf("\nReturn  = 0x%llX",llvm_cbe_tmp__20);
}
  if (AESL_DEBUG_TRACE)
      printf("\nEND @apatb_local_sin_sw}\n");
...
double ullong_to_double(signed long long llvm_cbe_x) {
  ...
  llvmBitCastUnion llvm_cbe_tmp__21__BITCAST_TEMPORARY;
...
printf("\n  %%1 = bitcast i64 %%x to double, !dbg !3 for 0x%llxth hint within @ullong_to_double  --> \n", ++aesl_llvm_cbe_67_count);
  llvm_cbe_tmp__21 = (double )(llvm_cbe_tmp__21__BITCAST_TEMPORARY.Int64 = llvm_cbe_x, llvm_cbe_tmp__21__BITCAST_TEMPORARY.Double);
if (AESL_DEBUG_TRACE)
