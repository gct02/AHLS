...
void populateInput(signed long long *llvm_cbe_inputVector,  char *llvm_cbe_filename);
void populateOutput(signed long long *llvm_cbe_outputVector,  char *llvm_cbe_filename);


/* Global Variable Definitions and Initialization */
static  char aesl_internal__OC_str2[2] = "w";
static  char aesl_internal__OC_str1[8] = "%016llx";
static  char aesl_internal__OC_str3[5] = "_raw";
static  char aesl_internal__OC_str[2] = "r";
static  char aesl_internal__OC_str4[9] = "%016llx\n";
...
llvm_cbe_tmp__11:
if (AESL_DEBUG_TRACE)
printf("\n  store i8 0, i8* %%9, align 1, !dbg !11 for 0x%llxth hint within @removeExt  --> \n", ++aesl_llvm_cbe_24_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds i64* %%inputVector, i64 %%3, !dbg !10 for 0x%llxth hint within @populateInput  --> \n", ++aesl_llvm_cbe_45_count);
  llvm_cbe_tmp__14 = (signed long long *)(&llvm_cbe_inputVector[(((signed long long )llvm_cbe_tmp__13))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%llX",((signed long long )llvm_cbe_tmp__13));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = tail call i32 (%%struct._IO_FILE*, i8*, ...)* @__isoc99_fscanf(%%struct._IO_FILE* %%1, i8* getelementptr inbounds ([8 x i8]* @aesl_internal_.str1, i64 0, i64 0), i64* %%4) nounwind, !dbg !10 for 0x%llxth hint within @populateInput  --> \n", ++aesl_llvm_cbe_46_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = sext i32 %%6 to i64, !dbg !10 for 0x%llxth hint within @populateInput  --> \n", ++aesl_llvm_cbe_52_count);
  llvm_cbe_tmp__17 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = inttoptr i64 %%7 to i8*, !dbg !10 for 0x%llxth hint within @populateInput  --> \n", ++aesl_llvm_cbe_53_count);
  llvm_cbe_tmp__18 = ( char *)(( char *)(unsigned long)llvm_cbe_tmp__17);
  if ((((unsigned long long )llvm_cbe_tmp__18&18446744073709551615ULL) < ((unsigned long long )llvm_cbe_filename&18446744073709551615ULL))) {
    llvm_cbe_tmp__13__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__17;   /* for PHI node */
...
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = tail call i32 @fclose(%%struct._IO_FILE* %%1) nounwind, !dbg !10 for 0x%llxth hint within @populateInput  --> \n", ++aesl_llvm_cbe_56_count);
...
void populateOutput(signed long long *llvm_cbe_outputVector,  char *llvm_cbe_filename) {
  ...
  l_struct_OC__IO_FILE *llvm_cbe_tmp__20;
  ...
  l_struct_OC__IO_FILE *llvm_cbe_tmp__31;
...
printf("\n  %%1 = tail call noalias %%struct._IO_FILE* @fopen(i8* %%filename, i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str2, i64 0, i64 0)) nounwind, !dbg !10 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_66_count);
  llvm_cbe_tmp__20 = (l_struct_OC__IO_FILE *) /*tail*/ aesl_fopen(( char *)llvm_cbe_filename, ( char *)((&aesl_internal__OC_str2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 2
#endif
])));
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = tail call i8* @removeExt(i8* %%filename), !dbg !10 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_70_count);
  llvm_cbe_tmp__21 = ( char *) /*tail*/ ( char *)removeExt(( char *)llvm_cbe_filename);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%3 = tail call i8* @strrchr(i8* %%filename, i32 46) nounwind readonly, !dbg !11 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_73_count);
  llvm_cbe_tmp__22 = ( char *) /*tail*/ ( char *)strrchr(( char *)llvm_cbe_filename, 46u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",46u);
...
printf("\n  %%4 = tail call i64 @strlen(i8* %%filename) nounwind readonly, !dbg !11 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_76_count);
  llvm_cbe_tmp__23 = (unsigned long long ) /*tail*/ strlen(( char *)llvm_cbe_filename);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%llX",llvm_cbe_tmp__23);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = trunc i64 %%4 to i32, !dbg !11 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_77_count);
  llvm_cbe_tmp__24 = (unsigned int )((unsigned int )llvm_cbe_tmp__23&4294967295U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = add nsw i32 %%5, 5, !dbg !12 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_80_count);
  llvm_cbe_tmp__25 = (unsigned int )((unsigned int )(llvm_cbe_tmp__24&4294967295ull)) + ((unsigned int )(5u&4294967295ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%strlen = tail call i64 @strlen(i8* %%8), !dbg !12 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_strlen_count);
  llvm_cbe_strlen = (unsigned long long ) /*tail*/ strlen(( char *)llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%endptr = getelementptr i8* %%8, i64 %%strlen, !dbg !12 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_endptr_count);
  llvm_cbe_endptr = ( char *)(&llvm_cbe_tmp__27[(((signed long long )llvm_cbe_strlen))]);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%11 = tail call i8* @strcat(i8* %%8, i8* %%3) nounwind, !dbg !11 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_90_count);
   /*tail*/ ( char *)strcat(( char *)llvm_cbe_tmp__27, ( char *)llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE) {
...
printf("\n  %%12 = tail call noalias %%struct._IO_FILE* @fopen(i8* %%8, i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str2, i64 0, i64 0)) nounwind, !dbg !12 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_91_count);
  llvm_cbe_tmp__31 = (l_struct_OC__IO_FILE *) /*tail*/ aesl_fopen(( char *)llvm_cbe_tmp__27, ( char *)((&aesl_internal__OC_str2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 2
#endif
])));
...
llvm_cbe_tmp__41:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge1 = phi i32 [ 0, %%0 ], [ %%20, %%13  for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_storemerge1_count);
  llvm_cbe_storemerge1 = (unsigned int )llvm_cbe_storemerge1__PHI_TEMPORARY;
if (AESL_DEBUG_TRACE) {
printf("\nstoremerge1 = 0x%X",llvm_cbe_storemerge1);
printf("\n = 0x%X",0u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = sext i32 %%storemerge1 to i64, !dbg !10 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_101_count);
  llvm_cbe_tmp__32 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__32);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = getelementptr inbounds i64* %%outputVector, i64 %%14, !dbg !10 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_102_count);
  llvm_cbe_tmp__33 = (signed long long *)(&llvm_cbe_outputVector[(((signed long long )llvm_cbe_tmp__32))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%llX",((signed long long )llvm_cbe_tmp__32));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = load i64* %%15, align 8, !dbg !10 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_103_count);
  llvm_cbe_tmp__34 = (unsigned long long )*llvm_cbe_tmp__33;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = tail call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%1, i8* getelementptr inbounds ([9 x i8]* @aesl_internal_.str4, i64 0, i64 0), i64 %%16) nounwind, !dbg !10 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_104_count);
   /*tail*/ fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__20, ( char *)((&aesl_internal__OC_str4[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 9
#endif
])), llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%llX",llvm_cbe_tmp__34);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__35);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = load i64* %%15, align 8, !dbg !10 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_105_count);
  llvm_cbe_tmp__36 = (unsigned long long )*llvm_cbe_tmp__33;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%llX\n", llvm_cbe_tmp__36);
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = tail call i32 (%%struct._IO_FILE*, i8*, ...)* @fprintf(%%struct._IO_FILE* %%12, i8* getelementptr inbounds ([9 x i8]* @aesl_internal_.str4, i64 0, i64 0), i64 %%18) nounwind, !dbg !10 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_106_count);
   /*tail*/ fprintf((l_struct_OC__IO_FILE *)llvm_cbe_tmp__31, ( char *)((&aesl_internal__OC_str4[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 9
#endif
])), llvm_cbe_tmp__36);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%llX",llvm_cbe_tmp__36);
...
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__38&4294967295ull)));
  if (((llvm_cbe_tmp__38&4294967295U) == (36u&4294967295U))) {
...
llvm_cbe_tmp__42:
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = tail call i32 @fclose(%%struct._IO_FILE* %%1) nounwind, !dbg !11 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_114_count);
   /*tail*/ fclose((l_struct_OC__IO_FILE *)llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__39);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = tail call i32 @fclose(%%struct._IO_FILE* %%12) nounwind, !dbg !12 for 0x%llxth hint within @populateOutput  --> \n", ++aesl_llvm_cbe_115_count);
   /*tail*/ fclose((l_struct_OC__IO_FILE *)llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE) {
