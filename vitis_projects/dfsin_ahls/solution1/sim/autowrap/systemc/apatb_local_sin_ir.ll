; ModuleID = '/home/gabriel/Documents/UFRGS/RAISE/AHLS/vitis_projects/dfsin_ahls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline willreturn
define i64 @apatb_local_sin_ir(i64 %rad) local_unnamed_addr #0 {
entry:
  call fastcc void @copy_in()
  %0 = call i64 @apatb_local_sin_hw(i64 %rad)
  call void @copy_back()
  ret i64 %0
}
...
declare i64 @apatb_local_sin_hw(i64)
...
define i64 @local_sin_hw_stub_wrapper(i64) #3 {
entry:
  call void @copy_out()
  %1 = call i64 @local_sin_hw_stub(i64 %0)
  call void @copy_in()
  ret i64 %1
}

declare i64 @local_sin_hw_stub(i64)
