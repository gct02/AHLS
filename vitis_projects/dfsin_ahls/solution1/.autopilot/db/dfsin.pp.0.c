# 1 "benchmarks/chstone/dfsin/src/dfsin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 339 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "benchmarks/chstone/dfsin/src/dfsin.c" 2
# 37 "benchmarks/chstone/dfsin/src/dfsin.c"
# 1 "benchmarks/chstone/dfsin/src/dfsin.h" 1
...
# 5 "benchmarks/chstone/dfsin/src/dfsin.h" 2

__attribute__((sdx_kernel("local_sin", 0))) float64
local_sin (float64 rad);

double
ullong_to_double (unsigned long long x);
# 38 "benchmarks/chstone/dfsin/src/dfsin.c" 2
...
#pragma HLSDIRECTIVE TOP name=local_sin
# 47 "benchmarks/chstone/dfsin/src/dfsin.c"
