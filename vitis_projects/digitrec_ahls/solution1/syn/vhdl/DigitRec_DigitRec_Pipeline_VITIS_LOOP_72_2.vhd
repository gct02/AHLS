...
attribute shreg_extract : string;
    ...
    signal max_label_1_fu_121_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal max_vote_1_fu_38 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal max_vote_fu_129_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal icmp_ln74_fu_112_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln77_fu_118_p1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    icmp_ln74_fu_112_p2 <= "1" when (signed(votes_q0) > signed(max_vote_1_fu_38)) else "0";
    max_label_1_fu_121_p3 <= 
        zext_ln77_fu_118_p1 when (icmp_ln74_fu_112_p2(0) = '1') else 
        max_label_fu_34;
    max_label_out <= max_label_fu_34;

    max_label_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln72_fu_84_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln72_fu_84_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    max_vote_fu_129_p3 <= 
        votes_q0 when (icmp_ln74_fu_112_p2(0) = '1') else 
        max_vote_1_fu_38;
    ...
    zext_ln77_fu_118_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_173),8));
end behav;
