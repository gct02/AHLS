...
architecture behav of SgdLR is 
    ...
    signal select_ln60_reg_258 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal shl_ln_fu_201_p3 : STD_LOGIC_VECTOR (16 downto 0);
    signal shl_ln_reg_264 : STD_LOGIC_VECTOR (16 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal xor_ln26_fu_216_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal xor_ln26_reg_270 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal prob_reg_295 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state30 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state30 : signal is "none";
    signal grp_fu_129_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal conv_reg_300 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_SgdLR_Pipeline_DOT_fu_93_grp_fu_305_p_din0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_SgdLR_Pipeline_DOT_fu_93_grp_fu_305_p_din1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_SgdLR_Pipeline_DOT_fu_93_grp_fu_305_p_ce : STD_LOGIC;
    ...
    signal grp_SgdLR_Pipeline_GRAD_fu_103_grp_fu_305_p_din0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_SgdLR_Pipeline_GRAD_fu_103_grp_fu_305_p_din1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_SgdLR_Pipeline_GRAD_fu_103_grp_fu_305_p_ce : STD_LOGIC;
    ...
    signal grp_SgdLR_Pipeline_UPDATE_fu_112_grp_fu_305_p_din0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_SgdLR_Pipeline_UPDATE_fu_112_grp_fu_305_p_din1 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_SgdLR_Pipeline_UPDATE_fu_112_grp_fu_305_p_ce : STD_LOGIC;
    ...
    signal zext_ln63_fu_226_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal training_id_fu_64 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
    signal add_ln63_fu_185_p2 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal bitcast_ln26_fu_212_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component SgdLR_faddfsub_32ns_32ns_32_5_full_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component SgdLR_fdiv_32ns_32ns_32_10_no_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component SgdLR_sitofp_32ns_32_4_no_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component SgdLR_fexp_32ns_32ns_32_10_full_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component SgdLR_fmul_32ns_32ns_32_4_max_dsp_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    faddfsub_32ns_32ns_32_5_full_dsp_1_U16 : component SgdLR_faddfsub_32ns_32ns_32_5_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    fdiv_32ns_32ns_32_10_no_dsp_1_U17 : component SgdLR_fdiv_32ns_32ns_32_10_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 10,
        din0_WIDTH => 32,
    ...
    sitofp_32ns_32_4_no_dsp_1_U18 : component SgdLR_sitofp_32ns_32_4_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fexp_32ns_32ns_32_10_full_dsp_1_U19 : component SgdLR_fexp_32ns_32ns_32_10_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 10,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_4_max_dsp_1_U20 : component SgdLR_fmul_32ns_32ns_32_4_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                    shl_ln_reg_264(16 downto 10) <= shl_ln_fu_201_p3(16 downto 10);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    shl_ln_reg_264(9 downto 0) <= "0000000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, grp_SgdLR_Pipeline_DOT_fu_93_ap_done, grp_SgdLR_Pipeline_GRAD_fu_103_ap_done, grp_SgdLR_Pipeline_UPDATE_fu_112_ap_done, ap_CS_fsm_state4, ap_CS_fsm_state37, ap_CS_fsm_state39, icmp_ln60_fu_156_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (grp_SgdLR_Pipeline_DOT_fu_93_ap_done = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_state37 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state37) and (grp_SgdLR_Pipeline_GRAD_fu_103_ap_done = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_state39 => 
                if (((grp_SgdLR_Pipeline_UPDATE_fu_112_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state39))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state39;
                end if;
    ...
    add_ln63_fu_185_p2 <= std_logic_vector(unsigned(select_ln60_fu_177_p3) + unsigned(ap_const_lv7_1));
    ...
    ap_ST_fsm_state37_blk_assign_proc : process(grp_SgdLR_Pipeline_GRAD_fu_103_ap_done)
    begin
    ...
    ap_ST_fsm_state39_blk_assign_proc : process(grp_SgdLR_Pipeline_UPDATE_fu_112_ap_done)
    begin
    ...
    bitcast_ln26_fu_212_p1 <= grp_SgdLR_Pipeline_DOT_fu_93_result_out;

    data_address0_assign_proc : process(grp_SgdLR_Pipeline_DOT_fu_93_data_address0, grp_SgdLR_Pipeline_GRAD_fu_103_data_address0, ap_CS_fsm_state4, ap_CS_fsm_state37)
    begin
    ...
    data_ce0_assign_proc : process(grp_SgdLR_Pipeline_DOT_fu_93_data_ce0, grp_SgdLR_Pipeline_GRAD_fu_103_data_ce0, ap_CS_fsm_state4, ap_CS_fsm_state37)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state37)) then 
            data_ce0 <= grp_SgdLR_Pipeline_GRAD_fu_103_data_ce0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    gradient_address0_assign_proc : process(grp_SgdLR_Pipeline_GRAD_fu_103_gradient_address0, grp_SgdLR_Pipeline_UPDATE_fu_112_gradient_address0, ap_CS_fsm_state37, ap_CS_fsm_state39)
    begin
    ...
    gradient_ce0_assign_proc : process(grp_SgdLR_Pipeline_GRAD_fu_103_gradient_ce0, grp_SgdLR_Pipeline_UPDATE_fu_112_gradient_ce0, ap_CS_fsm_state37, ap_CS_fsm_state39)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
            gradient_ce0 <= grp_SgdLR_Pipeline_UPDATE_fu_112_gradient_ce0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state37)) then 
    ...
    gradient_we0_assign_proc : process(grp_SgdLR_Pipeline_GRAD_fu_103_gradient_we0, ap_CS_fsm_state37)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state37)) then 
            gradient_we0 <= grp_SgdLR_Pipeline_GRAD_fu_103_gradient_we0;
        else 
    ...
    grp_fu_119_ce_assign_proc : process(grp_SgdLR_Pipeline_DOT_fu_93_grp_fu_119_p_ce, grp_SgdLR_Pipeline_UPDATE_fu_112_grp_fu_119_p_ce, ap_CS_fsm_state4, ap_CS_fsm_state39)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
    ...
    grp_fu_119_opcode_assign_proc : process(grp_SgdLR_Pipeline_DOT_fu_93_grp_fu_119_p_opcode, grp_SgdLR_Pipeline_UPDATE_fu_112_grp_fu_119_p_opcode, ap_CS_fsm_state4, ap_CS_fsm_state39, ap_CS_fsm_state16, ap_CS_fsm_state31)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
    ...
    grp_fu_119_p0_assign_proc : process(tmp_reg_280, prob_reg_295, grp_SgdLR_Pipeline_DOT_fu_93_grp_fu_119_p_din0, grp_SgdLR_Pipeline_UPDATE_fu_112_grp_fu_119_p_din0, ap_CS_fsm_state4, ap_CS_fsm_state39, ap_CS_fsm_state16, ap_CS_fsm_state31)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
    ...
    grp_fu_119_p1_assign_proc : process(conv_reg_300, grp_SgdLR_Pipeline_DOT_fu_93_grp_fu_119_p_din1, grp_SgdLR_Pipeline_UPDATE_fu_112_grp_fu_119_p_din1, ap_CS_fsm_state4, ap_CS_fsm_state39, ap_CS_fsm_state16, ap_CS_fsm_state31)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
    ...
    grp_fu_129_p0 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(label_r_q0),32));
    grp_fu_132_p1 <= xor_ln26_reg_270;

    grp_fu_305_ce_assign_proc : process(grp_SgdLR_Pipeline_DOT_fu_93_grp_fu_305_p_ce, grp_SgdLR_Pipeline_GRAD_fu_103_grp_fu_305_p_ce, grp_SgdLR_Pipeline_UPDATE_fu_112_grp_fu_305_p_ce, ap_CS_fsm_state4, ap_CS_fsm_state37, ap_CS_fsm_state39)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
    ...
    grp_fu_305_p0_assign_proc : process(grp_SgdLR_Pipeline_DOT_fu_93_grp_fu_305_p_din0, grp_SgdLR_Pipeline_GRAD_fu_103_grp_fu_305_p_din0, grp_SgdLR_Pipeline_UPDATE_fu_112_grp_fu_305_p_din0, ap_CS_fsm_state4, ap_CS_fsm_state37, ap_CS_fsm_state39)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
    ...
    grp_fu_305_p1_assign_proc : process(grp_SgdLR_Pipeline_DOT_fu_93_grp_fu_305_p_din1, grp_SgdLR_Pipeline_GRAD_fu_103_grp_fu_305_p_din1, grp_SgdLR_Pipeline_UPDATE_fu_112_grp_fu_305_p_din1, ap_CS_fsm_state4, ap_CS_fsm_state37, ap_CS_fsm_state39)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
    ...
    label_r_address0 <= zext_ln63_fu_226_p1(7 - 1 downto 0);

    label_r_ce0_assign_proc : process(ap_CS_fsm_state26)
    begin
    ...
    select_ln60_fu_177_p3 <= 
        ...
        training_id_fu_64;
    shl_ln_fu_201_p3 <= (select_ln60_reg_258 & ap_const_lv10_0);

    theta_address0_assign_proc : process(grp_SgdLR_Pipeline_DOT_fu_93_theta_address0, grp_SgdLR_Pipeline_UPDATE_fu_112_theta_address0, ap_CS_fsm_state4, ap_CS_fsm_state39)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
            theta_address0 <= grp_SgdLR_Pipeline_UPDATE_fu_112_theta_address0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    theta_ce0_assign_proc : process(grp_SgdLR_Pipeline_DOT_fu_93_theta_ce0, grp_SgdLR_Pipeline_UPDATE_fu_112_theta_ce0, ap_CS_fsm_state4, ap_CS_fsm_state39)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
            theta_ce0 <= grp_SgdLR_Pipeline_UPDATE_fu_112_theta_ce0;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    theta_ce1_assign_proc : process(grp_SgdLR_Pipeline_UPDATE_fu_112_theta_ce1, ap_CS_fsm_state39)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
            theta_ce1 <= grp_SgdLR_Pipeline_UPDATE_fu_112_theta_ce1;
        else 
    ...
    theta_we0_assign_proc : process(grp_SgdLR_Pipeline_UPDATE_fu_112_theta_we0, ap_CS_fsm_state39)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state39)) then 
            theta_we0 <= grp_SgdLR_Pipeline_UPDATE_fu_112_theta_we0;
        else 
    ...
    xor_ln26_fu_216_p2 <= (bitcast_ln26_fu_212_p1 xor ap_const_lv32_80000000);
    zext_ln63_fu_226_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln60_reg_258),64));
end behav;
