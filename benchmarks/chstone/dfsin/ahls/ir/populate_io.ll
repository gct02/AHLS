...
@.str.4 = private unnamed_addr constant [11 x i8] c"0x%016llx\0A\00", align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define void @populateInput(i64* %inputVector, i8* %filename) #0 {
entry:
  %inputVector.addr = alloca i64*, align 8
  %filename.addr = alloca i8*, align 8
  %inputFile = alloca %struct._IO_FILE*, align 8
  %i = alloca i32, align 4
  store i64* %inputVector, i64** %inputVector.addr, align 8
  store i8* %filename, i8** %filename.addr, align 8
  %0 = load i8*, i8** %filename.addr, align 8
...
for.body:                                         ; preds = %for.cond
  %4 = load %struct._IO_FILE*, %struct._IO_FILE** %inputFile, align 8
  %5 = load i64*, i64** %inputVector.addr, align 8
  %6 = load i32, i32* %i, align 4
  %idxprom = sext i32 %6 to i64
  %arrayidx = getelementptr inbounds i64, i64* %5, i64 %idxprom
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i32 0, i32 0), i64* %arrayidx)
  br label %for.inc
...
; Function Attrs: noinline nounwind optnone uwtable
define void @populateOutput(i64* %outputVector, i8* %filename) #0 {
entry:
  %outputVector.addr = alloca i64*, align 8
  %filename.addr = alloca i8*, align 8
  ...
  %i = alloca i32, align 4
  store i64* %outputVector, i64** %outputVector.addr, align 8
  store i8* %filename, i8** %filename.addr, align 8
  %0 = load i8*, i8** %filename.addr, align 8
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %cmp = icmp slt i32 %11, 36
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** %outputFile, align 8
  %13 = load i64*, i64** %outputVector.addr, align 8
  %14 = load i32, i32* %i, align 4
  %idxprom = sext i32 %14 to i64
  %arrayidx = getelementptr inbounds i64, i64* %13, i64 %idxprom
  %15 = load i64, i64* %arrayidx, align 8
  %call11 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %12, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.4, i32 0, i32 0), i64 %15)
  %16 = load %struct._IO_FILE*, %struct._IO_FILE** %rawOutput, align 8
  %17 = load i64*, i64** %outputVector.addr, align 8
  %18 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %18 to i64
  %arrayidx13 = getelementptr inbounds i64, i64* %17, i64 %idxprom12
  %19 = load i64, i64* %arrayidx13, align 8
  %call14 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %16, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.4, i32 0, i32 0), i64 %19)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %21 = load %struct._IO_FILE*, %struct._IO_FILE** %outputFile, align 8
  %call15 = call i32 @fclose(%struct._IO_FILE* %21)
  %22 = load %struct._IO_FILE*, %struct._IO_FILE** %rawOutput, align 8
