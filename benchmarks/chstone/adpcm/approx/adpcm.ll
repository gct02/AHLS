...
; Function Attrs: nounwind
define void @adpcm_main(i32* %input_samples, i32* %compressed, i32* %result, i32 %num_samples) #4 !dbg !1424 !fpga.function.pragma !1427 {
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %num_samples.addr, metadata !1436, metadata !DIExpression()), !dbg !1437
  %0 = bitcast i32* %i to i8*, !dbg !1438
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #5, !dbg !1438
  call void @llvm.dbg.declare(metadata i32* %i, metadata !1439, metadata !DIExpression()), !dbg !1440
  %1 = bitcast i32* %j to i8*, !dbg !1438
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %1) #5, !dbg !1438
  call void @llvm.dbg.declare(metadata i32* %j, metadata !1441, metadata !DIExpression()), !dbg !1442
  call void @reset(), !dbg !1443
  store i32 10, i32* %j, align 4, !dbg !1444
  br label %adpcm_main_label12, !dbg !1445
...
for.cond:                                         ; preds = %for.inc, %adpcm_main_label12
  %2 = load i32, i32* %i, align 4, !dbg !1449
  %3 = load i32, i32* %num_samples.addr, align 4, !dbg !1451
  %cmp = icmp slt i32 %2, %3, !dbg !1452
  br i1 %cmp, label %for.body, label %for.end, !dbg !1453

for.body:                                         ; preds = %for.cond
  %4 = load i32*, i32** %input_samples.addr, align 8, !dbg !1454
  %5 = load i32, i32* %i, align 4, !dbg !1456
  %idxprom = sext i32 %5 to i64, !dbg !1454
  %arrayidx = getelementptr inbounds i32, i32* %4, i64 %idxprom, !dbg !1454
  %6 = load i32, i32* %arrayidx, align 4, !dbg !1454
  %7 = load i32*, i32** %input_samples.addr, align 8, !dbg !1457
  %8 = load i32, i32* %i, align 4, !dbg !1458
  %add = add i32 %8, 1, !dbg !1459
  %idxprom1 = sext i32 %add to i64, !dbg !1457
  %arrayidx2 = getelementptr inbounds i32, i32* %7, i64 %idxprom1, !dbg !1457
  %9 = load i32, i32* %arrayidx2, align 4, !dbg !1457
  %call = call i32 @encode(i32 %6, i32 %9), !dbg !1460
  %10 = load i32*, i32** %compressed.addr, align 8, !dbg !1461
  %11 = load i32, i32* %i, align 4, !dbg !1462
  %div = sdiv i32 %11, 2, !dbg !1463
  %idxprom3 = sext i32 %div to i64, !dbg !1461
  %arrayidx4 = getelementptr inbounds i32, i32* %10, i64 %idxprom3, !dbg !1461
  store i32 %call, i32* %arrayidx4, align 4, !dbg !1464
  br label %for.inc, !dbg !1465

for.inc:                                          ; preds = %for.body
  %12 = load i32, i32* %i, align 4, !dbg !1466
  %add5 = add i32 %12, 2, !dbg !1466
  store i32 %add5, i32* %i, align 4, !dbg !1466
  br label %for.cond, !dbg !1467, !llvm.loop !1468

for.end:                                          ; preds = %for.cond
  br label %adpcm_main_label13, !dbg !1469

adpcm_main_label13:                               ; preds = %for.end
  store i32 0, i32* %i, align 4, !dbg !1471
  br label %for.cond6, !dbg !1473

for.cond6:                                        ; preds = %for.inc17, %adpcm_main_label13
  %13 = load i32, i32* %i, align 4, !dbg !1474
  %14 = load i32, i32* %num_samples.addr, align 4, !dbg !1476
  %cmp7 = icmp slt i32 %13, %14, !dbg !1477
  br i1 %cmp7, label %for.body8, label %for.end19, !dbg !1478

for.body8:                                        ; preds = %for.cond6
  %15 = load i32*, i32** %compressed.addr, align 8, !dbg !1479
  %16 = load i32, i32* %i, align 4, !dbg !1481
  %div9 = sdiv i32 %16, 2, !dbg !1482
  %idxprom10 = sext i32 %div9 to i64, !dbg !1479
  %arrayidx11 = getelementptr inbounds i32, i32* %15, i64 %idxprom10, !dbg !1479
  %17 = load i32, i32* %arrayidx11, align 4, !dbg !1479
  call void @decode(i32 %17), !dbg !1483
  %18 = load i32, i32* @xout1, align 4, !dbg !1484
  %19 = load i32*, i32** %result.addr, align 8, !dbg !1485
  %20 = load i32, i32* %i, align 4, !dbg !1486
  %idxprom12 = sext i32 %20 to i64, !dbg !1485
  %arrayidx13 = getelementptr inbounds i32, i32* %19, i64 %idxprom12, !dbg !1485
  store i32 %18, i32* %arrayidx13, align 4, !dbg !1487
  %21 = load i32, i32* @xout2, align 4, !dbg !1488
  %22 = load i32*, i32** %result.addr, align 8, !dbg !1489
  %23 = load i32, i32* %i, align 4, !dbg !1490
  %add14 = add i32 %23, 1, !dbg !1491
  %idxprom15 = sext i32 %add14 to i64, !dbg !1489
  %arrayidx16 = getelementptr inbounds i32, i32* %22, i64 %idxprom15, !dbg !1489
  store i32 %21, i32* %arrayidx16, align 4, !dbg !1492
  br label %for.inc17, !dbg !1493

for.inc17:                                        ; preds = %for.body8
  %24 = load i32, i32* %i, align 4, !dbg !1494
  %add18 = add i32 %24, 2, !dbg !1494
  store i32 %add18, i32* %i, align 4, !dbg !1494
  br label %for.cond6, !dbg !1495, !llvm.loop !1496

for.end19:                                        ; preds = %for.cond6
  %25 = bitcast i32* %j to i8*, !dbg !1499
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %25) #5, !dbg !1499
  %26 = bitcast i32* %i to i8*, !dbg !1499
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %26) #5, !dbg !1499
  ret void, !dbg !1499
}
...
!3 = !DIFile(filename: "/home/gabriel/Documents/UFRGS/RAISE/Approx/raise_adpcm/solution1/.autopilot/db/adpcm.pp.0.c", directory: "/home/gabriel/Documents/UFRGS/RAISE/Approx")
!4 = !{}
!5 = !{!6, !7}
...
!11 = !DIFile(filename: "benchmarks/chstone/adpcm/src/adpcm.c", directory: "/home/gabriel/Documents/UFRGS/RAISE/Approx")
...
!1431 = !DILocation(line: 770, column: 24, scope: !1424)
!1432 = !DILocalVariable(name: "compressed", arg: 2, scope: !1424, file: !11, line: 770, type: !258)
!1433 = !DILocation(line: 770, column: 44, scope: !1424)
!1434 = !DILocalVariable(name: "result", arg: 3, scope: !1424, file: !11, line: 770, type: !258)
!1435 = !DILocation(line: 770, column: 61, scope: !1424)
!1436 = !DILocalVariable(name: "num_samples", arg: 4, scope: !1424, file: !11, line: 770, type: !7)
!1437 = !DILocation(line: 770, column: 73, scope: !1424)
!1438 = !DILocation(line: 772, column: 3, scope: !1424)
!1439 = !DILocalVariable(name: "i", scope: !1424, file: !11, line: 772, type: !7)
!1440 = !DILocation(line: 772, column: 7, scope: !1424)
!1441 = !DILocalVariable(name: "j", scope: !1424, file: !11, line: 772, type: !7)
!1442 = !DILocation(line: 772, column: 10, scope: !1424)
!1443 = !DILocation(line: 775, column: 3, scope: !1424)
!1444 = !DILocation(line: 777, column: 5, scope: !1424)
!1445 = !DILocation(line: 777, column: 3, scope: !1424)
!1446 = !DILocation(line: 779, column: 29, scope: !1447)
!1447 = distinct !DILexicalBlock(scope: !1424, file: !11, line: 779, column: 22)
!1448 = !DILocation(line: 779, column: 27, scope: !1447)
!1449 = !DILocation(line: 779, column: 34, scope: !1450)
!1450 = distinct !DILexicalBlock(scope: !1447, file: !11, line: 779, column: 22)
!1451 = !DILocation(line: 779, column: 38, scope: !1450)
!1452 = !DILocation(line: 779, column: 36, scope: !1450)
!1453 = !DILocation(line: 779, column: 22, scope: !1447)
!1454 = !DILocation(line: 781, column: 35, scope: !1455)
!1455 = distinct !DILexicalBlock(scope: !1450, file: !11, line: 780, column: 5)
!1456 = !DILocation(line: 781, column: 49, scope: !1455)
!1457 = !DILocation(line: 781, column: 53, scope: !1455)
!1458 = !DILocation(line: 781, column: 67, scope: !1455)
!1459 = !DILocation(line: 781, column: 69, scope: !1455)
!1460 = !DILocation(line: 781, column: 27, scope: !1455)
!1461 = !DILocation(line: 781, column: 7, scope: !1455)
!1462 = !DILocation(line: 781, column: 18, scope: !1455)
!1463 = !DILocation(line: 781, column: 20, scope: !1455)
!1464 = !DILocation(line: 781, column: 25, scope: !1455)
!1465 = !DILocation(line: 782, column: 5, scope: !1455)
!1466 = !DILocation(line: 779, column: 53, scope: !1450)
!1467 = !DILocation(line: 779, column: 22, scope: !1450)
!1468 = distinct !{!1468, !1453, !1469, !1470}
!1469 = !DILocation(line: 782, column: 5, scope: !1447)
!1470 = !{!"llvm.loop.name", !"adpcm_main_label12"}
!1471 = !DILocation(line: 783, column: 29, scope: !1472)
!1472 = distinct !DILexicalBlock(scope: !1424, file: !11, line: 783, column: 22)
!1473 = !DILocation(line: 783, column: 27, scope: !1472)
!1474 = !DILocation(line: 783, column: 34, scope: !1475)
!1475 = distinct !DILexicalBlock(scope: !1472, file: !11, line: 783, column: 22)
!1476 = !DILocation(line: 783, column: 38, scope: !1475)
!1477 = !DILocation(line: 783, column: 36, scope: !1475)
!1478 = !DILocation(line: 783, column: 22, scope: !1472)
!1479 = !DILocation(line: 785, column: 17, scope: !1480)
!1480 = distinct !DILexicalBlock(scope: !1475, file: !11, line: 784, column: 5)
!1481 = !DILocation(line: 785, column: 28, scope: !1480)
!1482 = !DILocation(line: 785, column: 30, scope: !1480)
!1483 = !DILocation(line: 785, column: 9, scope: !1480)
!1484 = !DILocation(line: 786, column: 21, scope: !1480)
!1485 = !DILocation(line: 786, column: 9, scope: !1480)
!1486 = !DILocation(line: 786, column: 16, scope: !1480)
!1487 = !DILocation(line: 786, column: 19, scope: !1480)
!1488 = !DILocation(line: 787, column: 25, scope: !1480)
!1489 = !DILocation(line: 787, column: 9, scope: !1480)
!1490 = !DILocation(line: 787, column: 16, scope: !1480)
!1491 = !DILocation(line: 787, column: 18, scope: !1480)
!1492 = !DILocation(line: 787, column: 23, scope: !1480)
!1493 = !DILocation(line: 788, column: 5, scope: !1480)
!1494 = !DILocation(line: 783, column: 53, scope: !1475)
!1495 = !DILocation(line: 783, column: 22, scope: !1475)
!1496 = distinct !{!1496, !1478, !1497, !1498}
!1497 = !DILocation(line: 788, column: 5, scope: !1472)
!1498 = !{!"llvm.loop.name", !"adpcm_main_label13"}
!1499 = !DILocation(line: 789, column: 1, scope: !1424)
