...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %5) #7, !dbg !240
  ret i32 %4, !dbg !241
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !256
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !256
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %call68 = call i32 @abs(i32 %95) #8, !dbg !474
...
if.end71:                                         ; preds = %if.then70, %if.end
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %124) #7, !dbg !530
  %125 = bitcast i64* %xb to i8*, !dbg !530
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %125) #7, !dbg !530
  %126 = bitcast i64* %xa to i8*, !dbg !530
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %126) #7, !dbg !530
  %127 = bitcast i32** %tqmf_ptr1 to i8*, !dbg !530
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %127) #7, !dbg !530
  %128 = bitcast i32** %tqmf_ptr to i8*, !dbg !530
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %128) #7, !dbg !530
  %129 = bitcast i32** %h_ptr to i8*, !dbg !530
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %129) #7, !dbg !530
  %130 = bitcast i32* %i to i8*, !dbg !530
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %130) #7, !dbg !530
  ret i32 %or, !dbg !531
}
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %14) #7, !dbg !578
  %15 = bitcast i32* %i to i8*, !dbg !578
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %15) #7, !dbg !578
...
entry:
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !617
  %11 = bitcast i64* %pl to i8*, !dbg !617
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !617
...
entry:
  ...
  %call = call i32 @abs(i32 %4) #8, !dbg !635
...
if.end10:                                         ; preds = %if.else, %if.then5
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %18) #7, !dbg !677
  %19 = bitcast i64* %wd to i8*, !dbg !677
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %19) #7, !dbg !677
  %20 = bitcast i32* %mil to i8*, !dbg !677
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %20) #7, !dbg !677
  %21 = bitcast i32* %ril to i8*, !dbg !677
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %21) #7, !dbg !677
  ret i32 %17, !dbg !678
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !684
...
if.end5:                                          ; preds = %if.then4, %if.end
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #7, !dbg !712
  ret i32 %7, !dbg !713
}
...
entry:
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %10) #7, !dbg !743
  %11 = bitcast i32* %wd2 to i8*, !dbg !743
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %11) #7, !dbg !743
  %12 = bitcast i32* %wd1 to i8*, !dbg !743
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %12) #7, !dbg !743
  ret i32 %shl, !dbg !744
}
...
if.end27:                                         ; preds = %for.end26, %for.end
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %41) #7, !dbg !847
  %42 = bitcast i32* %wd2 to i8*, !dbg !847
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %42) #7, !dbg !847
  %43 = bitcast i32* %i to i8*, !dbg !847
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %43) #7, !dbg !847
  ret void, !dbg !847
}
...
if.end21:                                         ; preds = %if.then20, %if.end18
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %17) #7, !dbg !923
  %18 = bitcast i64* %wd4 to i8*, !dbg !923
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %18) #7, !dbg !923
  %19 = bitcast i64* %wd2 to i8*, !dbg !923
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %19) #7, !dbg !923
  ret i32 %16, !dbg !924
}
...
if.end14:                                         ; preds = %if.then12, %if.end9
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %16) #7, !dbg !987
  %17 = bitcast i32* %wd3 to i8*, !dbg !987
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %17) #7, !dbg !987
  %18 = bitcast i64* %wd2 to i8*, !dbg !987
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %18) #7, !dbg !987
  ret i32 %15, !dbg !988
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #7, !dbg !994
...
if.end4:                                          ; preds = %if.then3, %if.end
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %8) #7, !dbg !1021
  ret i32 %7, !dbg !1022
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !1036
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !1039
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !1039
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %6) #7, !dbg !1039
  ...
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %7) #7, !dbg !1039
...
for.end80:                                        ; preds = %for.cond71
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %123) #7, !dbg !1296
  %124 = bitcast i32** %ad_ptr to i8*, !dbg !1296
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %124) #7, !dbg !1296
  %125 = bitcast i32** %ac_ptr1 to i8*, !dbg !1296
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %125) #7, !dbg !1296
  %126 = bitcast i32** %ac_ptr to i8*, !dbg !1296
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %126) #7, !dbg !1296
  %127 = bitcast i32** %h_ptr to i8*, !dbg !1296
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %127) #7, !dbg !1296
  %128 = bitcast i64* %xa2 to i8*, !dbg !1296
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %128) #7, !dbg !1296
  %129 = bitcast i64* %xa1 to i8*, !dbg !1296
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %129) #7, !dbg !1296
  %130 = bitcast i32* %i to i8*, !dbg !1296
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %130) #7, !dbg !1296
  ret void, !dbg !1296
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #7, !dbg !1300
...
for.end38:                                        ; preds = %for.cond29
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %20) #7, !dbg !1423
  ret void, !dbg !1423
}
...
for.end19:                                        ; preds = %for.cond6
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %23) #7, !dbg !1495
  %24 = bitcast i32* %i to i8*, !dbg !1495
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %24) #7, !dbg !1495
  ret void, !dbg !1495
}
