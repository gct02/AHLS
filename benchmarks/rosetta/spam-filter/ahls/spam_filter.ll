...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #12, !dbg !389
...
DOT:                                              ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %1) #12, !dbg !392
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %3) #12, !dbg !400
  br label %for.end
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %13) #12, !dbg !413
...
GRAD:                                             ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #12, !dbg !436
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %2) #12, !dbg !444
  br label %for.end
...
UPDATE:                                           ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #12, !dbg !467
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %2) #12, !dbg !475
  br label %for.end
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4096, i8* %0) #12, !dbg !503
...
EPOCH:                                            ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %1) #12, !dbg !509
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %3) #12, !dbg !517
  br label %for.end15
...
TRAINING_INST:                                    ; preds = %for.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %4) #12, !dbg !519
...
for.cond.cleanup3:                                ; preds = %for.cond1
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %6) #12, !dbg !528
  br label %for.end

for.body4:                                        ; preds = %for.cond1
  %7 = bitcast float* %dot to i8*, !dbg !529
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %7) #12, !dbg !529
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %11) #12, !dbg !538
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %20) #12, !dbg !555
  %21 = bitcast float* %dot to i8*, !dbg !555
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %21) #12, !dbg !555
...
for.end15:                                        ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0i8(i64 4096, i8* %24) #12, !dbg !566
  ret void, !dbg !566
}
