...
; Function Attrs: nounwind
define void @_Z8DigitRecPKyS0_PKhPh(i64* "fpga.decayed.dim.hint"="12000" %training_samples, i64* "fpga.decayed.dim.hint"="2000" %test_set, i8* "fpga.decayed.dim.hint"="3000" %training_labels, i8* "fpga.decayed.dim.hint"="500" %results) #5 !fpga.function.pragma !12 {
entry:
