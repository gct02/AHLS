...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #8, !dbg !71
...
VITIS_LOOP_33_1:                                  ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %1) #8, !dbg !74
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %3) #8, !dbg !82
  br label %for.end

for.body:                                         ; preds = %for.cond
  %4 = bitcast i64* %diff to i8*, !dbg !83
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #8, !dbg !83
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #8, !dbg !95
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %15) #8, !dbg !101
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %16) #8, !dbg !104
...
FIND_MAX_DIST:                                    ; preds = %for.end
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %17) #8, !dbg !107
...
for.cond.cleanup5:                                ; preds = %for.cond3
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %19) #8, !dbg !115
  br label %for.end14
...
if.end21:                                         ; preds = %if.then16, %for.end14
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %37) #8, !dbg !150
  %38 = bitcast i32* %max_dist to i8*, !dbg !150
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %38) #8, !dbg !150
  %39 = bitcast i32* %dist to i8*, !dbg !150
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %39) #8, !dbg !150
  ret void, !dbg !150
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #8, !dbg !158
  ...
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %max_label) #8, !dbg !161
  ...
  call void @llvm.lifetime.start.p0i8(i64 40, i8* %1) #8, !dbg !164
...
VITIS_LOOP_69_1:                                  ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %3) #8, !dbg !170
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %5) #8, !dbg !178
  br label %for.end
...
VITIS_LOOP_72_2:                                  ; preds = %for.end
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %11) #8, !dbg !187
...
for.cond.cleanup7:                                ; preds = %for.cond5
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %13) #8, !dbg !195
  br label %for.end16
...
for.end16:                                        ; preds = %for.cond.cleanup7
  ...
  call void @llvm.lifetime.end.p0i8(i64 40, i8* %22) #8, !dbg !216
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %max_label) #8, !dbg !216
  %23 = bitcast i32* %max_vote to i8*, !dbg !216
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %23) #8, !dbg !216
  ret i8 %21, !dbg !217
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 12, i8* %0) #8, !dbg !235
  ...
  call void @llvm.lifetime.start.p0i8(i64 12, i8* %1) #8, !dbg !241
...
TEST_LOOP:                                        ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %2) #8, !dbg !244
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %4) #8, !dbg !252
  br label %for.end28
...
SET_KNN_SET:                                      ; preds = %for.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %5) #8, !dbg !254
...
for.cond.cleanup3:                                ; preds = %for.cond1
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %7) #8, !dbg !263
  br label %for.end
...
TRAINING_LOOP:                                    ; preds = %for.end
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %11) #8, !dbg !276
...
for.cond.cleanup10:                               ; preds = %for.cond8
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %13) #8, !dbg !284
  br label %for.end22
...
for.end22:                                        ; preds = %for.cond.cleanup10
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %max_vote) #8, !dbg !300
  ...
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %max_vote) #8, !dbg !309
...
for.end28:                                        ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0i8(i64 12, i8* %26) #8, !dbg !315
  %27 = bitcast [3 x i32]* %dists to i8*, !dbg !315
  call void @llvm.lifetime.end.p0i8(i64 12, i8* %27) #8, !dbg !315
  ret void, !dbg !315
}
...
entry:
  ...
  %training_samples = alloca [72000 x i64], align 16
  %testing_samples = alloca [8000 x i64], align 16
  %training_labels = alloca [18000 x i8], align 16
  %test_labels = alloca [2000 x i8], align 16
  %result = alloca [2000 x i8], align 16
  ...
  %arraydecay = getelementptr inbounds [72000 x i64], [72000 x i64]* %training_samples, i32 0, i32 0
  %arraydecay4 = getelementptr inbounds [18000 x i8], [18000 x i8]* %training_labels, i32 0, i32 0
  %arraydecay5 = getelementptr inbounds [8000 x i64], [8000 x i64]* %testing_samples, i32 0, i32 0
  %arraydecay6 = getelementptr inbounds [2000 x i8], [2000 x i8]* %test_labels, i32 0, i32 0
  call void @populateInput(i8* %1, i8* %3, i8* %5, i8* %7, i64* %arraydecay, i8* %arraydecay4, i64* %arraydecay5, i8* %arraydecay6)
  %arraydecay7 = getelementptr inbounds [72000 x i64], [72000 x i64]* %training_samples, i32 0, i32 0
  %arraydecay8 = getelementptr inbounds [8000 x i64], [8000 x i64]* %testing_samples, i32 0, i32 0
  %arraydecay9 = getelementptr inbounds [18000 x i8], [18000 x i8]* %training_labels, i32 0, i32 0
  %arraydecay10 = getelementptr inbounds [2000 x i8], [2000 x i8]* %result, i32 0, i32 0
