...
int main(int argc, char ** argv)
{
  ...
  populateInput(argv[1], argv[2], argv[3], argv[4], training_samples, training_labels, test_samples, test_labels);
  DigitRec(training_samples, test_samples, training_labels, result);
