...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %0) #15
...
; Function Attrs: nounwind
define void @_Z18clockwise_verticesP11Triangle_2D(%struct.Triangle_2D* %triangle_2d) #2 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %tmp_x) #15
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %tmp_y) #15
  ...
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %tmp_y) #15
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %tmp_x) #15
  ret void
}

; Function Attrs: nounwind
define zeroext i1 @_Z17pixel_in_trianglehh11Triangle_2D(i8 zeroext %x, i8 zeroext %y, %struct.Triangle_2D* byval align 1 %triangle_2d) #3 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %1) #15
...
land.end:                                         ; preds = %land.rhs, %land.lhs.true, %entry
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %31) #15
  %32 = bitcast i32* %pi1 to i8*
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %32) #15
  %33 = bitcast i32* %pi0 to i8*
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %33) #15
  ret i1 %30
}

; Function Attrs: nounwind
define zeroext i8 @_Z8find_minhhh(i8 zeroext %in0, i8 zeroext %in1, i8 zeroext %in2) #4 {
entry:
...
; Function Attrs: nounwind
define zeroext i8 @_Z8find_maxhhh(i8 zeroext %in0, i8 zeroext %in1, i8 zeroext %in2) #5 {
entry:
  %retval = alloca i8, align 1
  %in0.addr = alloca i8, align 1
  %in1.addr = alloca i8, align 1
...
; Function Attrs: nounwind
define void @_Z10projection11Triangle_3DP11Triangle_2Di(%struct.Triangle_3D* byval align 1 %triangle_3d, %struct.Triangle_2D* %triangle_2d, i32 %angle) #6 {
entry:
  %triangle_2d.addr = alloca %struct.Triangle_2D*, align 8
...
; Function Attrs: nounwind
define zeroext i1 @_Z14rasterization111Triangle_2DPhPi(%struct.Triangle_2D* byval align 1 %triangle_2d, i8* %max_min, i32* %max_index) #7 {
entry:
...
; Function Attrs: nounwind
define i32 @_Z14rasterization2bPhPi11Triangle_2DP14CandidatePixel(i1 zeroext %flag, i8* %max_min, i32* %max_index, %struct.Triangle_2D* byval align 1 %triangle_2d, %struct.CandidatePixel* %fragment) #8 {
entry:
...
if.end:                                           ; preds = %entry
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %color) #15
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %6) #15
  br label %for.end

for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %x) #15
  ...
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %y) #15
...
if.end23:                                         ; preds = %if.then11, %for.body
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %y) #15
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %x) #15
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %35) #15
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %color) #15
  br label %return
...
; Function Attrs: nounwind
define i32 @_Z8zcullingiP14CandidatePixeliP5Pixel(i32 %counter, %struct.CandidatePixel* %fragments, i32 %size, %struct.Pixel* %pixels) #9 {
entry:
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %3) #15
  br label %for.end10
...
; Function Attrs: nounwind
define void @_Z10coloringFBiiP5PixelPA256_h(i32 %counter, i32 %size_pixels, %struct.Pixel* %pixels, [256 x i8]* "fpga.decayed.dim.hint"="256" %frame_buffer) #10 {
entry:
  %counter.addr = alloca i32, align 4
...
; Function Attrs: nounwind
define void @_Z9renderingP11Triangle_3DPA256_hi(%struct.Triangle_3D* %triangle_3ds, [256 x i8]* "fpga.decayed.dim.hint"="256" %output, i32 %num_3d_tri) #11 !fpga.function.pragma !18 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 7, i8* %0) #15
  %1 = bitcast i32* %angle to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %1) #15
  store i32 0, i32* %angle, align 4
  %2 = bitcast [5 x i8]* %max_min to i8*
  call void @llvm.lifetime.start.p0i8(i64 5, i8* %2) #15
  ...
  call void @llvm.lifetime.start.p0i8(i64 2000, i8* %4) #15
  %5 = bitcast [500 x %struct.Pixel]* %pixels to i8*
  call void @llvm.lifetime.start.p0i8(i64 1500, i8* %5) #15
  br label %TRIANGLES
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %9) #15
  br label %for.end
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %14) #15
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %25) #15
  %26 = bitcast i32* %size_fragment to i8*
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %26) #15
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0i8(i64 1500, i8* %29) #15
  %30 = bitcast [500 x %struct.CandidatePixel]* %fragment to i8*
  call void @llvm.lifetime.end.p0i8(i64 2000, i8* %30) #15
  %31 = bitcast [1 x i32]* %max_index to i8*
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %31) #15
  %32 = bitcast [5 x i8]* %max_min to i8*
  call void @llvm.lifetime.end.p0i8(i64 5, i8* %32) #15
  %33 = bitcast i32* %angle to i8*
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %33) #15
  %34 = bitcast %struct.Triangle_2D* %triangle_2ds to i8*
  call void @llvm.lifetime.end.p0i8(i64 7, i8* %34) #15
  ret void
}
...
declare i32 @atoi(i8*) #13

declare void @populateInput(i8*, %struct.Triangle_3D**, i32) #14

declare void @populateOutput([256 x i8]*, i8*) #14
...
attributes #2 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "fpga.demangled.name"="clockwise_vertices" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #3 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "fpga.demangled.name"="pixel_in_triangle" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #4 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "fpga.demangled.name"="find_min" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #5 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "fpga.demangled.name"="find_max" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #6 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "fpga.demangled.name"="projection" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #7 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "fpga.demangled.name"="rasterization1" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #8 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "fpga.demangled.name"="rasterization2" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #9 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "fpga.demangled.name"="zculling" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #10 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "fpga.demangled.name"="coloringFB" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #13 = { nounwind readonly willreturn "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
