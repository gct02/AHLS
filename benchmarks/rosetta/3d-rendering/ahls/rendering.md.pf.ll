...
define i32 @_Z15check_clockwise11Triangle_2D(%struct.Triangle_2D* byval align 1 %triangle_2d) #0 !dbg !44 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"3.") #15, !dbg !64, !opID !67, !stats.instNumber !68, !opSignedness !59
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"39.") #15, !dbg !164, !opID !167, !stats.instNumber !168, !opSignedness !59
...
; Function Attrs: nounwind
define void @_Z18clockwise_verticesP11Triangle_2D(%struct.Triangle_2D* %triangle_2d) #3 !dbg !172 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %"43.tmp_x") #15, !dbg !188, !opID !189, !stats.instNumber !190, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %"44.tmp_y") #15, !dbg !188, !opID !195, !stats.instNumber !196, !opSignedness !59
  ...
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %"44.tmp_y") #15, !dbg !281, !opID !282, !stats.instNumber !283, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %"43.tmp_x") #15, !dbg !281, !opID !284, !stats.instNumber !285, !opSignedness !59
  ret void, !dbg !281, !opID !286, !stats.instNumber !287, !opSignedness !59
}

; Function Attrs: nounwind
define zeroext i1 @_Z17pixel_in_trianglehh11Triangle_2D(i8 zeroext %x, i8 zeroext %y, %struct.Triangle_2D* byval align 1 %triangle_2d) #4 !dbg !288 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"92.") #15, !dbg !318, !opID !321, !stats.instNumber !322, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"95.") #15, !dbg !318, !opID !329, !stats.instNumber !330, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"98.") #15, !dbg !318, !opID !337, !stats.instNumber !338, !opSignedness !59
...
land.end:                                         ; preds = %land.rhs, %land.lhs.true, %entry
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"201.") #15, !dbg !617, !opID !620, !stats.instNumber !621, !opSignedness !59
  %"203." = bitcast i32* %"85.pi1" to i8*, !dbg !617, !opID !622, !stats.instNumber !623, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"203.") #15, !dbg !617, !opID !624, !stats.instNumber !625, !opSignedness !59
  %"205." = bitcast i32* %"84.pi0" to i8*, !dbg !617, !opID !626, !stats.instNumber !627, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"205.") #15, !dbg !617, !opID !628, !stats.instNumber !629, !opSignedness !59
  ret i1 %"200.", !dbg !630, !opID !631, !stats.instNumber !632, !opSignedness !59
}

; Function Attrs: nounwind
define zeroext i8 @_Z8find_minhhh(i8 zeroext %in0, i8 zeroext %in1, i8 zeroext %in2) #5 !dbg !633 {
entry:
...
; Function Attrs: nounwind
define zeroext i8 @_Z8find_maxhhh(i8 zeroext %in0, i8 zeroext %in1, i8 zeroext %in2) #6 !dbg !752 {
entry:
...
; Function Attrs: nounwind
define void @_Z10projection11Triangle_3DP11Triangle_2Di(%struct.Triangle_3D* byval align 1 %triangle_3d, %struct.Triangle_2D* %triangle_2d, i32 %angle) #7 !dbg !869 {
entry:
...
; Function Attrs: nounwind
define zeroext i1 @_Z14rasterization111Triangle_2DPhPi(%struct.Triangle_2D* byval align 1 %triangle_2d, i8* %max_min, i32* %max_index) #8 !dbg !1355 {
entry:
...
; Function Attrs: nounwind
define i32 @_Z14rasterization2bPhPi11Triangle_2DP14CandidatePixel(i1 zeroext %flag, i8* %max_min, i32* %max_index, %struct.Triangle_2D* byval align 1 %triangle_2d, %struct.CandidatePixel* %fragment) #9 !dbg !1624 {
entry:
...
if.end:                                           ; preds = %entry
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %"566.color") #15, !dbg !1690, !opID !1691, !stats.instNumber !1692, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"588.") #15, !dbg !1699, !opID !1702, !stats.instNumber !1703, !opSignedness !59
...
RAST2:                                            ; preds = %if.end
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"593.") #15, !dbg !1712, !opID !1716, !stats.instNumber !1717, !opSignedness !59
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"604.") #15, !dbg !1743, !opID !1746, !stats.instNumber !1747, !opSignedness !59
  br label %for.end, !opID !1748, !stats.instNumber !1749, !opSignedness !59

for.body:                                         ; preds = %for.cond
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %"569.x") #15, !dbg !1750, !opID !1752, !stats.instNumber !1753, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %"570.y") #15, !dbg !1789, !opID !1790, !stats.instNumber !1791, !opSignedness !59
...
if.end23:                                         ; preds = %if.then11, %for.body
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %"570.y") #15, !dbg !1934, !opID !1935, !stats.instNumber !1936, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %"569.x") #15, !dbg !1934, !opID !1937, !stats.instNumber !1938, !opSignedness !59
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"685.") #15, !dbg !1960, !opID !1963, !stats.instNumber !1964, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %"566.color") #15, !dbg !1960, !opID !1965, !stats.instNumber !1966, !opSignedness !59
...
ZCULLING_INIT_ROW:                                ; preds = %if.then
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"712.") #15, !dbg !2028, !opID !2033, !stats.instNumber !2034, !opSignedness !59
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"721.") #15, !dbg !2055, !opID !2058, !stats.instNumber !2059, !opSignedness !59
...
ZCULLING_INIT_COL:                                ; preds = %for.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"725.") #15, !dbg !2065, !opID !2070, !stats.instNumber !2071, !opSignedness !59
...
for.cond.cleanup4:                                ; preds = %for.cond2
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"734.") #15, !dbg !2092, !opID !2095, !stats.instNumber !2096, !opSignedness !59
...
if.end:                                           ; preds = %for.end10, %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"755.") #15, !dbg !2151, !opID !2154, !stats.instNumber !2155, !opSignedness !59
...
ZCULLING:                                         ; preds = %if.end
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"760.") #15, !dbg !2164, !opID !2168, !stats.instNumber !2169, !opSignedness !59
...
for.cond.cleanup13:                               ; preds = %for.cond11
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"770.") #15, !dbg !2193, !opID !2196, !stats.instNumber !2197, !opSignedness !59
...
for.end62:                                        ; preds = %for.cond.cleanup13
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"870.") #15, !dbg !2449, !opID !2452, !stats.instNumber !2453, !opSignedness !59
  ret i32 %"868.", !dbg !2454, !opID !2455, !stats.instNumber !2456, !opSignedness !59
}

; Function Attrs: nounwind
define void @_Z10coloringFBiiP5PixelPA256_h(i32 %counter, i32 %size_pixels, %struct.Pixel* %pixels, [256 x i8]* "fpga.decayed.dim.hint"="256" %frame_buffer) #11 !dbg !2457 {
entry:
...
COLORING_FB_INIT_ROW:                             ; preds = %if.then
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"893.") #15, !dbg !2516, !opID !2521, !stats.instNumber !2522, !opSignedness !59
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"902.") #15, !dbg !2543, !opID !2546, !stats.instNumber !2547, !opSignedness !59
...
COLORING_FB_INIT_COL:                             ; preds = %for.body
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"906.") #15, !dbg !2553, !opID !2558, !stats.instNumber !2559, !opSignedness !59
...
for.cond.cleanup4:                                ; preds = %for.cond2
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"915.") #15, !dbg !2580, !opID !2583, !stats.instNumber !2584, !opSignedness !59
...
COLORING_FB:                                      ; preds = %if.end
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"938.") #15, !dbg !2642, !opID !2646, !stats.instNumber !2647, !opSignedness !59
...
for.cond.cleanup14:                               ; preds = %for.cond12
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"948.") #15, !dbg !2671, !opID !2674, !stats.instNumber !2675, !opSignedness !59
...
; Function Attrs: nounwind
define void @_Z9renderingP11Triangle_3DPA256_h(%struct.Triangle_3D* "fpga.decayed.dim.hint"="3192" %triangle_3ds, [256 x i8]* "fpga.decayed.dim.hint"="256" %output) #12 !dbg !2754 !fpga.function.pragma !2758 {
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 7, i8* %"1000.") #15, !dbg !2803, !opID !2806, !stats.instNumber !2807, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"1003.") #15, !dbg !2812, !opID !2815, !stats.instNumber !2816, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 5, i8* %"1007.") #15, !dbg !2823, !opID !2826, !stats.instNumber !2827, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"1010.") #15, !dbg !2835, !opID !2838, !stats.instNumber !2839, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 2000, i8* %"1013.") #15, !dbg !2847, !opID !2850, !stats.instNumber !2851, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 1500, i8* %"1016.") #15, !dbg !2859, !opID !2862, !stats.instNumber !2863, !opSignedness !59
...
TRIANGLES:                                        ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"1020.") #15, !dbg !2871, !opID !2875, !stats.instNumber !2876, !opSignedness !59
...
for.cond.cleanup:                                 ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"1028.") #15, !dbg !2895, !opID !2898, !stats.instNumber !2899, !opSignedness !59
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.lifetime.start.p0i8(i64 1, i8* %"1039.") #15, !dbg !2923, !opID !2926, !stats.instNumber !2927, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"1048.") #15, !dbg !2948, !opID !2951, !stats.instNumber !2952, !opSignedness !59
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %"1059.") #15, !dbg !2979, !opID !2982, !stats.instNumber !2983, !opSignedness !59
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"1073.") #15, !dbg !3020, !opID !3023, !stats.instNumber !3024, !opSignedness !59
  %"1075." = bitcast i32* %"993.size_fragment" to i8*, !dbg !3020, !opID !3025, !stats.instNumber !3026, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"1075.") #15, !dbg !3020, !opID !3027, !stats.instNumber !3028, !opSignedness !59
  %"1077." = bitcast i1* %"991.flag" to i8*, !dbg !3020, !opID !3029, !stats.instNumber !3030, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 1, i8* %"1077.") #15, !dbg !3020, !opID !3031, !stats.instNumber !3032, !opSignedness !59
...
for.end:                                          ; preds = %for.cond.cleanup
  ...
  call void @llvm.lifetime.end.p0i8(i64 1500, i8* %"1084.") #15, !dbg !3048, !opID !3051, !stats.instNumber !3052, !opSignedness !59
  %"1086." = bitcast [500 x %struct.CandidatePixel]* %"987.fragment" to i8*, !dbg !3048, !opID !3053, !stats.instNumber !3054, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 2000, i8* %"1086.") #15, !dbg !3048, !opID !3055, !stats.instNumber !3056, !opSignedness !59
  %"1088." = bitcast [1 x i32]* %"986.max_index" to i8*, !dbg !3048, !opID !3057, !stats.instNumber !3058, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"1088.") #15, !dbg !3048, !opID !3059, !stats.instNumber !3060, !opSignedness !59
  %"1090." = bitcast [5 x i8]* %"985.max_min" to i8*, !dbg !3048, !opID !3061, !stats.instNumber !3062, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 5, i8* %"1090.") #15, !dbg !3048, !opID !3063, !stats.instNumber !3064, !opSignedness !59
  %"1092." = bitcast i32* %"984.angle" to i8*, !dbg !3048, !opID !3065, !stats.instNumber !3066, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %"1092.") #15, !dbg !3048, !opID !3067, !stats.instNumber !3068, !opSignedness !59
  %"1094." = bitcast %struct.Triangle_2D* %"983.triangle_2ds" to i8*, !dbg !3048, !opID !3069, !stats.instNumber !3070, !opSignedness !59
  call void @llvm.lifetime.end.p0i8(i64 7, i8* %"1094.") #15, !dbg !3048, !opID !3071, !stats.instNumber !3072, !opSignedness !59
...
declare void @profOp(i64, i8, i64, i64, double, i1, i1, i32)

declare void @saveProfile(i8*)
