...
def process_ir(ir_src_path:Path, ir_dst_path:Path, directives_path:Path):
    """
    Process an LLVM IR generated by Vitis HLS to make it more compact and easier to analyze
    in order to build a CDFG from it and use it as input to the GNN.
    ...
    dce: 
        remove dead code;
    strip-dead-prototypes: 
        remove unused function prototypes that may have been generated by 
        the previous passes;
    update-md: 
    ...
    try:
        ...
        run_opt(temp2_path, temp1_path, "-lowerinvoke -lowerswitch")
        run_opt(temp1_path, temp2_path, "-mem2reg")
        run_opt(temp2_path, temp1_path, "-prep-gnn")
        run_opt(temp1_path, temp2_path, "-dce -strip-dead-prototypes")
        run_opt(temp1_path, temp2_path, "-update-md")
        run_opt(temp2_path, temp1_path, "-set-hls-md -dir {}".format(directives_path))
...
if __name__ == "__main__":
    ...
    for i, benchmark in enumerate(benchmarks):
        ...
        for j, solution in enumerate(solutions):
            ...
            ir_mod = solution / ".autopilot/db/a.g.ld.0.han.ll"

            try:
                process_ir(ir, ir_mod, directives_path)
